...
# Unit tests for ::EmailFeatureOverview
...
describe ::EmailFeatureOverview do
  ...
  describe "test an instance of EmailFeatureOverview" do
    it "should create an instance of EmailFeatureOverview" do
      #instance = ::EmailFeatureOverview.new
      #expect(instance).to be_instance_of(::EmailFeatureOverview)
    end
  end
  ...
  describe "test attribute 'statuses'" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Petstore::EnumTest::EnumAttributeValidator.new("Set(String)", ["SUPPORTED", "PARTIAL", "NOT_SUPPORTED", "UNKNOWN"])
      # validator.allowable_values.each do |value|
