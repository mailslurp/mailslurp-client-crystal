...
describe "InboxForwarderControllerApi" do
  ...
  # Get all inbox forwarder events
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :page Optional page index in inbox forwarder event list pagination
  # @option opts [Int32] :size Optional page size in inbox forwarder event list pagination
