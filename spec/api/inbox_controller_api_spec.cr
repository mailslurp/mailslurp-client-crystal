...
describe "InboxControllerApi" do
  ...
  # @option opts [Bool] :allow_team_access Grant team access to this inbox and the emails that belong to it for team members of your organization.
  ...
  # @option opts [Bool] :favourite Is the inbox favorited. Favouriting inboxes is typically done in the dashboard for quick access or filtering
  ...
  # @option opts [Bool] :team_access Optionally filter by team access. Defaults to false so organization inboxes are not included
