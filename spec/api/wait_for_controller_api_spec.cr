...
describe "WaitForControllerApi" do
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Time] :before Filter for emails that were received before the given timestamp
  # @option opts [Int32] :count Number of emails to wait for. Must be greater that 1
  # @option opts [Int64] :delay Max milliseconds delay between calls
  # @option opts [String] :inbox_id Id of the inbox we are fetching emails from
  # @option opts [Time] :since Filter for emails that were received after the given timestamp
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Time] :before Filter for emails that were before after the given timestamp
  # @option opts [Int64] :delay Max milliseconds delay between calls
  # @option opts [String] :inbox_id Id of the inbox we are fetching emails from
  # @option opts [Time] :since Filter for emails that were received after the given timestamp
  # @option opts [String] :sort Sort direction
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Time] :before Filter for emails that were received before the given timestamp
  # @option opts [Int32] :count Number of emails to wait for. Must be greater or equal to 1
  # @option opts [Int64] :delay Max milliseconds delay between calls
  # @option opts [String] :inbox_id Id of the inbox we are fetching emails from
  # @option opts [Time] :since Filter for emails that were received after the given timestamp
  # @option opts [String] :sort Sort direction
