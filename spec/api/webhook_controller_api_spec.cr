...
describe "WebhookControllerApi" do
  ...
  # @option opts [Bool] :include_account_wide Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters
  # @return [PageWebhookProjection]
  ...
  # @option opts [String] :health Filter by webhook health
  # @option opts [String] :event_type Optional event type
  # @option opts [Bool] :include_account_wide Include account scope inbox webhooks
  # @return [PageWebhookProjection]
  ...
  # @option opts [String] :search_filter Optional search filter
  # @option opts [String] :health Filter by webhook health
  # @option opts [Bool] :include_account_wide Include account scope phone webhooks
  # @return [PageWebhookProjection]
