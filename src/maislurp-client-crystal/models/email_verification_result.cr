...
module 
  ...
  class EmailVerificationResult include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@domain_name : String, @port : Int32, @email_address : String, @is_valid : Bool, @error : String | Nil)
    end
