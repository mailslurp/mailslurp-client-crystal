...
module 
  class GetOrCreateSamlUserOptions include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: issuer, type: String)]
    property issuer : String


    @[JSON::Field(key: nameId, type: String)]
    property name_id : String


    @[JSON::Field(key: nameIdFormat, type: String)]
    property name_id_format : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@issuer : String, @name_id : String, @name_id_format : String | Nil)
    end
