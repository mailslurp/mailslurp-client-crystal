...
module 
  ...
  class PhoneNumberProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @user_id : String, @phone_country : String, @created_at : Time, @provider_label : String | Nil, @line_type : String | Nil, @carrier_name : String | Nil, @mobile_country_code : String | Nil, @mobile_network_code : String | Nil, @phone_number : String)
    end
