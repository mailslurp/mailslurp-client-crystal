...
module 
  class ReputationItemProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: reputationType, type: String)]
    property reputation_type : String
    ...
    @[JSON::Field(key: severity, type: String)]
    ...
    def initialize(@created_at : Time, @recipient : String | Nil, @reputation_type : String, @id : String, @severity : String, @source : String | Nil)
    end
    ...
    def reputation_type=(reputation_type)
      ...
      unless validator.valid?(reputation_type)
        raise ArgumentError.new("invalid value for \"reputation_type\", must be one of #{validator.allowable_values}.")
      end
    ...
    def severity=(severity)
      ...
      unless validator.valid?(severity)
        raise ArgumentError.new("invalid value for \"severity\", must be one of #{validator.allowable_values}.")
      end
      @severity = severity
    end
