...
module 
  ...
  class CodeCandidate include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: confidence, type: Float64)]
    ...
    @[JSON::Field(key: context, type: String, nilable: true, emit_null: true)]
    ...
    def initialize(@code : String, @confidence : Float64, @method : String, @source : String, @context : String | Nil)
    end
