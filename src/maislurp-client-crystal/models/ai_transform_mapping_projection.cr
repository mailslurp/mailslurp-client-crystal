...
module 
  class AITransformMappingProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@user_id : String, @created_at : Time, @entity_type : String, @ai_transform_id : String, @entity_id : String | Nil, @content_selector : String | Nil, @trigger_selector : String | Nil, @name : String | Nil, @id : String)
    end
