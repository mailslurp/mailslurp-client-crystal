...
module 
  ...
  class EmailPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @subject : String | Nil, @to : Array(String) | Nil, @from : String | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @created_at : Time | Nil, @read : Bool | Nil, @attachments : Array(String) | Nil)
    end
