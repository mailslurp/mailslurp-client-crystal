...
module 
  ...
  class EmailPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @inbox_id : String | Nil, @domain_id : String | Nil, @subject : String | Nil, @to : Array(String), @from : String | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @created_at : Time, @read : Bool, @attachments : Array(String) | Nil, @thread_id : String | Nil, @message_id : String | Nil, @in_reply_to : String | Nil, @sender : Sender | Nil, @recipients : EmailRecipients | Nil, @favourite : Bool | Nil, @body_part_content_types : Array(String) | Nil, @plus_address : String | Nil, @size_bytes : Int64 | Nil)
    end
