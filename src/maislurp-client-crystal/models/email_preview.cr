...
module 
  ...
  class EmailPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @subject : String | Nil, @to : Array(String), @from : String | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @created_at : Time, @read : Bool, @attachments : Array(String) | Nil)
    end
