...
module 
  ...
  class EmailPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachments : Array(String) | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @created_at : Time | Nil, @from : String | Nil, @id : String | Nil, @read : Bool | Nil, @subject : String | Nil, @to : Array(String) | Nil)
    end
