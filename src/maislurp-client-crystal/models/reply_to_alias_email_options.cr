...
module 
  ...
  class ReplyToAliasEmailOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachments : Array(String) | Nil, @body : String | Nil, @charset : String | Nil, @is_html : Bool | Nil, @send_strategy : String | Nil, @template : String | Nil, @template_variables : Object | Nil)
    end
