...
module 
  ...
  class ReplyToAliasEmailOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@body : String, @is_html : Bool, @charset : String | Nil, @attachments : Array(String) | Nil, @template_variables : Hash(String, Object) | Nil, @template : String | Nil, @send_strategy : String | Nil, @custom_headers : Hash(String, String) | Nil, @use_inbox_name : Bool | Nil, @html : Bool | Nil)
    end
