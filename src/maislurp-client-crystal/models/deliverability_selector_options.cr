...
module 
  ...
  class DeliverabilitySelectorOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: entityIds, type: Array(String), nilable: true, emit_null: true)]
    ...
    @[JSON::Field(key: excludeEntityIds, type: Array(String), nilable: true, emit_null: true)]
    property exclude_entity_ids : Array(String)
    ...
    def initialize(@_type : String, @pattern : String | Nil, @phone_country : String | Nil, @entity_ids : Array(String) | Nil, @exclude_entity_ids : Array(String) | Nil)
    end
    ...
    def valid?
      ...
      _type_validator = EnumAttributeValidator.new("String", ["ALL", "PATTERN", "EXPLICIT"])
    ...
    def hash
      [_type, pattern, phone_country, entity_ids, exclude_entity_ids].hash
    end
