...
module 
  ...
  class EmailThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @sender : SenderProjection | Nil, @recipients : EmailRecipientsProjection | Nil, @user_id : String, @inbox_id : String | Nil, @created_at : Time, @to : Array(String), @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @updated_at : Time, @has_attachments : Bool, @unread : Bool, @message_count : Int32, @last_body_excerpt : String | Nil, @last_text_excerpt : String | Nil, @last_created_at : Time | Nil, @last_from : String | Nil, @last_sender : SenderProjection | Nil)
    end
