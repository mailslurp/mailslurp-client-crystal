...
module 
  ...
  class EmailThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@subject : String | Nil, @updated_at : Time, @user_id : String, @inbox_id : String | Nil, @created_at : Time, @to : Array(String), @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @sender : SenderProjection | Nil, @recipients : EmailRecipientsProjection | Nil, @has_attachments : Bool, @unread : Bool, @message_count : Int32, @last_body_excerpt : String | Nil, @last_text_excerpt : String | Nil, @last_created_at : Time | Nil, @last_from : String | Nil, @last_sender : SenderProjection | Nil, @id : String, @from : String | Nil)
    end
