...
module 
  ...
  class EmailThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@subject : String | Nil, @user_id : String, @inbox_id : String | Nil, @sender : SenderProjection | Nil, @recipients : EmailRecipientsProjection | Nil, @updated_at : Time, @created_at : Time, @to : Array(String), @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @has_attachments : Bool, @last_created_at : Time | Nil, @last_from : String | Nil, @last_sender : SenderProjection | Nil, @unread : Bool, @message_count : Int32, @last_body_excerpt : String | Nil, @last_text_excerpt : String | Nil, @id : String, @from : String | Nil)
    end
