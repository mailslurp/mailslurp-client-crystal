...
module 
  ...
  class ExportOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: listSeparatorToken, type: Object)]
    property list_separator_token : Object
    ...
    def initialize(@output_format : String, @exclude_previously_exported : Bool | Nil, @created_earliest_time : Time | Nil, @created_oldest_time : Time | Nil, @filter : String | Nil, @list_separator_token : Object | Nil)
    end
