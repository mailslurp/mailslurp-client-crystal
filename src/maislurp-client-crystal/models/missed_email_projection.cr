...
module 
  class MissedEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @from : String | Nil, @subject : String | Nil, @user_id : String | Nil, @created_at : Time | Nil)
    end
