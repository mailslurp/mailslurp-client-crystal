...
module 
  class PageTableData include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: headers, type: Array(String))]
    property headers : Array(String)


    @[JSON::Field(key: rows, type: Array(Array(String)))]
    property rows : Array(Array(String))


    @[JSON::Field(key: pagination, type: Pagination)]
    property pagination : Pagination

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@headers : Array(String), @rows : Array(Array(String)), @pagination : Pagination)
    end
