...
module 
  class DomainRegionInformation include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: domainName, type: String)]
    ...
    @[JSON::Field(key: creationEnabled, type: Bool)]
    property creation_enabled : Bool


    @[JSON::Field(key: sendingEnabled, type: Bool)]
    property sending_enabled : Bool
    ...
    def initialize(@domain_name : String, @verified : Bool, @domain_type : String, @account_region : String | Nil, @creation_enabled : Bool, @sending_enabled : Bool, @active : Bool)
    end
