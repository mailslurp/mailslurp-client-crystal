...
module 
  # SMS projection
  class SmsProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @body : String, @user_id : String, @created_at : Time, @phone_number : String, @from_number : String, @read : Bool)
    end
