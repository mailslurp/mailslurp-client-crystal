...
module 
  ...
  class DomainPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @domain : String | Nil, @catch_all_inbox_id : String | Nil, @created_at : Time | Nil, @domain_type : String | Nil, @verified : Bool | Nil)
    end
