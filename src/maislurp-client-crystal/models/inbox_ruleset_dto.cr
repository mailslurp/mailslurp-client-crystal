...
module 
  class InboxRulesetDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: handler, type: String)]
    ...
    def initialize(@id : String | Nil, @inbox_id : String | Nil, @scope : String | Nil, @action : String | Nil, @target : String | Nil, @handler : String | Nil, @created_at : Time | Nil)
    end
    ...
    def action=(action)
      ...
      unless validator.valid?(action)
        raise ArgumentError.new("invalid value for \"action\", must be one of #{validator.allowable_values}.")
      end
      @action = action
    end
    ...
    def handler=(handler)
      ...
      unless validator.valid?(handler)
        raise ArgumentError.new("invalid value for \"handler\", must be one of #{validator.allowable_values}.")
      end
      @handler = handler
    end
