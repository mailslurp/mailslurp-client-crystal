...
module 
  ...
  class WebhookNewEmailPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@message_id : String, @webhook_id : String, @event_name : String, @webhook_name : String | Nil, @inbox_id : String, @domain_id : String | Nil, @email_id : String, @created_at : Time, @to : Array(String), @from : String, @cc : Array(String), @bcc : Array(String), @subject : String | Nil, @attachment_meta_datas : Array(AttachmentMetaData))
    end
