...
module 
  ...
  class WebhookNewEmailPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@message_id : String | Nil, @webhook_id : String | Nil, @event_name : String | Nil, @webhook_name : String | Nil, @inbox_id : String | Nil, @email_id : String | Nil, @created_at : Time | Nil, @to : Array(String) | Nil, @from : String | Nil, @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @subject : String | Nil, @attachment_meta_datas : Array(AttachmentMetaData) | Nil)
    end
