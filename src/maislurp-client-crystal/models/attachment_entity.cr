...
module 
  class AttachmentEntity include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @attachment_id : String, @user_id : String, @content_type : String | Nil, @content_length : Int64 | Nil, @name : String | Nil, @created_at : Time, @updated_at : Time)
    end
