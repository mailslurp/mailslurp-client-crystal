...
module 
  class AttachmentEntity include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @attachment_id : String | Nil, @user_id : String | Nil, @content_type : String | Nil, @content_length : Int64 | Nil, @name : String | Nil, @created_at : Time | Nil, @updated_at : Time | Nil)
    end
