...
module 
  class AttachmentEntity include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachment_id : String, @content_length : Int64 | Nil, @content_type : String | Nil, @created_at : Time, @id : String | Nil, @name : String | Nil, @updated_at : Time, @user_id : String)
    end
