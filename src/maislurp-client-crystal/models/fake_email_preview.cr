...
module 
  class FakeEmailPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @email_address : String, @sender : Sender | Nil, @recipients : EmailRecipients | Nil, @has_attachments : Bool, @subject : String | Nil, @preview : String | Nil, @created_at : Time, @seen : Bool)
    end
