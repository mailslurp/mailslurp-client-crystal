...
module 
  class ContactProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@company : String | Nil, @created_at : Time, @email_addresses : Array(String) | Nil, @first_name : String | Nil, @group_id : String | Nil, @id : String, @last_name : String | Nil, @opt_out : Bool | Nil)
    end
