...
module 
  ...
  class ContactProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @group_id : String | Nil, @email_address : String | Nil, @created_at : Time, @first_name : String | Nil, @last_name : String | Nil, @company : String | Nil, @email_addresses : Array(String) | Nil, @opt_out : Bool)
    end
