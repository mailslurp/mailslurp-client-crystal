...
module 
  ...
  class ContactProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @email_address : String | Nil, @email_addresses : Array(String) | Nil, @first_name : String | Nil, @last_name : String | Nil, @company : String | Nil, @opt_out : Bool | Nil, @id : String, @group_id : String | Nil)
    end
