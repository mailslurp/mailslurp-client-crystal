...
module 
  ...
  class ContactProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @email_address : String | Nil, @created_at : Time, @email_addresses : Array(String) | Nil, @first_name : String | Nil, @last_name : String | Nil, @company : String | Nil, @opt_out : Bool | Nil, @group_id : String | Nil)
    end
