...
module 
  ...
  class ContactProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @group_id : String | Nil, @created_at : Time, @email_addresses : Array(String) | Nil, @opt_out : Bool, @first_name : String | Nil, @last_name : String | Nil, @company : String | Nil)
    end
