...
module 
  class FakeEmailDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @email_address : String, @sender : Sender | Nil, @recipients : EmailRecipients | Nil, @subject : String | Nil, @preview : String | Nil, @body : String, @seen : Bool, @created_at : Time)
    end
