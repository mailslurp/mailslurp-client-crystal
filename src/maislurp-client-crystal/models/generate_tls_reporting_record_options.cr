...
module 
  class GenerateTlsReportingRecordOptions include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: reportingAddresses, type: Array(String))]
    property reporting_addresses : Array(String)


    @[JSON::Field(key: reportingUrl, type: String)]
    ...
    def initialize(@reporting_addresses : Array(String), @reporting_url : String | Nil, @host : String, @version : String, @ttl : Int32)
    end
