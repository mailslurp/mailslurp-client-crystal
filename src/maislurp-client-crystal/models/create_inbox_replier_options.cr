...
module 
  ...
  class CreateInboxReplierOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@inbox_id : String | Nil, @name : String | Nil, @field : String | Nil, @match : String | Nil, @reply_to : String | Nil, @subject : String | Nil, @from : String | Nil, @charset : String | Nil, @ignore_reply_to : Bool | Nil, @is_html : Bool | Nil, @body : String | Nil, @template_id : String | Nil, @template_variables : Hash(String, Object) | Nil, @should : String | Nil, @match_options : InboxAutomationMatchOptions | Nil)
    end
