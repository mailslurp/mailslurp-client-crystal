...
module 
  ...
  class WebhookTestRequest include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: payload, type: String, nilable: true, emit_null: true)]
    ...
    def initialize(@url : String, @method : String, @headers : Hash(String, String), @payload : String | Nil)
    end
