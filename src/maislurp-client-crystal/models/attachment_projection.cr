...
module 
  class AttachmentProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachment_id : String | Nil, @content_length : Int64 | Nil, @content_type : String | Nil, @created_at : Time, @name : String | Nil, @updated_at : Time, @user_id : String)
    end
