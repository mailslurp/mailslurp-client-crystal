...
module 
  class AttachmentProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @content_length : Int64 | Nil, @content_type : String | Nil, @user_id : String | Nil, @attachment_id : String | Nil, @created_at : Time | Nil, @updated_at : Time | Nil)
    end
