...
module 
  ...
  class WebhookDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @user_id : String | Nil, @basic_auth : Bool | Nil, @name : String | Nil, @inbox_id : String | Nil, @url : String | Nil, @method : String | Nil, @payload_json_schema : String | Nil, @created_at : Time | Nil, @updated_at : Time | Nil, @event_name : String | Nil)
    end
