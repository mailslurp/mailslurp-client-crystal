...
module 
  ...
  class WebhookDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@basic_auth : Bool | Nil, @created_at : Time | Nil, @event_name : String | Nil, @id : String | Nil, @inbox_id : String | Nil, @method : String | Nil, @name : String | Nil, @payload_json_schema : String | Nil, @updated_at : Time, @url : String | Nil)
    end
