...
module 
  ...
  class WebhookDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @basic_auth : Bool, @name : String | Nil, @phone_id : String | Nil, @inbox_id : String | Nil, @url : String, @method : String, @payload_json_schema : String, @created_at : Time, @updated_at : Time, @event_name : String | Nil, @request_headers : WebhookHeaders | Nil)
    end
