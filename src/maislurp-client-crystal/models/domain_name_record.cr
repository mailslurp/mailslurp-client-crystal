...
module 
  ...
  class DomainNameRecord include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: required, type: Bool)]
    ...
    @[JSON::Field(key: alternativeRecordEntries, type: Array(String), nilable: true, emit_null: true)]
    property alternative_record_entries : Array(String)
    ...
    def initialize(@label : String, @required : Bool, @record_type : String, @name : String, @record_entries : Array(String), @ttl : Int64, @alternative_record_entries : Array(String) | Nil)
    end
