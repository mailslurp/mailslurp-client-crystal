...
module 
  class PhonePoolDetailDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: memberCount, type: Int32)]
    property member_count : Int32


    @[JSON::Field(key: availableMemberCount, type: Int32)]
    property available_member_count : Int32


    @[JSON::Field(key: leasedMemberCount, type: Int32)]
    property leased_member_count : Int32


    @[JSON::Field(key: members, type: Array(PhonePoolMemberDto))]
    property members : Array(PhonePoolMemberDto)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String, @user_id : String, @name : String, @description : String | Nil, @created_at : Time, @updated_at : Time, @member_count : Int32, @available_member_count : Int32, @leased_member_count : Int32, @members : Array(PhonePoolMemberDto))
    end
