...
module 
  ...
  class ExpirationDefaults include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@can_permanent_inbox : Bool, @default_expiration_millis : Int64 | Nil, @default_expires_at : Time | Nil, @max_expiration_millis : Int64 | Nil, @next_inbox_allows_permanent : Bool)
    end
