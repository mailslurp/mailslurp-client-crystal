...
module 
  class DomainMonitorRunComparisonDto include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: baseline, type: DomainMonitorRunDto)]
    property baseline : DomainMonitorRunDto


    @[JSON::Field(key: current, type: DomainMonitorRunDto)]
    property current : DomainMonitorRunDto
    ...
    @[JSON::Field(key: passingChecksDelta, type: Int32)]
    property passing_checks_delta : Int32


    @[JSON::Field(key: failingChecksDelta, type: Int32)]
    property failing_checks_delta : Int32


    @[JSON::Field(key: spfChanged, type: Bool)]
    property spf_changed : Bool


    @[JSON::Field(key: dmarcChanged, type: Bool)]
    property dmarc_changed : Bool


    @[JSON::Field(key: dmarcEnforcedChanged, type: Bool)]
    property dmarc_enforced_changed : Bool


    @[JSON::Field(key: mxChanged, type: Bool)]
    property mx_changed : Bool
    ...
    def initialize(@baseline : DomainMonitorRunDto, @current : DomainMonitorRunDto, @health_score_delta : Int32, @status_changed : Bool, @passing_checks_delta : Int32, @failing_checks_delta : Int32, @spf_changed : Bool, @dmarc_changed : Bool, @dmarc_enforced_changed : Bool, @mx_changed : Bool, @added_insights : Array(String), @removed_insights : Array(String))
    end
