...
module 
  class AnalyzeDmarcReportOptions include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: reportXml, type: String)]
    property report_xml : String
    ...
    def initialize(@report_xml : String, @captcha_token : String | Nil)
    end
    ...
    def report_xml=(report_xml)
      if report_xml.nil?
        raise ArgumentError.new("report_xml cannot be nil")
      end

      if report_xml.to_s.length > 1000000
        raise ArgumentError.new("invalid value for \"report_xml\", the character length must be smaller than or equal to 1000000.")
      end

      if report_xml.to_s.length < 0
        raise ArgumentError.new("invalid value for \"report_xml\", the character length must be great than or equal to 0.")
      end
