...
module 
  class PhonePoolMemberDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: activeLease, type: PhonePoolLeaseDto)]
    property active_lease : PhonePoolLeaseDto
    ...
    def initialize(@id : String, @pool_id : String, @phone_number_id : String, @phone_number : String, @phone_country : String, @phone_name : String | Nil, @created_at : Time, @active_lease : PhonePoolLeaseDto | Nil)
    end
