...
module 
  class ConnectorSyncEventDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @connector_id : String, @sync_status : String, @sync_count : Int64, @message : String | Nil, @created_at : Time)
    end
