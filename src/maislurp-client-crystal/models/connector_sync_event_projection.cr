...
module 
  ...
  class ConnectorSyncEventProjection include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: connectorId, type: String)]
    property connector_id : String


    @[JSON::Field(key: syncCount, type: Int64)]
    property sync_count : Int64


    @[JSON::Field(key: syncStatus, type: String)]
    ...
    def initialize(@connector_id : String, @sync_count : Int64, @sync_status : String, @created_at : Time, @message : String | Nil, @id : String | Nil)
    end
    ...
    def sync_status=(sync_status)
      ...
      unless validator.valid?(sync_status)
        raise ArgumentError.new("invalid value for \"sync_status\", must be one of #{validator.allowable_values}.")
      end
