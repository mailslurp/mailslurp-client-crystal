...
module 
  ...
  class AliasProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String | Nil, @updated_at : Time | Nil, @user_id : String | Nil, @email_address : String | Nil, @inbox_id : String | Nil, @created_at : Time | Nil, @use_threads : Bool | Nil)
    end
