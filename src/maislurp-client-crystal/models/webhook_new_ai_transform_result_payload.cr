...
module 
  ...
  class WebhookNewAITransformResultPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: aiTransformResultId, type: String)]
    property ai_transform_result_id : String
    ...
    @[JSON::Field(key: result, type: String, nilable: true, emit_null: true)]
    ...
    def initialize(@message_id : String, @webhook_id : String, @event_name : String, @webhook_name : String | Nil, @ai_transform_result_id : String, @user_id : String, @ai_transform_id : String, @ai_transform_mapping_id : String | Nil, @entity_id : String | Nil, @entity_type : String | Nil, @result : String | Nil)
    end
