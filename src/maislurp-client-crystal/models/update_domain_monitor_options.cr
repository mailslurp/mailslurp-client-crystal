...
module 
  ...
  class UpdateDomainMonitorOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @interval_seconds : Int64 | Nil, @enabled : Bool | Nil, @scheduling_enabled : Bool | Nil)
    end
