...
module 
  ...
  class WaitForSmsConditions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: matches, type: Array(SmsMatchOption), nilable: true, emit_null: true)]
    property matches : Array(SmsMatchOption)
    ...
    def initialize(@phone_number_id : String, @limit : Int32 | Nil, @count : Int64, @delay_timeout : Int64 | Nil, @timeout : Int64, @unread_only : Bool | Nil, @count_type : String | Nil, @matches : Array(SmsMatchOption) | Nil, @sort_direction : String | Nil, @since : Time | Nil, @before : Time | Nil)
    end
