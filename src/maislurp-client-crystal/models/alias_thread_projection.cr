...
module 
  ...
  class AliasThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@subject : String | Nil, @created_at : Time, @updated_at : Time, @user_id : String, @inbox_id : String, @to : Array(String), @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @alias_id : String, @name : String | Nil, @id : String)
    end
