...
module 
  ...
  class AliasThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@subject : String | Nil, @inbox_id : String, @user_id : String, @updated_at : Time, @created_at : Time, @to : Array(String), @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @alias_id : String, @name : String | Nil, @id : String)
    end
