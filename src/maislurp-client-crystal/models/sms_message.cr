...
module 
  class SmsMessage include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @user_id : String, @phone_number : String, @from_number : String, @body : String, @read : Bool, @sid : String, @created_at : Time, @updated_at : Time)
    end
