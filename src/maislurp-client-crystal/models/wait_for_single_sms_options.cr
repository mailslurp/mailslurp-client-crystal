...
module 
  class WaitForSingleSmsOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: delay, type: Int64)]
    ...
    def initialize(@phone_number_id : String, @timeout : Int64, @unread_only : Bool | Nil, @before : Time | Nil, @since : Time | Nil, @sort_direction : String | Nil, @delay : Int64 | Nil)
    end
