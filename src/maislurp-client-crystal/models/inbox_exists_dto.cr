...
module 
  ...
  class InboxExistsDto include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: exists, type: Bool)]
    property exists : Bool


    # Inbox is full or simulating a soft bounce via inbox replier or rulesets
    @[JSON::Field(key: softBounce, type: Bool, nilable: true, emit_null: true)]
    property soft_bounce : Bool


    # Inbox is blocking receiving emails or simulating a hard bounce via inbox replier or rulesets
    @[JSON::Field(key: hardBounce, type: Bool, nilable: true, emit_null: true)]
    property hard_bounce : Bool

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@exists : Bool, @soft_bounce : Bool | Nil, @hard_bounce : Bool | Nil)
    end
