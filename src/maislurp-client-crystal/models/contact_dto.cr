...
module 
  class ContactDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @group_id : String | Nil, @first_name : String | Nil, @last_name : String | Nil, @company : String | Nil, @email_addresses : Set(String) | Nil, @primary_email_address : String | Nil, @tags : Set(String) | Nil, @meta_data : Object | Nil, @opt_out : Bool | Nil, @created_at : Time | Nil)
    end
