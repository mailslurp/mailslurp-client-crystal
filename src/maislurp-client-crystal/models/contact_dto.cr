...
module 
  class ContactDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@company : String | Nil, @created_at : Time, @email_addresses : Array(String), @first_name : String | Nil, @group_id : String | Nil, @id : String, @last_name : String | Nil, @meta_data : Object | Nil, @opt_out : Bool | Nil, @tags : Array(String))
    end
