...
module 
  ...
  class ValidateEmailAddressListResult include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: validEmailAddresses, type: Array(String))]
    property valid_email_addresses : Array(String)


    @[JSON::Field(key: invalidEmailAddresses, type: Array(String))]
    property invalid_email_addresses : Array(String)


    @[JSON::Field(key: resultMapEmailAddressIsValid, type: Hash(String, Bool))]
    property result_map_email_address_is_valid : Hash(String, Bool)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@valid_email_addresses : Array(String), @invalid_email_addresses : Array(String), @result_map_email_address_is_valid : Hash(String, Bool))
    end
