...
module 
  ...
  class WebhookHeaders include JSON::Serializable
   include JSON::Serializable 
    # List of header name value pairs to include with webhook requests
    @[JSON::Field(key: headers, type: Array(WebhookHeaderNameValue))]
    property headers : Array(WebhookHeaderNameValue)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@headers : Array(WebhookHeaderNameValue))
    end
