...
module 
  ...
  class InboxReplierDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @inbox_id : String, @name : String | Nil, @field : String, @match : String, @reply_to : String | Nil, @subject : String | Nil, @from : String | Nil, @charset : String | Nil, @is_html : Bool, @template_id : String | Nil, @template_variables : Hash(String, Object) | Nil, @ignore_reply_to : Bool, @created_at : Time)
    end
