...
module 
  ...
  class InboxReplierDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @inbox_id : String | Nil, @name : String | Nil, @field : String | Nil, @match : String | Nil, @reply_to : String | Nil, @subject : String | Nil, @from : String | Nil, @charset : String | Nil, @is_html : Bool, @template_id : String | Nil, @template_variables : Hash(String, Object) | Nil, @ignore_reply_to : Bool, @created_at : Time, @should : String | Nil, @match_options : InboxAutomationMatchOptions | Nil)
    end
