...
module 
  ...
  class InboxPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @domain_id : String | Nil, @email_address : String, @created_at : Time, @favourite : Bool, @name : String | Nil, @tags : Array(String) | Nil, @team_access : Bool, @inbox_type : String | Nil, @virtual_inbox : Bool, @expires_at : Time | Nil, @functions_as : String | Nil, @user_id : String, @description : String | Nil, @account_region : String | Nil)
    end
