...
module 
  class InboxPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @email_address : String | Nil, @created_at : Time, @favourite : Bool, @name : String | Nil, @tags : Array(String) | Nil, @team_access : Bool, @inbox_type : String | Nil, @expires_at : String | Nil)
    end
