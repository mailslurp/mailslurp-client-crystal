...
module 
  class InboxPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time | Nil, @email_address : String | Nil, @expires_at : String | Nil, @favourite : Bool | Nil, @id : String | Nil, @inbox_type : String | Nil, @name : String | Nil, @tags : Array(String) | Nil, @team_access : Bool | Nil)
    end
