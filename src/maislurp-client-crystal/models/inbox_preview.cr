...
module 
  class InboxPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @email_address : String | Nil, @created_at : Time | Nil, @favourite : Bool | Nil, @name : String | Nil, @tags : Set(String) | Nil, @team_access : Bool | Nil, @inbox_type : String | Nil, @expires_at : String | Nil)
    end
