...
module 
  ...
  class InboxPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: expiresAt, type: String, nilable: true, emit_null: true)]
    ...
    def initialize(@id : String, @domain_id : String | Nil, @email_address : String | Nil, @created_at : Time, @favourite : Bool, @name : String | Nil, @tags : Array(String) | Nil, @team_access : Bool, @inbox_type : String | Nil, @virtual_inbox : Bool, @expires_at : String | Nil, @functions_as : String | Nil)
    end
