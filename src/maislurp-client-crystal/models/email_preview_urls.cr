...
module 
  # URLs for email body
  class EmailPreviewUrls include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: rawSmtpMessageUrl, type: String)]
    property raw_smtp_message_url : String


    @[JSON::Field(key: plainHtmlBodyUrl, type: String)]
    property plain_html_body_url : String


    @[JSON::Field(key: origin, type: String)]
    property origin : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@raw_smtp_message_url : String, @plain_html_body_url : String, @origin : String)
    end
