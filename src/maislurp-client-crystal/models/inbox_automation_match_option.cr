...
module 
  ...
  class InboxAutomationMatchOption include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: should, type: String)]
    ...
    def initialize(@field : String, @should : String, @value : String)
    end
    ...
    def value=(value)
      if value.nil?
        raise ArgumentError.new("value cannot be nil")
      end

      if value.to_s.length < 1
        raise ArgumentError.new("invalid value for \"value\", the character length must be great than or equal to 1.")
      end
