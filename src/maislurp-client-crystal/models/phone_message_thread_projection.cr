...
module 
  class PhoneMessageThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@phone_number : String | Nil, @phone_number_id : String, @other_phone_number : String | Nil, @last_message_direction : String, @last_body : String, @last_created : Time)
    end
