...
module 
  class PhoneMessageThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@other_phone_number : String | Nil, @last_message_direction : String, @last_body : String, @last_created : Time, @phone_number : String | Nil, @phone_number_id : String)
    end
