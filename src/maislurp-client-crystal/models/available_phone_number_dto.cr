...
module 
  class AvailablePhoneNumberDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@phone_number : String, @phone_country : String, @phone_variant : String | Nil, @line_type : String | Nil, @carrier_name : String | Nil, @mobile_country_code : String | Nil, @mobile_network_code : String | Nil, @provider_label : String | Nil)
    end
