...
module 
  ...
  class WebhookProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: aiTransformerId, type: String)]
    ...
    def initialize(@url : String, @password : String | Nil, @username : String | Nil, @user_id : String, @inbox_id : String | Nil, @event_name : String | Nil, @updated_at : Time, @created_at : Time, @health_status : String | Nil, @ai_transformer_id : String | Nil, @ai_transform_id : String | Nil, @phone_number_id : String | Nil, @name : String | Nil, @id : String)
    end
