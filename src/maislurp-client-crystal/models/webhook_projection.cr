...
module 
  ...
  class WebhookProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @updated_at : Time, @url : String, @user_id : String, @inbox_id : String | Nil, @event_name : String | Nil, @health_status : String | Nil, @phone_number_id : String | Nil, @name : String | Nil, @id : String, @username : String | Nil, @password : String | Nil)
    end
