...
module 
  ...
  class WebhookProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@url : String, @inbox_id : String | Nil, @event_name : String | Nil, @phone_number_id : String | Nil, @created_at : Time, @updated_at : Time, @name : String | Nil, @id : String)
    end
