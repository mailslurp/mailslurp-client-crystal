...
module 
  ...
  class WebhookProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@url : String, @password : String | Nil, @username : String | Nil, @user_id : String, @inbox_id : String | Nil, @event_name : String | Nil, @updated_at : Time, @created_at : Time, @health_status : String | Nil, @phone_number_id : String | Nil, @name : String | Nil, @id : String)
    end
