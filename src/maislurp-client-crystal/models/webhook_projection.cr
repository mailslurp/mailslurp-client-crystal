...
module 
  ...
  class WebhookProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @updated_at : Time, @url : String, @inbox_id : String | Nil, @event_name : String | Nil, @phone_number_id : String | Nil, @name : String | Nil, @id : String)
    end
