...
module 
  ...
  class WebhookProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @url : String, @inbox_id : String | Nil, @created_at : Time, @updated_at : Time, @event_name : String | Nil, @phone_number_id : String | Nil)
    end
