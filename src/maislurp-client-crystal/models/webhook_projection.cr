...
module 
  ...
  class WebhookProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @url : String, @inbox_id : String | Nil, @event_name : String | Nil, @created_at : Time, @updated_at : Time, @phone_number_id : String | Nil)
    end
