...
module 
  ...
  class WebhookProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@url : String, @password : String | Nil, @username : String | Nil, @user_id : String, @inbox_id : String | Nil, @event_name : String | Nil, @created_at : Time, @updated_at : Time, @health_status : String | Nil, @ai_transformer_id : String | Nil, @ai_transform_id : String | Nil, @phone_number_id : String | Nil, @name : String | Nil, @id : String)
    end
