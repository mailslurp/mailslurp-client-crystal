...
module 
  ...
  class WebhookProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@url : String, @password : String | Nil, @username : String | Nil, @updated_at : Time, @user_id : String, @inbox_id : String | Nil, @event_name : String | Nil, @created_at : Time, @ai_transform_id : String | Nil, @health_status : String | Nil, @ai_transformer_id : String | Nil, @phone_number_id : String | Nil, @name : String | Nil, @id : String)
    end
