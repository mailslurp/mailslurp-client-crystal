...
module 
  ...
  class WebhookNewSmsPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    # ID of SMS message
    @[JSON::Field(key: smsId, type: String)]
    ...
    @[JSON::Field(key: toNumber, type: String)]
    property to_number : String


    # Sender phone number
    @[JSON::Field(key: fromNumber, type: String)]
    property from_number : String
    ...
    def initialize(@message_id : String, @webhook_id : String, @event_name : String, @webhook_name : String | Nil, @sms_id : String, @user_id : String, @phone_number : String, @to_number : String, @from_number : String, @body : String, @read : Bool)
    end
