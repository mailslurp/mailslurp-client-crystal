...
module 
  class PhoneNumberDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @name : String | Nil, @description : String | Nil, @user_id : String, @compliance_address : String | Nil, @emergency_address : String | Nil, @phone_number : String, @phone_country : String, @phone_plan : String, @created_at : Time, @updated_at : Time, @favourite : Bool)
    end
