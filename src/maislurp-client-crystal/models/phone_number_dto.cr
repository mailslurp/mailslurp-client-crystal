...
module 
  class PhoneNumberDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: complianceAddress, type: String)]
    property compliance_address : String


    @[JSON::Field(key: emergencyAddress, type: String)]
    property emergency_address : String
    ...
    @[JSON::Field(key: phonePlan, type: String)]
    property phone_plan : String
    ...
    @[JSON::Field(key: phoneVariant, type: String)]
    property phone_variant : String


    @[JSON::Field(key: lineType, type: String)]
    property line_type : String


    @[JSON::Field(key: carrierName, type: String)]
    property carrier_name : String


    @[JSON::Field(key: mobileCountryCode, type: String)]
    property mobile_country_code : String


    @[JSON::Field(key: mobileNetworkCode, type: String)]
    property mobile_network_code : String


    @[JSON::Field(key: providerLabel, type: String)]
    ...
    def initialize(@id : String, @name : String | Nil, @description : String | Nil, @user_id : String, @compliance_address : String | Nil, @emergency_address : String | Nil, @phone_number : String, @phone_country : String, @phone_plan : String, @created_at : Time, @updated_at : Time, @favourite : Bool, @phone_variant : String | Nil, @line_type : String | Nil, @carrier_name : String | Nil, @mobile_country_code : String | Nil, @mobile_network_code : String | Nil, @provider_label : String | Nil)
    end
