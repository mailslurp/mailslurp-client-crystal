...
module 
  ...
  class DnsPropagationResolverResult include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: resolver, type: String)]
    property resolver : String


    @[JSON::Field(key: records, type: Array(String))]
    property records : Array(String)


    @[JSON::Field(key: responded, type: Bool)]
    property responded : Bool


    @[JSON::Field(key: matchedExpectedValue, type: Bool, nilable: true, emit_null: true)]
    property matched_expected_value : Bool

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@resolver : String, @records : Array(String), @responded : Bool, @matched_expected_value : Bool | Nil)
    end
