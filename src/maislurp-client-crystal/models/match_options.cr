...
module 
  ...
  class MatchOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: conditions, type: Array(ConditionOption), nilable: true, emit_null: true)]
    property conditions : Array(ConditionOption)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@matches : Array(MatchOption) | Nil, @conditions : Array(ConditionOption) | Nil)
    end
