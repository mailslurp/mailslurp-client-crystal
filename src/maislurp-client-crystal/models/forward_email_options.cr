...
module 
  ...
  class ForwardEmailOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@to : Array(String), @subject : String | Nil, @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @from : String | Nil, @use_inbox_name : Bool | Nil, @filter_bounced_recipients : Bool | Nil)
    end
    ...
    def to=(to)
      if to.nil?
        raise ArgumentError.new("to cannot be nil")
      end

      if to.length < 1
        raise ArgumentError.new("invalid value for \"to\", number of items must be greater than or equal to 1.")
      end
