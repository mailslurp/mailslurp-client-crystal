...
module 
  ...
  class ReplyToEmailOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachments : Array(String) | Nil, @body : String | Nil, @charset : String | Nil, @from : String | Nil, @is_html : Bool | Nil, @reply_to : String | Nil, @send_strategy : String | Nil, @template : String | Nil, @template_variables : Object | Nil)
    end
