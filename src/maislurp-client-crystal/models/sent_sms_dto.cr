...
module 
  class SentSmsDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: replyToSid, type: String)]
    property reply_to_sid : String


    @[JSON::Field(key: replyToId, type: String)]
    ...
    def initialize(@id : String, @user_id : String, @phone_number : String, @from_number : String, @to_number : String, @body : String, @sid : String, @reply_to_sid : String | Nil, @reply_to_id : String | Nil, @created_at : Time, @updated_at : Time)
    end
