...
module 
  class SentSmsDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @phone_number : String, @from_number : String, @to_number : String, @body : String, @sid : String, @reply_to_sid : String, @reply_to_id : String, @created_at : Time, @updated_at : Time)
    end
