...
module 
  ...
  class WebhookEmailOpenedPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time | Nil, @event_name : String | Nil, @inbox_id : String | Nil, @message_id : String | Nil, @pixel_id : String | Nil, @recipient : String | Nil, @sent_email_id : String | Nil, @webhook_id : String | Nil, @webhook_name : String | Nil)
    end
