...
module 
  ...
  class WebhookEmailOpenedPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: pixelId, type: String)]
    property pixel_id : String
    ...
    def initialize(@message_id : String, @webhook_id : String, @event_name : String, @webhook_name : String | Nil, @inbox_id : String, @pixel_id : String, @sent_email_id : String, @recipient : String, @created_at : Time)
    end
