...
module 
  ...
  class WebhookEmailOpenedPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@message_id : String | Nil, @webhook_id : String | Nil, @event_name : String | Nil, @webhook_name : String | Nil, @inbox_id : String | Nil, @pixel_id : String | Nil, @sent_email_id : String | Nil, @recipient : String | Nil, @created_at : Time | Nil)
    end
