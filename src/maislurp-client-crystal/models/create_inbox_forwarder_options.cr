...
module 
  ...
  class CreateInboxForwarderOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@field : String | Nil, @match : String | Nil, @forward_to_recipients : Array(String), @should : String | Nil, @match_options : InboxAutomationMatchOptions | Nil, @attachment_text_extraction_method : String | Nil)
    end
