...
module 
  ...
  class AbstractWebhookPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@event_name : String | Nil, @webhook_id : String | Nil, @message_id : String | Nil, @webhook_name : String | Nil)
    end
