...
module 
  ...
  class DomainDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @domain : String, @verification_token : String, @dkim_tokens : Array(String), @is_verified : Bool, @domain_name_records : Array(DomainNameRecord), @catch_all_inbox_id : String | Nil, @created_at : Time, @updated_at : Time, @domain_type : String)
    end
