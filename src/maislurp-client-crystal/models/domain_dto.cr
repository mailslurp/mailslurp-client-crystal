...
module 
  ...
  class DomainDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: duplicateRecordsMessage, type: String, nilable: true, emit_null: true)]
    property duplicate_records_message : String


    # Whether the domain has duplicated required records. If true then see the domain in the dashboard app.
    @[JSON::Field(key: hasDuplicateRecords, type: Bool)]
    property has_duplicate_records : Bool
    ...
    def initialize(@id : String, @user_id : String, @domain : String, @verification_token : String, @dkim_tokens : Array(String), @duplicate_records_message : String | Nil, @has_duplicate_records : Bool, @missing_records_message : String | Nil, @has_missing_records : Bool, @is_verified : Bool, @domain_name_records : Array(DomainNameRecord), @catch_all_inbox_id : String | Nil, @created_at : Time, @updated_at : Time, @domain_type : String)
    end
