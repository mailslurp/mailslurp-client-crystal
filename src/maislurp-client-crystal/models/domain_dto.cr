...
module 
  ...
  class DomainDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@catch_all_inbox_id : String | Nil, @created_at : Time, @dkim_tokens : Array(String) | Nil, @domain : String | Nil, @domain_name_records : Array(DomainNameRecord) | Nil, @domain_type : String | Nil, @id : String, @is_verified : Bool | Nil, @updated_at : Time, @user_id : String, @verification_token : String | Nil)
    end
