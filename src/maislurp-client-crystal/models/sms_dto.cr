...
module 
  class SmsDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @phone_number : String, @from_number : String, @to_number : String | Nil, @favourite : Bool, @body : String, @read : Bool, @created_at : Time, @updated_at : Time)
    end
