...
module 
  ...
  class SentEmailDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @user_id : String | Nil, @inbox_id : String | Nil, @to : Array(String) | Nil, @from : String | Nil, @reply_to : String | Nil, @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @attachments : Array(String) | Nil, @subject : String | Nil, @body_md5_hash : String | Nil, @body : String | Nil, @charset : String | Nil, @sent_at : Time | Nil, @pixel_ids : Array(String) | Nil, @html : Bool | Nil)
    end
