...
module 
  ...
  class SentEmailDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachments : Array(String) | Nil, @bcc : Array(String) | Nil, @body : String | Nil, @body_md5_hash : String | Nil, @cc : Array(String) | Nil, @charset : String | Nil, @from : String | Nil, @id : String | Nil, @inbox_id : String | Nil, @is_html : Bool | Nil, @pixel_ids : Array(String) | Nil, @reply_to : String | Nil, @sent_at : Time, @subject : String | Nil, @to : Array(String) | Nil, @user_id : String | Nil)
    end
