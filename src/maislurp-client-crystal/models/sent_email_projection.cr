...
module 
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@subject : String | Nil, @id : String, @body_md5_hash : String | Nil, @from : String | Nil, @inbox_id : String, @user_id : String, @attachments : Array(String), @to : Array(String), @bcc : Array(String), @cc : Array(String), @created_at : Time, @virtual_send : Bool)
    end
