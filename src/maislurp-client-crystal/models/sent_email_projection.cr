...
module 
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @thread_id : String | Nil, @in_reply_to : String | Nil, @from : String | Nil, @sender : Sender | Nil, @recipients : EmailRecipients | Nil, @subject : String | Nil, @user_id : String, @attachments : Array(String) | Nil, @inbox_id : String, @created_at : Time, @to : Array(String) | Nil, @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @message_id : String | Nil, @virtual_send : Bool, @body_excerpt : String | Nil, @text_excerpt : String | Nil, @body_md5_hash : String | Nil)
    end
