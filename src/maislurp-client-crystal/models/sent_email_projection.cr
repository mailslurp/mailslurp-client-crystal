...
module 
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @id : String, @subject : String | Nil, @from : String | Nil, @attachments : Array(String), @user_id : String, @inbox_id : String, @to : Array(String), @bcc : Array(String), @cc : Array(String), @body_md5_hash : String | Nil, @virtual_send : Bool)
    end
