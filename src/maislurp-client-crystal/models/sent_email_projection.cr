...
module 
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @id : String, @body_md5_hash : String | Nil, @user_id : String, @from : String | Nil, @subject : String | Nil, @inbox_id : String, @attachments : Array(String), @to : Array(String), @bcc : Array(String), @cc : Array(String), @virtual_send : Bool)
    end
