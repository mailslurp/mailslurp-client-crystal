...
module 
  ...
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @user_id : String, @subject : String | Nil, @inbox_id : String, @to : Array(String), @attachments : Array(String), @created_at : Time, @bcc : Array(String), @cc : Array(String), @body_md5_hash : String | Nil)
    end
