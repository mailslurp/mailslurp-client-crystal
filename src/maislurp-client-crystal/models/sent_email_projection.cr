...
module 
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @sender : Sender | Nil, @recipients : EmailRecipients | Nil, @subject : String | Nil, @user_id : String, @attachments : Array(String) | Nil, @inbox_id : String, @created_at : Time, @to : Array(String), @cc : Array(String), @bcc : Array(String), @message_id : String | Nil, @in_reply_to : String | Nil, @body_excerpt : String | Nil, @text_excerpt : String | Nil, @body_md5_hash : String | Nil, @virtual_send : Bool, @thread_id : String | Nil)
    end
