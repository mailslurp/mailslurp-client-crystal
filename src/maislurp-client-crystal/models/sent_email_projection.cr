...
module 
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@subject : String | Nil, @id : String, @user_id : String, @inbox_id : String, @attachments : Array(String) | Nil, @from : String | Nil, @sender : Sender | Nil, @recipients : EmailRecipients | Nil, @created_at : Time, @to : Array(String) | Nil, @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @message_id : String | Nil, @in_reply_to : String | Nil, @virtual_send : Bool, @body_excerpt : String | Nil, @text_excerpt : String | Nil, @body_md5_hash : String | Nil, @thread_id : String | Nil)
    end
