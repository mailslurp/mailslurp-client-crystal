...
module 
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachments : Array(String), @bcc : Array(String), @body_md5_hash : String | Nil, @cc : Array(String), @created_at : Time, @from : String | Nil, @id : String, @inbox_id : String, @subject : String | Nil, @to : Array(String), @user_id : String)
    end
