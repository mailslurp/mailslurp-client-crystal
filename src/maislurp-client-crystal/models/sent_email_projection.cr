...
module 
  ...
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @user_id : String, @inbox_id : String, @attachments : Array(String), @created_at : Time, @to : Array(String), @bcc : Array(String), @cc : Array(String), @body_md5_hash : String | Nil, @virtual_send : Bool)
    end
