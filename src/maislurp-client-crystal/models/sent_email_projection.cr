...
module 
  ...
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @user_id : String, @subject : String | Nil, @inbox_id : String, @body_md5_hash : String | Nil, @bcc : Array(String), @cc : Array(String), @virtual_send : Bool, @attachments : Array(String), @created_at : Time, @to : Array(String))
    end
