...
module 
  ...
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @attachments : Array(String), @inbox_id : String, @user_id : String, @to : Array(String), @bcc : Array(String), @cc : Array(String), @created_at : Time, @body_md5_hash : String | Nil, @virtual_send : Bool)
    end
