...
module 
  ...
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @user_id : String, @subject : String | Nil, @to : Array(String), @inbox_id : String, @attachments : Array(String), @body_md5_hash : String | Nil, @created_at : Time, @bcc : Array(String), @cc : Array(String), @virtual_send : Bool | Nil)
    end
