...
module 
  ...
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @user_id : String, @subject : String | Nil, @inbox_id : String, @attachments : Array(String), @to : Array(String), @created_at : Time, @bcc : Array(String), @cc : Array(String), @body_md5_hash : String | Nil, @virtual_send : Bool)
    end
