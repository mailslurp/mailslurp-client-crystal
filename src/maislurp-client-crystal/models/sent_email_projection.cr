...
module 
  ...
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @from : String | Nil, @user_id : String | Nil, @subject : String | Nil, @body_md5_hash : String | Nil, @inbox_id : String | Nil, @to : Array(String) | Nil, @attachments : Array(String) | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @created_at : Time | Nil)
    end
