...
module 
  ...
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @user_id : String, @subject : String | Nil, @body_md5_hash : String | Nil, @bcc : Array(String), @cc : Array(String), @virtual_send : Bool, @inbox_id : String, @attachments : Array(String), @to : Array(String), @created_at : Time)
    end
