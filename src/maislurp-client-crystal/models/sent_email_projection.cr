...
module 
  class SentEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@subject : String | Nil, @id : String, @from : String | Nil, @user_id : String, @attachments : Array(String), @inbox_id : String, @to : Array(String), @bcc : Array(String), @cc : Array(String), @created_at : Time, @body_md5_hash : String | Nil, @virtual_send : Bool)
    end
