...
module 
  class TrackingPixelDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @html : String, @id : String, @inbox_id : String | Nil, @recipient : String | Nil, @seen : Bool, @seen_at : Time | Nil, @sent_email_id : String | Nil, @url : String)
    end
