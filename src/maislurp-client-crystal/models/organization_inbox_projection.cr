...
module 
  class OrganizationInboxProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @created_at : Time, @name : String | Nil, @email_address : String | Nil, @favourite : Bool, @tags : Array(String) | Nil, @team_access : Bool, @inbox_type : String | Nil, @read_only : Bool)
    end
