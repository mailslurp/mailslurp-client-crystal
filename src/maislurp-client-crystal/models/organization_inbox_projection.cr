...
module 
  class OrganizationInboxProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time | Nil, @email_address : String | Nil, @favourite : Bool | Nil, @id : String | Nil, @name : String | Nil, @read_only : Bool | Nil, @tags : Array(String) | Nil, @team_access : Bool | Nil)
    end
