...
module 
  ...
  class OrganizationInboxProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @domain_id : String | Nil, @created_at : Time, @name : String | Nil, @email_address : String, @favourite : Bool, @tags : Array(String) | Nil, @team_access : Bool, @inbox_type : String | Nil, @read_only : Bool, @virtual_inbox : Bool, @functions_as : String | Nil, @user_id : String, @description : String | Nil, @expires_at : Time | Nil, @account_region : String | Nil)
    end
