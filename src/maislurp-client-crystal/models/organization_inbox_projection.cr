...
module 
  class OrganizationInboxProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @created_at : Time | Nil, @name : String | Nil, @email_address : String | Nil, @favourite : Bool | Nil, @tags : Set(String) | Nil, @team_access : Bool | Nil, @inbox_type : String | Nil, @read_only : Bool | Nil)
    end
