...
module 
  class ConnectorEventDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: logs, type: String)]
    ...
    def initialize(@id : String, @connector_id : String, @status : String, @event_type : String, @size : Int64, @message : String | Nil, @logs : String | Nil, @seen : Bool | Nil, @created_at : Time)
    end
