...
module 
  ...
  class EmailSignature include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: marker, type: String, nilable: true, emit_null: true)]
    property marker : String


    # Detection strategy used. Examples: DELIMITER, MOBILE_FOOTER, VALEDICTION
    @[JSON::Field(key: detectionType, type: String)]
    property detection_type : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@body : String, @source : String, @marker : String | Nil, @detection_type : String)
    end
