...
module 
  class SmsPreview include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @body : String, @phone_number : String, @from_number : String, @read : Bool, @created_at : Time)
    end
