...
module 
  ...
  class ConnectorProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @enabled : Bool | Nil, @inbox_id : String, @user_id : String, @email_address : String | Nil, @sync_enabled : Bool | Nil, @sync_schedule_type : String, @sync_interval : Int32 | Nil, @name : String | Nil, @id : String | Nil)
    end
