...
module 
  ...
  class ConnectorProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @user_id : String, @inbox_id : String, @created_at : Time, @connector_type : String, @sync_schedule_type : String, @sync_interval : Int32 | Nil, @sync_enabled : Bool)
    end
