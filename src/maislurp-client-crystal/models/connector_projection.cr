...
module 
  ...
  class ConnectorProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @inbox_id : String, @user_id : String, @created_at : Time, @sync_enabled : Bool, @connector_type : String, @sync_schedule_type : String, @sync_interval : Int32 | Nil)
    end
