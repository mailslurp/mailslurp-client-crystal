...
module 
  ...
  class ConnectorProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @user_id : String, @inbox_id : String, @sync_enabled : Bool, @connector_type : String, @sync_schedule_type : String, @sync_interval : Int32 | Nil, @id : String | Nil)
    end
