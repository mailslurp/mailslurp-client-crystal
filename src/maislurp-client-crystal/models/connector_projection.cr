...
module 
  ...
  class ConnectorProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@enabled : Bool | Nil, @user_id : String, @email_address : String | Nil, @inbox_id : String, @sync_enabled : Bool | Nil, @sync_schedule_type : String, @sync_interval : Int32 | Nil, @created_at : Time, @name : String | Nil, @id : String | Nil)
    end
