...
module 
  ...
  class ConnectorProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@user_id : String, @inbox_id : String, @sync_enabled : Bool, @connector_type : String, @sync_schedule_type : String, @sync_interval : Int32 | Nil, @created_at : Time, @id : String | Nil)
    end
