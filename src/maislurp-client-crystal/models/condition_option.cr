...
module 
  ...
  class ConditionOption include JSON::Serializable
   include JSON::Serializable 
    # Condition of an email object that can be used to filter results
    @[JSON::Field(key: condition, type: String)]
    ...
    def initialize(@condition : String | Nil, @value : String | Nil)
    end
    ...
    def condition=(condition)
      ...
      unless validator.valid?(condition)
        raise ArgumentError.new("invalid value for \"condition\", must be one of #{validator.allowable_values}.")
      end
      @condition = condition
    end
