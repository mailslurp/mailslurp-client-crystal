...
module 
  class EmailValidationRequest include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @user_id : String, @email_address : String, @is_valid : Bool, @created_at : Time, @updated_at : Time)
    end
