...
module 
  # Sent SMS projection
  class SentSmsProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@body : String, @user_id : String, @created_at : Time, @phone_number : String, @from_number : String, @to_number : String, @reply_to_id : String | Nil, @id : String)
    end
