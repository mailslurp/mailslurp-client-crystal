...
module 
  class SendWithQueueResult include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: headerId, type: String)]
    property header_id : String


    @[JSON::Field(key: delivered, type: Bool)]
    property delivered : Bool


    @[JSON::Field(key: exceptionName, type: String)]
    property exception_name : String
    ...
    def initialize(@id : String, @user_id : String, @subject : String | Nil, @inbox_id : String | Nil, @header_id : String, @delivered : Bool, @exception_name : String | Nil, @message : String | Nil, @created_at : Time, @updated_at : Time)
    end
