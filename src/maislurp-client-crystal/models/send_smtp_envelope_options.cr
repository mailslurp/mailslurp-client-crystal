...
module 
  ...
  class SendSMTPEnvelopeOptions include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: rcptTo, type: Array(String))]
    property rcpt_to : Array(String)


    @[JSON::Field(key: mailFrom, type: String)]
    ...
    def initialize(@rcpt_to : Array(String), @mail_from : String, @data : String)
    end
