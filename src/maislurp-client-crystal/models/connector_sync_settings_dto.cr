...
module 
  class ConnectorSyncSettingsDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @connector_id : String, @sync_enabled : Bool, @sync_schedule_type : String | Nil, @sync_interval : Int32 | Nil)
    end
