...
module 
  ...
  class TestNewInboxRulesetOptions include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: inboxRulesetTestOptions, type: RulesetTestOptions)]
    property inbox_ruleset_test_options : RulesetTestOptions


    @[JSON::Field(key: createRulesetOptions, type: CreateRulesetOptions)]
    property create_ruleset_options : CreateRulesetOptions

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@inbox_ruleset_test_options : RulesetTestOptions, @create_ruleset_options : CreateRulesetOptions)
    end
