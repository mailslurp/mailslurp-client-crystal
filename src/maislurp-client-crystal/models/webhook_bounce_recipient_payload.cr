...
module 
  ...
  class WebhookBounceRecipientPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@message_id : String, @webhook_id : String, @event_name : String, @webhook_name : String | Nil, @recipient : String)
    end
