...
module 
  ...
  class CreatePhoneProvisioningJobOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: items, type: Array(CreatePhoneProvisioningJobItemOptions))]
    property items : Array(CreatePhoneProvisioningJobItemOptions)
    ...
    def initialize(@phone_country : String, @phone_variant : String | Nil, @items : Array(CreatePhoneProvisioningJobItemOptions))
    end
