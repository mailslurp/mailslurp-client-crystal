...
module 
  class AITransformResultDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @ai_transform_id : String, @ai_transform_mapping_id : String, @value : Object, @entity_id : String, @entity_type : String, @created_at : Time, @updated_at : Time)
    end
