...
module 
  ...
  class MissedSmsProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @created_at : Time, @phone_number : String, @sid : String, @from_number : String)
    end
