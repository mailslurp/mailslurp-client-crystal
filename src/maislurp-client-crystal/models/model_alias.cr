...
module 
  class ModelAlias include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @email_address : String, @id : String | Nil, @inbox_id : String, @name : String | Nil, @updated_at : Time, @use_threads : Bool | Nil, @user_id : String)
    end
