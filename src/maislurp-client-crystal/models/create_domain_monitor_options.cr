...
module 
  ...
  class CreateDomainMonitorOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: intervalSeconds, type: Int64, nilable: true, emit_null: true)]
    ...
    @[JSON::Field(key: schedulingEnabled, type: Bool, nilable: true, emit_null: true)]
    property scheduling_enabled : Bool

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@domain : String, @name : String | Nil, @interval_seconds : Int64 | Nil, @enabled : Bool | Nil, @scheduling_enabled : Bool | Nil)
    end
    ...
    def domain=(domain)
      ...
      if domain.to_s.length < 1
        raise ArgumentError.new("invalid value for \"domain\", the character length must be great than or equal to 1.")
      end
    ...
    def interval_seconds=(interval_seconds)
      if !interval_seconds.nil? && interval_seconds > 604800
        raise ArgumentError.new("invalid value for \"interval_seconds\", must be smaller than or equal to 604800.")
      end

      if !interval_seconds.nil? && interval_seconds < 60
        raise ArgumentError.new("invalid value for \"interval_seconds\", must be greater than or equal to 60.")
      end
