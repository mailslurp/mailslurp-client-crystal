...
module 
  class PhonePoolDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @name : String, @description : String | Nil, @created_at : Time, @updated_at : Time, @member_count : Int32, @available_member_count : Int32, @leased_member_count : Int32)
    end
