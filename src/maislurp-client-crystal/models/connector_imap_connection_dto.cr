...
module 
  class ConnectorImapConnectionDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@connector_id : String, @imap_host : String | Nil, @imap_port : Int32 | Nil, @imap_username : String | Nil, @imap_password : String | Nil, @imap_ssl : Bool | Nil, @select_folder : String | Nil, @search_terms : String | Nil, @enabled : Bool | Nil, @created_at : Time, @id : String)
    end
