...
module 
  ...
  class EmailIntelligenceScoreBreakdownDto include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: randomnessPenalty, type: Int32)]
    property randomness_penalty : Int32


    @[JSON::Field(key: freeProviderPenalty, type: Int32)]
    property free_provider_penalty : Int32


    @[JSON::Field(key: httpsWebsitePenalty, type: Int32)]
    property https_website_penalty : Int32


    @[JSON::Field(key: dnsPenalty, type: Int32)]
    property dns_penalty : Int32


    @[JSON::Field(key: domainAgePenalty, type: Int32)]
    property domain_age_penalty : Int32


    @[JSON::Field(key: emailValidationPenalty, type: Int32)]
    property email_validation_penalty : Int32


    @[JSON::Field(key: totalPenalty, type: Int32)]
    property total_penalty : Int32

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@randomness_penalty : Int32, @free_provider_penalty : Int32, @https_website_penalty : Int32, @dns_penalty : Int32, @domain_age_penalty : Int32, @email_validation_penalty : Int32, @total_penalty : Int32)
    end
