...
module 
  class ConnectorDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: syncScheduleType, type: String, nilable: true, emit_null: true)]
    property sync_schedule_type : String


    @[JSON::Field(key: syncInterval, type: Int32, nilable: true, emit_null: true)]
    property sync_interval : Int32


    @[JSON::Field(key: hasImapConnection, type: Bool)]
    property has_imap_connection : Bool


    @[JSON::Field(key: hasSmtpConnection, type: Bool)]
    property has_smtp_connection : Bool
    ...
    def initialize(@id : String, @name : String | Nil, @enabled : Bool, @user_id : String, @inbox_id : String, @sync_enabled : Bool, @sync_schedule_type : String | Nil, @sync_interval : Int32 | Nil, @has_imap_connection : Bool, @has_smtp_connection : Bool, @created_at : Time)
    end
