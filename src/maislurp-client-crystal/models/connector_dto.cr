...
module 
  class ConnectorDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @connector_type : String, @connector_auth_type : String, @sync_enabled : Bool, @sync_schedule_type : String, @sync_interval : Int32 | Nil, @imap_host : String | Nil, @imap_port : Int32 | Nil, @imap_username : String | Nil, @imap_password : String | Nil, @imap_ssl : Bool | Nil, @created_at : Time)
    end
