...
module 
  class ConnectorDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: connectorType, type: String)]
    property connector_type : String


    @[JSON::Field(key: connectorAuthType, type: String)]
    property connector_auth_type : String


    @[JSON::Field(key: syncEnabled, type: Bool)]
    property sync_enabled : Bool


    @[JSON::Field(key: syncScheduleType, type: String)]
    property sync_schedule_type : String


    @[JSON::Field(key: syncInterval, type: Int32)]
    ...
    @[JSON::Field(key: imapPort, type: Int32)]
    ...
    @[JSON::Field(key: imapSsl, type: Bool)]
    property imap_ssl : Bool


    @[JSON::Field(key: selectFolder, type: String)]
    property select_folder : String


    @[JSON::Field(key: searchTerms, type: String)]
    ...
    def initialize(@id : String, @enabled : Bool, @user_id : String, @connector_type : String, @connector_auth_type : String, @sync_enabled : Bool, @sync_schedule_type : String, @sync_interval : Int32 | Nil, @imap_host : String | Nil, @imap_port : Int32 | Nil, @imap_username : String | Nil, @imap_password : String | Nil, @imap_ssl : Bool | Nil, @select_folder : String | Nil, @search_terms : String | Nil, @created_at : Time)
    end
    ...
    def connector_type=(connector_type)
      ...
      unless validator.valid?(connector_type)
        raise ArgumentError.new("invalid value for \"connector_type\", must be one of #{validator.allowable_values}.")
      end
    ...
    def connector_auth_type=(connector_auth_type)
      ...
      unless validator.valid?(connector_auth_type)
        raise ArgumentError.new("invalid value for \"connector_auth_type\", must be one of #{validator.allowable_values}.")
      end
    ...
    def sync_schedule_type=(sync_schedule_type)
      ...
      unless validator.valid?(sync_schedule_type)
        raise ArgumentError.new("invalid value for \"sync_schedule_type\", must be one of #{validator.allowable_values}.")
      end
