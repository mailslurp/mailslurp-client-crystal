...
module 
  ...
  class CreateInboxDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@email_address : String | Nil, @name : String | Nil, @description : String | Nil, @use_domain_pool : Bool | Nil, @tags : Array(String) | Nil, @expires_at : Time | Nil, @favourite : Bool | Nil, @expires_in : Int64 | Nil, @allow_team_access : Bool | Nil, @inbox_type : String | Nil, @virtual_inbox : Bool | Nil)
    end
