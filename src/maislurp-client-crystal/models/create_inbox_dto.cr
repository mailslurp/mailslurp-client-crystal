...
module 
  ...
  class CreateInboxDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@allow_team_access : Bool | Nil, @description : String | Nil, @email_address : String | Nil, @expires_at : Time | Nil, @expires_in : Int64 | Nil, @favourite : Bool | Nil, @name : String | Nil, @tags : Array(String) | Nil, @use_domain_pool : Bool | Nil)
    end
