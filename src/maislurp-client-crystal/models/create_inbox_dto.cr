...
module 
  ...
  class CreateInboxDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: domainName, type: String, nilable: true, emit_null: true)]
    ...
    @[JSON::Field(key: useDomainPool, type: Bool, nilable: true, emit_null: true)]
    ...
    @[JSON::Field(key: expiresIn, type: Int64, nilable: true, emit_null: true)]
    ...
    @[JSON::Field(key: allowTeamAccess, type: Bool, nilable: true, emit_null: true)]
    ...
    @[JSON::Field(key: virtualInbox, type: Bool, nilable: true, emit_null: true)]
    property virtual_inbox : Bool


    # Use a shorter email address under 31 characters
    @[JSON::Field(key: useShortAddress, type: Bool, nilable: true, emit_null: true)]
    property use_short_address : Bool


    # Prefix to add before the email address for easier labelling or identification.
    @[JSON::Field(key: prefix, type: String, nilable: true, emit_null: true)]
    ...
    def initialize(@email_address : String | Nil, @domain_name : String | Nil, @domain_id : String | Nil, @name : String | Nil, @description : String | Nil, @use_domain_pool : Bool | Nil, @tags : Array(String) | Nil, @expires_at : Time | Nil, @favourite : Bool | Nil, @expires_in : Int64 | Nil, @allow_team_access : Bool | Nil, @inbox_type : String | Nil, @virtual_inbox : Bool | Nil, @use_short_address : Bool | Nil, @prefix : String | Nil)
    end
