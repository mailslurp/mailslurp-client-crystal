...
module 
  ...
  class EmailIntelligenceResultDto include JSON::Serializable
   include JSON::Serializable 
    # Original input value before normalization.
    @[JSON::Field(key: input, type: String)]
    property input : String


    # Score from 0 to 100 where higher is better.
    @[JSON::Field(key: totalScore, type: Int32)]
    property total_score : Int32


    @[JSON::Field(key: scoreBreakdown, type: EmailIntelligenceScoreBreakdownDto)]
    property score_breakdown : EmailIntelligenceScoreBreakdownDto


    @[JSON::Field(key: signals, type: EmailIntelligenceSignalsDto)]
    property signals : EmailIntelligenceSignalsDto

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@input : String, @total_score : Int32, @score_breakdown : EmailIntelligenceScoreBreakdownDto, @signals : EmailIntelligenceSignalsDto)
    end
