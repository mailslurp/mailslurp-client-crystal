...
module 
  ...
  class TestRulesetReceivingOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: fromSender, type: String)]
    property from_sender : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@inbox_id : String | Nil, @phone_id : String | Nil, @from_sender : String)
    end
