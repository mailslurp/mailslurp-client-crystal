...
module 
  ...
  class CreateCampaignProbeOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @enabled : Bool | Nil, @interval_seconds : Int64 | Nil, @scheduling_enabled : Bool | Nil)
    end
    ...
    def name=(name)
      ...
      if !name.nil? && name.to_s.length < 1
        raise ArgumentError.new("invalid value for \"name\", the character length must be great than or equal to 1.")
      end
