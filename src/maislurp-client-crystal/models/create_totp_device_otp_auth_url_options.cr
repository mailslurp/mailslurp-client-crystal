...
module 
  class CreateTotpDeviceOtpAuthUrlOptions include JSON::Serializable
   include JSON::Serializable 
    # OTP Auth URI for connecting a TOTP device.
    @[JSON::Field(key: otpAuthUrl, type: String)]
    property otp_auth_url : String
    ...
    def initialize(@otp_auth_url : String, @name : String | Nil, @username : String | Nil, @issuer : String | Nil, @digits : Int32 | Nil, @period : Int32 | Nil, @algorithm : String | Nil)
    end
