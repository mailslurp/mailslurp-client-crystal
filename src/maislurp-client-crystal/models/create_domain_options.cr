...
module 
  ...
  class CreateDomainOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: createdCatchAllInbox, type: Bool)]
    ...
    def initialize(@created_catch_all_inbox : Bool | Nil, @description : String | Nil, @domain : String | Nil, @domain_type : String | Nil)
    end
