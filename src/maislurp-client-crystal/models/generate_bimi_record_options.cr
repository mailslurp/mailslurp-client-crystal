...
module 
  class GenerateBimiRecordOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: logoUrl, type: String)]
    property logo_url : String


    @[JSON::Field(key: vmcUrl, type: String)]
    property vmc_url : String
    ...
    def initialize(@domain : String, @version : String, @logo_url : String, @vmc_url : String | Nil)
    end
