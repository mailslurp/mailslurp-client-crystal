...
module 
  class Complaint include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: mailSource, type: String)]
    property mail_source : String


    @[JSON::Field(key: mailMessageId, type: String)]
    property mail_message_id : String


    @[JSON::Field(key: complaintRecipient, type: String)]
    property complaint_recipient : String
    ...
    def initialize(@id : String, @user_id : String | Nil, @event_type : String | Nil, @mail_source : String | Nil, @mail_message_id : String | Nil, @complaint_recipient : String, @created_at : Time, @updated_at : Time)
    end
