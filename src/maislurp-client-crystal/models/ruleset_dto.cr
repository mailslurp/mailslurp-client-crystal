...
module 
  ...
  class RulesetDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @inbox_id : String | Nil, @phone_id : String | Nil, @scope : String, @action : String, @target : String, @handler : String, @created_at : Time)
    end
