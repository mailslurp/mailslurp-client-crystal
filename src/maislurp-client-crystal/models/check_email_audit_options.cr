...
module 
  ...
  class CheckEmailAuditOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: captchaToken, type: String, nilable: true, emit_null: true)]
    property captcha_token : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@from_address : String | Nil, @recipient : String | Nil, @subject : String | Nil, @html_body : String | Nil, @text_body : String | Nil, @email_analysis : EmailAnalysis | Nil, @has_attachments : Bool | Nil, @captcha_token : String | Nil)
    end
