...
module 
  class AITransformResultProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@user_id : String, @ai_transform_id : String, @entity_id : String, @entity_type : String, @ai_transform_mapping_id : String, @value : String | Nil, @id : String)
    end
