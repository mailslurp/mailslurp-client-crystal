...
module 
  class InvokeTransformerOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: aiTransformMappingId, type: String)]
    property ai_transform_mapping_id : String


    @[JSON::Field(key: rawInput, type: String)]
    ...
    @[JSON::Field(key: rawConditions, type: Array(String))]
    property raw_conditions : Array(String)


    @[JSON::Field(key: rawInstructions, type: Array(String))]
    ...
    @[JSON::Field(key: contentSelector, type: String)]
    ...
    def initialize(@ai_transform_id : String | Nil, @ai_transform_mapping_id : String | Nil, @raw_input : String | Nil, @entity_id : String | Nil, @entity_type : String | Nil, @raw_conditions : Array(String) | Nil, @raw_instructions : Array(String) | Nil, @raw_output_schema : StructuredOutputSchema | Nil, @content_selector : String | Nil)
    end
