...
module 
  ...
  class DeliverabilityAnalyticsRunDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @name : String | Nil, @scope : String, @status : String, @created_at : Time, @start_at : Time, @completed_at : Time | Nil, @total_entities : Int64, @matched_entities : Int64, @unmatched_entities : Int64, @completion_percentage : Float64, @success_threshold_percent : Float64 | Nil, @threshold_status : String)
    end
