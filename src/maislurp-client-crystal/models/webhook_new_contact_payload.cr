...
module 
  ...
  class WebhookNewContactPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: emailAddresses, type: Set(String))]
    property email_addresses : Set(String)


    @[JSON::Field(key: tags, type: Set(String))]
    ...
    def email_addresses=(email_addresses)
      if email_addresses.nil?
        raise ArgumentError.new("email_addresses cannot be nil")
      end
    ...
    def tags=(tags)
      if tags.nil?
        raise ArgumentError.new("tags cannot be nil")
      end
