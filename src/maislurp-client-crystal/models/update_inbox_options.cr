...
module 
  ...
  class UpdateInboxOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @description : String | Nil, @tags : Set(String) | Nil, @expires_at : Time | Nil, @favourite : Bool | Nil)
    end
