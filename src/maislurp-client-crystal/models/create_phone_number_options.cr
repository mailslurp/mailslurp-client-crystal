...
module 
  class CreatePhoneNumberOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@phone_country : String, @name : String | Nil, @description : String | Nil, @schedule : String | Nil, @phone_number_endpoint_override : String | Nil, @phone_number_variant : String | Nil)
    end
