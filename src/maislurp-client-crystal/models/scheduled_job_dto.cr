...
module 
  class ScheduledJobDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: jobId, type: String)]
    ...
    @[JSON::Field(key: triggerId, type: String)]
    ...
    @[JSON::Field(key: sendAtTimestamp, type: Time)]
    property send_at_timestamp : Time
    ...
    def initialize(@id : String, @user_id : String, @inbox_id : String, @job_id : String, @group_id : String, @trigger_id : String, @status : String, @send_at_timestamp : Time, @created_at : Time, @updated_at : Time)
    end
