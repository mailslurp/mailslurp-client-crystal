...
module 
  ...
  class WebhookNewAttachmentPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachment_id : String | Nil, @content_length : Int64 | Nil, @content_type : String | Nil, @event_name : String | Nil, @message_id : String | Nil, @name : String | Nil, @webhook_id : String | Nil, @webhook_name : String | Nil)
    end
