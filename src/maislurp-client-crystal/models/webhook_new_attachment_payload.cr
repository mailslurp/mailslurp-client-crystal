...
module 
  ...
  class WebhookNewAttachmentPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@message_id : String | Nil, @webhook_id : String | Nil, @webhook_name : String | Nil, @event_name : String | Nil, @attachment_id : String | Nil, @name : String | Nil, @content_type : String | Nil, @content_length : Int64 | Nil)
    end
