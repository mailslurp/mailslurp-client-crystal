...
module 
  ...
  class ThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @subject : String | Nil, @inbox_id : String, @user_id : String, @to : Array(String), @created_at : Time, @updated_at : Time, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @alias_id : String)
    end
