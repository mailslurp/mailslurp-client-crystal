...
module 
  ...
  class ThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @subject : String | Nil, @user_id : String, @inbox_id : String, @to : Array(String), @created_at : Time, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @updated_at : Time, @alias_id : String)
    end
