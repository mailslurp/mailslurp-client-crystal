...
module 
  ...
  class ThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @inbox_id : String, @subject : String | Nil, @user_id : String, @to : Array(String), @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @created_at : Time, @updated_at : Time, @alias_id : String)
    end
