...
module 
  ...
  class ThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @updated_at : Time, @user_id : String, @inbox_id : String, @to : Array(String), @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @alias_id : String, @subject : String | Nil, @name : String | Nil, @id : String)
    end
