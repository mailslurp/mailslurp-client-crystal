...
module 
  ...
  class ThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @user_id : String, @inbox_id : String, @subject : String | Nil, @to : Array(String), @created_at : Time, @updated_at : Time, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @alias_id : String)
    end
