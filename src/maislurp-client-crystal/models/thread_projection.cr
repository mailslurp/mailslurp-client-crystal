...
module 
  ...
  class ThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@alias_id : String, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @created_at : Time, @id : String, @inbox_id : String, @name : String | Nil, @subject : String | Nil, @to : Array(String), @updated_at : Time, @user_id : String)
    end
