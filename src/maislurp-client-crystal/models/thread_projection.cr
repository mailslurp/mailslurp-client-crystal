...
module 
  ...
  class ThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@subject : String | Nil, @inbox_id : String, @user_id : String, @to : Array(String), @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @alias_id : String, @created_at : Time, @updated_at : Time, @name : String | Nil, @id : String)
    end
