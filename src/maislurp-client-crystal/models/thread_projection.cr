...
module 
  ...
  class ThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String | Nil, @subject : String | Nil, @user_id : String | Nil, @inbox_id : String | Nil, @to : Array(String) | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @created_at : Time | Nil, @updated_at : Time | Nil, @alias_id : String | Nil)
    end
