...
module 
  ...
  class ThreadProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @subject : String | Nil, @inbox_id : String, @user_id : String, @to : Array(String), @updated_at : Time, @created_at : Time, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @alias_id : String)
    end
