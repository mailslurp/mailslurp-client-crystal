...
module 
  ...
  class CreateConnectorOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: syncEnabled, type: Bool, nilable: true, emit_null: true)]
    ...
    def initialize(@sync_enabled : Bool | Nil, @sync_schedule_type : String | Nil, @sync_interval : Int32 | Nil, @name : String | Nil, @email_address : String | Nil, @enabled : Bool | Nil)
    end
