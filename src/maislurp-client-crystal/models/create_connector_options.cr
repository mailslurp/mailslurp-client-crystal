...
module 
  class CreateConnectorOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@connector_type : String, @connector_auth_type : String, @imap_settings : CreateConnectorImapOptions | Nil, @inbox_id : String | Nil, @sync_enabled : Bool, @sync_schedule_type : String, @sync_interval : Int32 | Nil)
    end
