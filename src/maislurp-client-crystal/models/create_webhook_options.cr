...
module 
  ...
  class CreateWebhookOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@url : String, @basic_auth : BasicAuthOptions | Nil, @name : String | Nil, @event_name : String | Nil, @include_headers : WebhookHeaders | Nil, @request_body_template : String | Nil, @ignore_insecure_ssl_certificates : Bool | Nil)
    end
