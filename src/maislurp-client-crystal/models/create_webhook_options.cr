...
module 
  ...
  class CreateWebhookOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: basicAuth, type: BasicAuthOptions, nilable: true, emit_null: true)]
    property basic_auth : BasicAuthOptions
    ...
    @[JSON::Field(key: includeHeaders, type: WebhookHeaders)]
    property include_headers : WebhookHeaders
    ...
    def initialize(@url : String, @basic_auth : BasicAuthOptions | Nil, @name : String | Nil, @event_name : String | Nil, @include_headers : WebhookHeaders | Nil, @request_body_template : String | Nil, @ai_transform_id : String | Nil, @use_static_ip_range : Bool | Nil, @ignore_insecure_ssl_certificates : Bool | Nil, @tags : Array(String) | Nil)
    end
