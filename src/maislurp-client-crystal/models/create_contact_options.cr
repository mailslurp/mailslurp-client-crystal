...
module 
  class CreateContactOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@first_name : String | Nil, @last_name : String | Nil, @company : String | Nil, @email_addresses : Set(String) | Nil, @tags : Set(String) | Nil, @meta_data : Object | Nil, @opt_out : Bool | Nil, @group_id : String | Nil)
    end
