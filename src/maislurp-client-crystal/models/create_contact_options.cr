...
module 
  class CreateContactOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@email_addresses : Array(String) | Nil, @first_name : String | Nil, @group_id : String | Nil, @meta_data : Object | Nil, @opt_out : Bool | Nil, @tags : Array(String) | Nil, @last_name : String | Nil, @company : String | Nil)
    end
