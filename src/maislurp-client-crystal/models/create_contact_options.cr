...
module 
  ...
  class CreateContactOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: verifyEmailAddresses, type: Bool, nilable: true, emit_null: true)]
    property verify_email_addresses : Bool

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@first_name : String | Nil, @last_name : String | Nil, @company : String | Nil, @email_addresses : Array(String) | Nil, @tags : Array(String) | Nil, @meta_data : Object | Nil, @opt_out : Bool | Nil, @group_id : String | Nil, @verify_email_addresses : Bool | Nil)
    end
