...
module 
  class EmailThreadDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @inbox_id : String | Nil, @from : String | Nil, @to : Array(String), @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @sender : Sender | Nil, @recipients : EmailRecipients | Nil, @subject : String | Nil, @created_at : Time, @updated_at : Time)
    end
