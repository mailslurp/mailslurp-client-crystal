...
module 
  ...
  class DownloadAttachmentDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: base64FileContents, type: String)]
    property base64_file_contents : String
    ...
    @[JSON::Field(key: sizeBytes, type: Int64)]
    property size_bytes : Int64

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@base64_file_contents : String | Nil, @content_type : String | Nil, @size_bytes : Int64 | Nil)
    end
