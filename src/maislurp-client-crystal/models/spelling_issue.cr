...
module 
  class SpellingIssue include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: group, type: String)]
    property group : String


    @[JSON::Field(key: suggestion, type: String)]
    ...
    def initialize(@group : String, @suggestion : String, @severity : String, @message : String)
    end
