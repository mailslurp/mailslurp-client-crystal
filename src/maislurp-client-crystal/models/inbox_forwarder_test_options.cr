...
module 
  ...
  class InboxForwarderTestOptions include JSON::Serializable
   include JSON::Serializable 
    # Simple value to test against the forwarder's simple field/match rule. Required when emailId is not provided.
    @[JSON::Field(key: testValue, type: String, nilable: true, emit_null: true)]
    property test_value : String
    ...
    def initialize(@test_value : String | Nil, @email_id : String | Nil)
    end
