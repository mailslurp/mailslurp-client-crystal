...
module 
  class CreateTotpDeviceCustomOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@secret : String, @name : String | Nil, @username : String | Nil, @issuer : String | Nil, @digits : Int32 | Nil, @period : Int32 | Nil, @algorithm : String | Nil)
    end
