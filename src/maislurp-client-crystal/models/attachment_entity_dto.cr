...
module 
  ...
  class AttachmentEntityDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @attachment_id : String, @user_id : String, @content_type : String | Nil, @content_length : Int64 | Nil, @content_id : String | Nil, @name : String | Nil, @inbox_id : String | Nil, @created_at : Time, @updated_at : Time)
    end
