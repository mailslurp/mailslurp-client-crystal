...
module 
  class PhoneProviderCapabilitiesResult include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: supportedVariants, type: Array(String))]
    property supported_variants : Array(String)
    ...
    def initialize(@provider_label : String, @phone_country : String, @supported_variants : Array(String), @warning : String | Nil)
    end
