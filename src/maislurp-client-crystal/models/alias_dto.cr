...
module 
  ...
  class AliasDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: maskedEmailAddress, type: String)]
    ...
    def initialize(@id : String | Nil, @email_address : String | Nil, @masked_email_address : String | Nil, @user_id : String | Nil, @inbox_id : String | Nil, @name : String | Nil, @use_threads : Bool | Nil, @created_at : Time | Nil, @updated_at : Time | Nil, @verified : Bool | Nil)
    end
