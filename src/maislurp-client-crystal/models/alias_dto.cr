...
module 
  ...
  class AliasDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @email_address : String, @masked_email_address : String | Nil, @user_id : String, @inbox_id : String, @name : String | Nil, @use_threads : Bool | Nil, @is_verified : Bool, @created_at : Time | Nil, @updated_at : Time | Nil)
    end
