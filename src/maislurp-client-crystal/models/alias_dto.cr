...
module 
  ...
  class AliasDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: maskedEmailAddress, type: String, nilable: true, emit_null: true)]
    property masked_email_address : String
    ...
    @[JSON::Field(key: useThreads, type: Bool, nilable: true, emit_null: true)]
    ...
    @[JSON::Field(key: updatedAt, type: Time, nilable: true, emit_null: true)]
    property updated_at : Time

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String, @email_address : String, @masked_email_address : String | Nil, @user_id : String, @inbox_id : String, @name : String | Nil, @use_threads : Bool | Nil, @is_verified : Bool, @domain_id : String | Nil, @created_at : Time | Nil, @updated_at : Time | Nil)
    end
