...
module 
  ...
  class AliasDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time | Nil, @email_address : String | Nil, @id : String, @inbox_id : String | Nil, @is_verified : Bool | Nil, @masked_email_address : String | Nil, @name : String | Nil, @updated_at : Time | Nil, @use_threads : Bool | Nil, @user_id : String)
    end
