...
module 
  class PhonePoolLeaseDto include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: id, type: String)]
    property id : String


    @[JSON::Field(key: poolId, type: String)]
    ...
    @[JSON::Field(key: phoneName, type: String)]
    property phone_name : String


    @[JSON::Field(key: leaseName, type: String)]
    property lease_name : String


    @[JSON::Field(key: leaseOwner, type: String)]
    property lease_owner : String


    @[JSON::Field(key: leasedAt, type: Time)]
    property leased_at : Time
    ...
    def initialize(@id : String, @pool_id : String, @phone_number_id : String, @phone_number : String, @phone_country : String, @phone_name : String | Nil, @lease_name : String | Nil, @lease_owner : String | Nil, @leased_at : Time, @expires_at : Time | Nil)
    end
