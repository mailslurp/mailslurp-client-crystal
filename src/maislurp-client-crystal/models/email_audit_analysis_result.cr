...
module 
  ...
  class EmailAuditAnalysisResult include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: detectedLinks, type: Int32)]
    property detected_links : Int32
    ...
    @[JSON::Field(key: detectedImages, type: Int32)]
    property detected_images : Int32
    ...
    @[JSON::Field(key: spellingIssueCount, type: Int32)]
    property spelling_issue_count : Int32


    @[JSON::Field(key: brokenLinks, type: Array(EmailAuditUrlIssue))]
    property broken_links : Array(EmailAuditUrlIssue)


    @[JSON::Field(key: brokenImages, type: Array(EmailAuditUrlIssue))]
    property broken_images : Array(EmailAuditUrlIssue)


    @[JSON::Field(key: spellingIssues, type: Array(EmailAuditSpellingIssue))]
    property spelling_issues : Array(EmailAuditSpellingIssue)
    ...
    @[JSON::Field(key: featureSupport, type: EmailFeatureSupportResult)]
    property feature_support : EmailFeatureSupportResult
    ...
    @[JSON::Field(key: htmlValidation, type: HTMLValidationResult, nilable: true, emit_null: true)]
    property html_validation : HTMLValidationResult


    @[JSON::Field(key: reputationFailureCount, type: Int32)]
    property reputation_failure_count : Int32
    ...
    @[JSON::Field(key: externalCheckSkippedCount, type: Int32)]
    property external_check_skipped_count : Int32
    ...
    def initialize(@status : String, @health_score : Int32, @total_checks : Int32, @passing_checks : Int32, @failing_checks : Int32, @detected_links : Int32, @checked_links : Int32, @detected_images : Int32, @checked_images : Int32, @link_issue_count : Int32, @image_issue_count : Int32, @spelling_issue_count : Int32, @broken_links : Array(EmailAuditUrlIssue), @broken_images : Array(EmailAuditUrlIssue), @spelling_issues : Array(EmailAuditSpellingIssue), @compatibility_warning_count : Int32, @compatibility_not_supported_count : Int32, @compatibility_unknown_count : Int32, @feature_support : EmailFeatureSupportResult | Nil, @html_error_count : Int32, @html_warning_count : Int32, @html_info_count : Int32, @html_validation : HTMLValidationResult | Nil, @reputation_failure_count : Int32, @attachment_mention_issue_count : Int32, @external_check_skipped_count : Int32, @insights : Array(String), @error_message : String | Nil)
    end
