...
module 
  class PhonePlanAvailabilityItem include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: phoneCountry, type: String)]
    property phone_country : String


    @[JSON::Field(key: availabilityStatus, type: String)]
    property availability_status : String


    @[JSON::Field(key: variants, type: Array(String))]
    property variants : Array(String)
    ...
    def initialize(@phone_country : String, @availability_status : String, @variants : Array(String) | Nil)
    end
    ...
    def availability_status=(availability_status)
      ...
      unless validator.valid?(availability_status)
        raise ArgumentError.new("invalid value for \"availability_status\", must be one of #{validator.allowable_values}.")
      end
