...
module 
  class ImapFlagOperationOptions include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: flagOperation, type: String)]
    property flag_operation : String
    ...
    def initialize(@flag_operation : String, @flags : Array(String))
    end
    ...
    def flag_operation=(flag_operation)
      ...
      unless validator.valid?(flag_operation)
        raise ArgumentError.new("invalid value for \"flag_operation\", must be one of #{validator.allowable_values}.")
      end
