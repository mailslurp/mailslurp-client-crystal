...
module 
  ...
  class PhoneNumberReleaseProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @user_id : String, @phone_country : String, @created_at : Time, @phone_number : String | Nil, @subscription_schedule : String | Nil, @plan_currency : String | Nil)
    end
