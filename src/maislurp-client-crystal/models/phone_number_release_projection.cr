...
module 
  ...
  class PhoneNumberReleaseProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@user_id : String, @created_at : Time, @phone_country : String, @phone_number : String | Nil, @subscription_schedule : String | Nil, @plan_currency : String | Nil, @name : String | Nil, @id : String)
    end
