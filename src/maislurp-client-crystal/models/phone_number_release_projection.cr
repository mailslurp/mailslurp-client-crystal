...
module 
  ...
  class PhoneNumberReleaseProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: subscriptionSchedule, type: String)]
    property subscription_schedule : String


    @[JSON::Field(key: planCurrency, type: String)]
    property plan_currency : String
    ...
    def initialize(@user_id : String, @created_at : Time, @phone_number : String | Nil, @phone_country : String, @subscription_schedule : String | Nil, @plan_currency : String | Nil, @name : String | Nil, @id : String)
    end
    ...
    def subscription_schedule=(subscription_schedule)
      ...
      unless validator.valid?(subscription_schedule)
        raise ArgumentError.new("invalid value for \"subscription_schedule\", must be one of #{validator.allowable_values}.")
      end
    ...
    def plan_currency=(plan_currency)
      ...
      unless validator.valid?(plan_currency)
        raise ArgumentError.new("invalid value for \"plan_currency\", must be one of #{validator.allowable_values}.")
      end
