...
module 
  ...
  class ExtractAttachmentTextOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: maxBytes, type: Int64, nilable: true, emit_null: true)]
    property max_bytes : Int64
    ...
    def initialize(@method : String | Nil, @allow_fallback : Bool | Nil, @max_bytes : Int64 | Nil)
    end
