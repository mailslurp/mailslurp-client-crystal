...
module 
  ...
  class GuestPortalUserProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @updated_at : Time, @user_id : String, @email_address : String | Nil, @inbox_id : String | Nil, @portal_id : String, @name : String | Nil, @id : String, @username : String)
    end
