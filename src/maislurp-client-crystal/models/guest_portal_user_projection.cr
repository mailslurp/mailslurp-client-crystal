...
module 
  ...
  class GuestPortalUserProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@username : String, @updated_at : Time, @user_id : String, @email_address : String | Nil, @inbox_id : String | Nil, @created_at : Time, @portal_id : String, @name : String | Nil, @id : String)
    end
