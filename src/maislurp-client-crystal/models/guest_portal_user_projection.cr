...
module 
  ...
  class GuestPortalUserProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @username : String, @user_id : String, @email_address : String | Nil, @inbox_id : String | Nil, @updated_at : Time, @created_at : Time, @portal_id : String)
    end
