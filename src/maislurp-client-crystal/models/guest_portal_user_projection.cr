...
module 
  ...
  class GuestPortalUserProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @id : String, @username : String, @email_address : String | Nil, @user_id : String, @inbox_id : String | Nil, @created_at : Time, @updated_at : Time, @portal_id : String)
    end
