...
module 
  ...
  class GuestPortalUserProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@username : String, @user_id : String, @inbox_id : String | Nil, @email_address : String | Nil, @created_at : Time, @updated_at : Time, @portal_id : String, @name : String | Nil, @id : String)
    end
