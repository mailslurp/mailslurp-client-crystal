...
module 
  ...
  class GuestPortalUserProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@username : String, @inbox_id : String | Nil, @user_id : String, @email_address : String | Nil, @updated_at : Time, @created_at : Time, @portal_id : String, @name : String | Nil, @id : String)
    end
