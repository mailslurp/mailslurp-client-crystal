...
module 
  ...
  class WaitForConditions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@inbox_id : String | Nil, @count : Int32 | Nil, @delay_timeout : Int64 | Nil, @timeout : Int64, @unread_only : Bool | Nil, @count_type : String | Nil, @matches : Array(MatchOption) | Nil, @sort_direction : String | Nil, @since : Time | Nil, @before : Time | Nil)
    end
