...
module 
  ...
  class WaitForConditions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@count : Int32, @count_type : String | Nil, @inbox_id : String, @matches : Array(MatchOption) | Nil, @since : Time | Nil, @sort_direction : String | Nil, @timeout : Int64, @unread_only : Bool | Nil)
    end
