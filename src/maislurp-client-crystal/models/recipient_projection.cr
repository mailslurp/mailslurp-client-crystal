...
module 
  class RecipientProjection include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: emailAddress, type: String)]
    property email_address : String


    @[JSON::Field(key: rawValue, type: String)]
    ...
    def initialize(@email_address : String, @raw_value : String, @name : String | Nil)
    end
