...
module 
  class EntityFavouriteItemProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @entity_type : String, @name : String, @id : String, @description : String | Nil)
    end
