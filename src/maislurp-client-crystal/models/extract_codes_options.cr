...
module 
  ...
  class ExtractCodesOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: customPatterns, type: Array(String), nilable: true, emit_null: true)]
    property custom_patterns : Array(String)
    ...
    def initialize(@method : String | Nil, @allow_fallback : Bool | Nil, @min_length : Int32 | Nil, @max_length : Int32 | Nil, @max_candidates : Int32 | Nil, @custom_patterns : Array(String) | Nil)
    end
