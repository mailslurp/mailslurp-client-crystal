...
module 
  class CreateAITransformerMappingOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: triggerSelector, type: String, nilable: true, emit_null: true)]
    property trigger_selector : String


    @[JSON::Field(key: spreadRootArray, type: Bool, nilable: true, emit_null: true)]
    property spread_root_array : Bool
    ...
    def initialize(@name : String | Nil, @ai_transform_id : String, @entity_id : String | Nil, @entity_type : String, @content_selector : String | Nil, @trigger_selector : String | Nil, @spread_root_array : Bool | Nil, @match_options : AIMappingMatchOptions | Nil)
    end
    ...
    def trigger_selector=(trigger_selector)
      ...
      unless validator.valid?(trigger_selector)
        raise ArgumentError.new("invalid value for \"trigger_selector\", must be one of #{validator.allowable_values}.")
      end
