...
module 
  class CreateAITransformerMappingOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: triggerSelector, type: String)]
    property trigger_selector : String


    @[JSON::Field(key: spreadRootArray, type: Bool)]
    ...
    def initialize(@name : String, @ai_transform_id : String, @entity_id : String, @entity_type : String, @content_selector : String | Nil, @trigger_selector : String | Nil, @spread_root_array : Bool | Nil)
    end
