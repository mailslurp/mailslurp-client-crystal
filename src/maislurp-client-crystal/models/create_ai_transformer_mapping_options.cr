...
module 
  class CreateAITransformerMappingOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String | Nil, @ai_transform_id : String, @entity_id : String | Nil, @entity_type : String, @content_selector : String | Nil, @trigger_selector : String | Nil, @spread_root_array : Bool | Nil)
    end
