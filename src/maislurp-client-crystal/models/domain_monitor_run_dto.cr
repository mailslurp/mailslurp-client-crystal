...
module 
  class DomainMonitorRunDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: spfOk, type: Bool)]
    property spf_ok : Bool


    @[JSON::Field(key: dmarcOk, type: Bool)]
    property dmarc_ok : Bool


    @[JSON::Field(key: dmarcEnforced, type: Bool)]
    property dmarc_enforced : Bool


    @[JSON::Field(key: mxOk, type: Bool)]
    property mx_ok : Bool
    ...
    def initialize(@id : String, @monitor_id : String, @user_id : String, @domain : String, @status : String, @trigger_source : String, @health_score : Int32, @total_checks : Int32, @passing_checks : Int32, @failing_checks : Int32, @spf_ok : Bool, @dmarc_ok : Bool, @dmarc_enforced : Bool, @mx_ok : Bool, @insights : Array(String), @error_message : String | Nil, @created_at : Time, @updated_at : Time)
    end
