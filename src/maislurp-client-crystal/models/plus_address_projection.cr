...
module 
  class PlusAddressProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: plusAddress, type: String)]
    property plus_address : String


    @[JSON::Field(key: fullAddress, type: String)]
    ...
    def initialize(@created_at : Time, @updated_at : Time, @user_id : String, @inbox_id : String, @plus_address : String, @full_address : String, @id : String)
    end
