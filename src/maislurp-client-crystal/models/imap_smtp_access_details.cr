...
module 
  ...
  class ImapSmtpAccessDetails include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: secureImapServerHost, type: String)]
    property secure_imap_server_host : String


    # Secure TLS IMAP server host port
    @[JSON::Field(key: secureImapServerPort, type: Int32)]
    property secure_imap_server_port : Int32


    # Secure TLS IMAP username for login
    @[JSON::Field(key: secureImapUsername, type: String)]
    property secure_imap_username : String


    # Secure TLS IMAP password for login
    @[JSON::Field(key: secureImapPassword, type: String)]
    property secure_imap_password : String
    ...
    @[JSON::Field(key: imapMailbox, type: String)]
    property imap_mailbox : String
    ...
    def initialize(@email_address : String, @secure_smtp_server_host : String, @secure_smtp_server_port : Int32, @secure_smtp_username : String, @secure_smtp_password : String, @smtp_server_host : String, @smtp_server_port : Int32, @smtp_username : String, @smtp_password : String, @secure_imap_server_host : String, @secure_imap_server_port : Int32, @secure_imap_username : String, @secure_imap_password : String, @imap_server_host : String, @imap_server_port : Int32, @imap_username : String, @imap_password : String, @imap_mailbox : String, @mail_from_domain : String | Nil)
    end
