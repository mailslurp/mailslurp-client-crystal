...
module 
  ...
  class WebhookEmailReadPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    # Is the email read
    @[JSON::Field(key: emailIsRead, type: Bool)]
    property email_is_read : Bool
    ...
    def initialize(@message_id : String, @webhook_id : String, @event_name : String, @webhook_name : String | Nil, @email_id : String, @inbox_id : String, @email_is_read : Bool, @created_at : Time)
    end
