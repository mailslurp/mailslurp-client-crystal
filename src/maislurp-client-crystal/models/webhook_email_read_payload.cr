...
module 
  ...
  class WebhookEmailReadPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@message_id : String | Nil, @webhook_id : String | Nil, @event_name : String | Nil, @webhook_name : String | Nil, @email_id : String | Nil, @inbox_id : String | Nil, @email_is_read : Bool | Nil, @created_at : Time | Nil)
    end
