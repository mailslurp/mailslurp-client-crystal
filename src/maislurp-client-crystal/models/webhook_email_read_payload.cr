...
module 
  ...
  class WebhookEmailReadPayload include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time | Nil, @email_id : String | Nil, @email_is_read : Bool | Nil, @event_name : String | Nil, @inbox_id : String | Nil, @message_id : String | Nil, @webhook_id : String | Nil, @webhook_name : String | Nil)
    end
