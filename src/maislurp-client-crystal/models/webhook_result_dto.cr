...
module 
  class WebhookResultDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @user_id : String, @inbox_id : String, @webhook_id : String, @webhook_url : String, @message_id : String, @redrive_id : String | Nil, @http_method : String, @webhook_event : String, @response_status : Int32 | Nil, @response_time_millis : Int64, @response_body_extract : String | Nil, @result_type : String | Nil, @created_at : Time, @updated_at : Time, @seen : Bool | Nil)
    end
