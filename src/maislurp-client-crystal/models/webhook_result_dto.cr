...
module 
  ...
  class WebhookResultDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: aiTransformerId, type: String, nilable: true, emit_null: true)]
    property ai_transformer_id : String
    ...
    def initialize(@id : String | Nil, @user_id : String, @webhook_id : String, @webhook_url : String, @message_id : String, @redrive_id : String | Nil, @http_method : String, @webhook_event : String, @response_status : Int32 | Nil, @response_time_millis : Int64, @response_body_extract : String | Nil, @result_type : String | Nil, @created_at : Time, @updated_at : Time, @seen : Bool, @inbox_id : String | Nil, @email_id : String | Nil, @attachment_id : String | Nil, @phone_id : String | Nil, @sms_id : String | Nil, @ai_transformer_id : String | Nil)
    end
