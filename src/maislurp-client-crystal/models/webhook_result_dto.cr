...
module 
  class WebhookResultDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @user_id : String | Nil, @inbox_id : String | Nil, @webhook_id : String | Nil, @webhook_url : String | Nil, @message_id : String | Nil, @redrive_id : String | Nil, @http_method : String | Nil, @webhook_event : String | Nil, @response_status : Int32 | Nil, @response_time_millis : Int64 | Nil, @response_body_extract : String | Nil, @result_type : String | Nil, @created_at : Time | Nil, @updated_at : Time | Nil, @seen : Bool | Nil)
    end
