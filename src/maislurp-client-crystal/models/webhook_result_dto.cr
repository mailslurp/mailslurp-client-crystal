...
module 
  class WebhookResultDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @http_method : String, @id : String | Nil, @inbox_id : String, @message_id : String, @redrive_id : String | Nil, @response_body_extract : String | Nil, @response_status : Int32 | Nil, @response_time_millis : Int64, @result_type : String | Nil, @seen : Bool | Nil, @updated_at : Time, @user_id : String, @webhook_event : String, @webhook_id : String, @webhook_url : String)
    end
