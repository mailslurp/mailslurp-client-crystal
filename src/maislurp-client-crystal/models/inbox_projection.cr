...
module 
  class InboxProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @email_address : String | Nil, @favourite : Bool, @id : String, @inbox_type : String | Nil, @name : String | Nil, @tags : Array(String) | Nil, @team_access : Bool)
    end
