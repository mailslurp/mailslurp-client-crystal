...
module 
  ...
  class EmailIntelligenceListResult include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: content, type: Array(EmailIntelligenceResultDto))]
    property content : Array(EmailIntelligenceResultDto)
    ...
    @[JSON::Field(key: billableCount, type: Int64)]
    property billable_count : Int64

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@content : Array(EmailIntelligenceResultDto), @page : Int32, @size : Int32, @total_elements : Int64, @total_pages : Int32, @billable_count : Int64)
    end
