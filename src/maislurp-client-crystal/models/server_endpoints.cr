...
module 
  class ServerEndpoints include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: tls, type: Bool)]
    property tls : Bool


    @[JSON::Field(key: altPorts, type: Array(Int32))]
    property alt_ports : Array(Int32)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@host : String, @port : Int32, @tls : Bool, @alt_ports : Array(Int32))
    end
