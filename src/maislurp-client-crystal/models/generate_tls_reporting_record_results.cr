...
module 
  class GenerateTlsReportingRecordResults include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@name : String, @_type : String, @ttl : Int32, @value : String)
    end
