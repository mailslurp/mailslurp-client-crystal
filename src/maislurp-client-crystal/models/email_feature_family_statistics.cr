...
module 
  class EmailFeatureFamilyStatistics include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: feature, type: String)]
    property feature : String


    @[JSON::Field(key: family, type: String)]
    property family : String


    @[JSON::Field(key: platforms, type: Array(EmailFeaturePlatformStatistics))]
    property platforms : Array(EmailFeaturePlatformStatistics)
    ...
    def initialize(@feature : String, @family : String, @platforms : Array(EmailFeaturePlatformStatistics))
    end
    ...
    def family=(family)
      ...
      unless validator.valid?(family)
        raise ArgumentError.new("invalid value for \"family\", must be one of #{validator.allowable_values}.")
      end
      @family = family
    end
