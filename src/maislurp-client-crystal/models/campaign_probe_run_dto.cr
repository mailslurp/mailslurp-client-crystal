...
module 
  class CampaignProbeRunDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: errorMessage, type: String)]
    property error_message : String


    @[JSON::Field(key: fromAddress, type: String)]
    property from_address : String


    @[JSON::Field(key: recipient, type: String)]
    ...
    @[JSON::Field(key: sourceMessageId, type: String)]
    property source_message_id : String


    @[JSON::Field(key: processingMs, type: Int64)]
    property processing_ms : Int64
    ...
    def initialize(@id : String, @probe_id : String, @user_id : String, @status : String, @source : String, @health_score : Int32, @total_checks : Int32, @passing_checks : Int32, @failing_checks : Int32, @checked_links : Int32, @checked_images : Int32, @link_issue_count : Int32, @image_issue_count : Int32, @compatibility_warning_count : Int32, @compatibility_not_supported_count : Int32, @compatibility_unknown_count : Int32, @html_error_count : Int32, @html_warning_count : Int32, @html_info_count : Int32, @reputation_failure_count : Int32, @attachment_mention_issue_count : Int32, @insights : Array(String), @error_message : String | Nil, @from_address : String | Nil, @recipient : String | Nil, @subject : String | Nil, @message_id : String | Nil, @source_message_id : String | Nil, @processing_ms : Int64 | Nil, @created_at : Time, @updated_at : Time)
    end
