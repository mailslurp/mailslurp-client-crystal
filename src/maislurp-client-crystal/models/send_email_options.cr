...
module 
  ...
  class SendEmailOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: templateVariables, type: Hash(String, Object))]
    ...
    @[JSON::Field(key: filterBouncedRecipients, type: Bool)]
    property filter_bounced_recipients : Bool


    # Validate recipient email addresses before sending
    @[JSON::Field(key: validateEmailAddresses, type: String)]
    ...
    def initialize(@to_contacts : Array(String) | Nil, @to_group : String | Nil, @to : Array(String) | Nil, @from : String | Nil, @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @subject : String | Nil, @reply_to : String | Nil, @body : String | Nil, @html : Bool | Nil, @is_html : Bool | Nil, @charset : String | Nil, @attachments : Array(String) | Nil, @template_variables : Hash(String, Object) | Nil, @template : String | Nil, @send_strategy : String | Nil, @use_inbox_name : Bool | Nil, @add_tracking_pixel : Bool | Nil, @filter_bounced_recipients : Bool | Nil, @validate_email_addresses : String | Nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@to_contacts.nil? && @to_contacts.length > 10
        invalid_properties.push("invalid value for \"to_contacts\", number of items must be less than or equal to 10."
      end

      if !@to_contacts.nil? && @to_contacts.length < 0
        invalid_properties.push("invalid value for \"to_contacts\", number of items must be greater than or equal to 0."
      end

      if !@to.nil? && @to.length > 10
        invalid_properties.push("invalid value for \"to\", number of items must be less than or equal to 10."
      end

      if !@to.nil? && @to.length < 0
        invalid_properties.push("invalid value for \"to\", number of items must be greater than or equal to 0."
      end

      if !@cc.nil? && @cc.length > 10
        invalid_properties.push("invalid value for \"cc\", number of items must be less than or equal to 10."
      end

      if !@cc.nil? && @cc.length < 0
        invalid_properties.push("invalid value for \"cc\", number of items must be greater than or equal to 0."
      end

      if !@bcc.nil? && @bcc.length > 10
        invalid_properties.push("invalid value for \"bcc\", number of items must be less than or equal to 10."
      end

      if !@bcc.nil? && @bcc.length < 0
        invalid_properties.push("invalid value for \"bcc\", number of items must be greater than or equal to 0."
      end
    ...
    def valid?
      return false if !@to_contacts.nil? && @to_contacts.length > 10
      return false if !@to_contacts.nil? && @to_contacts.length < 0
      return false if !@to.nil? && @to.length > 10
      return false if !@to.nil? && @to.length < 0
      return false if !@cc.nil? && @cc.length > 10
      return false if !@cc.nil? && @cc.length < 0
      return false if !@bcc.nil? && @bcc.length > 10
      return false if !@bcc.nil? && @bcc.length < 0
    ...
    # @param [Object] to_contacts Value to be assigned
    def to_contacts=(to_contacts)
      if !to_contacts.nil? && to_contacts.length > 10
        raise ArgumentError.new("invalid value for \"to_contacts\", number of items must be less than or equal to 10.")
      end

      if !to_contacts.nil? && to_contacts.length < 0
        raise ArgumentError.new("invalid value for \"to_contacts\", number of items must be greater than or equal to 0.")
      end
    ...
    def to=(to)
      if !to.nil? && to.length > 10
        raise ArgumentError.new("invalid value for \"to\", number of items must be less than or equal to 10.")
      end

      if !to.nil? && to.length < 0
        raise ArgumentError.new("invalid value for \"to\", number of items must be greater than or equal to 0.")
      end
    ...
    def cc=(cc)
      if !cc.nil? && cc.length > 10
        raise ArgumentError.new("invalid value for \"cc\", number of items must be less than or equal to 10.")
      end

      if !cc.nil? && cc.length < 0
        raise ArgumentError.new("invalid value for \"cc\", number of items must be greater than or equal to 0.")
      end
    ...
    def bcc=(bcc)
      if !bcc.nil? && bcc.length > 10
        raise ArgumentError.new("invalid value for \"bcc\", number of items must be less than or equal to 10.")
      end

      if !bcc.nil? && bcc.length < 0
        raise ArgumentError.new("invalid value for \"bcc\", number of items must be greater than or equal to 0.")
      end
