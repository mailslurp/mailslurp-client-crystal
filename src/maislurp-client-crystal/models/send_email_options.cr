...
module 
  ...
  class SendEmailOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachments : Array(String) | Nil, @bcc : Array(String) | Nil, @body : String | Nil, @cc : Array(String) | Nil, @charset : String | Nil, @from : String | Nil, @html : Bool | Nil, @is_html : Bool | Nil, @reply_to : String | Nil, @send_strategy : String | Nil, @subject : String | Nil, @template : String | Nil, @template_variables : Object | Nil, @to : Array(String) | Nil, @to_contacts : Array(String) | Nil, @to_group : String | Nil, @use_inbox_name : Bool | Nil)
    end
