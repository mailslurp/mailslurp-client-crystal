...
module 
  ...
  class SendEmailOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@to_contacts : Array(String) | Nil, @to_group : String | Nil, @to : Array(String) | Nil, @from : String | Nil, @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @subject : String | Nil, @reply_to : String | Nil, @body : String | Nil, @html : Bool | Nil, @charset : String | Nil, @attachments : Array(String) | Nil, @template_variables : Hash(String, Object) | Nil, @template : String | Nil, @send_strategy : String | Nil, @use_inbox_name : Bool | Nil, @add_tracking_pixel : Bool | Nil)
    end
