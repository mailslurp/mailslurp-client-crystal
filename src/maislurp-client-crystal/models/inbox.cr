...
module 
  ...
  class Inbox include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time | Nil, @description : String | Nil, @email_address : String | Nil, @expires_at : String | Nil, @favourite : Bool | Nil, @id : String | Nil, @inbox_type : String | Nil, @name : String | Nil, @read_only : Bool | Nil, @tags : Array(String) | Nil, @team_access : Bool | Nil, @user_id : String | Nil)
    end
