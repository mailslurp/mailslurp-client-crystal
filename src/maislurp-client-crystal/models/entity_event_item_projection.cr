...
module 
  class EntityEventItemProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@inbox_id : String | Nil, @event_type : String, @phone_id : String | Nil, @id : String, @severity : String)
    end
