...
module 
  class ImapMailboxStatus include JSON::Serializable
   include JSON::Serializable 
    ...
    # Results map
    @[JSON::Field(key: items, type: Object, nilable: true, emit_null: true)]
    ...
    def initialize(@name : String, @read_only : Bool, @items : Object, @flags : Array(String), @permanent_flags : Array(String), @unseen_seq_num : Int64, @messages : Int32, @recent : Int32, @unseen : Int32, @uid_next : Int64, @uid_validity : Int32, @append_limit : Int32 | Nil)
    end
