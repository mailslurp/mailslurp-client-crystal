...
module 
  class ImapMailboxStatus include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: items, type: Hash(String, Object), nilable: true, emit_null: true)]
    property items : Hash(String, Object)


    # The mailbox flags.
    @[JSON::Field(key: flags, type: Array(String), nilable: true, emit_null: true)]
    property flags : Array(String)


    # The mailbox permanent flags.
    @[JSON::Field(key: permanentFlags, type: Array(String), nilable: true, emit_null: true)]
    property permanent_flags : Array(String)


    # The sequence number of the first unseen message in the mailbox.
    @[JSON::Field(key: unseenSeqNum, type: Int64)]
    property unseen_seq_num : Int64


    # The number of messages in this mailbox.
    @[JSON::Field(key: messages, type: Int32)]
    property messages : Int32


    # The number of messages not seen since the last time the mailbox was opened.
    @[JSON::Field(key: recent, type: Int32)]
    property recent : Int32


    # The number of unread messages.
    @[JSON::Field(key: unseen, type: Int32)]
    property unseen : Int32


    # The next UID.
    @[JSON::Field(key: uidNext, type: Int64)]
    property uid_next : Int64


    # Together with a UID, it is a unique identifier for a message. Must be greater than or equal to 1.
    @[JSON::Field(key: uidValidity, type: Int32)]
    property uid_validity : Int32


    # Per-mailbox limit of message size. Set only if server supports the APPENDLIMIT extension
    @[JSON::Field(key: appendLimit, type: Int32, nilable: true, emit_null: true)]
    property append_limit : Int32

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@name : String, @read_only : Bool, @items : Hash(String, Object), @flags : Array(String), @permanent_flags : Array(String), @unseen_seq_num : Int64, @messages : Int32, @recent : Int32, @unseen : Int32, @uid_next : Int64, @uid_validity : Int32, @append_limit : Int32 | Nil)
    end
