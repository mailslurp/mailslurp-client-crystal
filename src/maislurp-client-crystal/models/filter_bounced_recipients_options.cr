...
module 
  ...
  class FilterBouncedRecipientsOptions include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: emailRecipients, type: Array(String))]
    property email_recipients : Array(String)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@email_recipients : Array(String))
    end
