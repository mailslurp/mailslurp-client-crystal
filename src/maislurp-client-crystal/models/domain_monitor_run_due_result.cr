...
module 
  class DomainMonitorRunDueResult include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@trigger_source : String, @run_count : Int32, @requested_max_runs : Int32, @executed_at : Time)
    end
