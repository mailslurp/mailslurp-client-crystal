...
module 
  ...
  class ImapServerFetchItem include JSON::Serializable
   include JSON::Serializable 
    ...
    # UID of the email
    @[JSON::Field(key: uid, type: Int32)]
    property uid : Int32


    # Sequence number of the email
    @[JSON::Field(key: seqNum, type: Int32)]
    property seq_num : Int32
    ...
    def initialize(@content : String, @id : String, @uid : Int32, @seq_num : Int32, @read : Bool)
    end
