...
module 
  class CheckEmailBodyResults include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: hasIssues, type: Bool)]
    property has_issues : Bool


    @[JSON::Field(key: linkIssues, type: Array(LinkIssue))]
    property link_issues : Array(LinkIssue)


    @[JSON::Field(key: imageIssues, type: Array(ImageIssue))]
    property image_issues : Array(ImageIssue)


    @[JSON::Field(key: spellingIssues, type: Array(SpellingIssue))]
    property spelling_issues : Array(SpellingIssue)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@has_issues : Bool, @link_issues : Array(LinkIssue), @image_issues : Array(ImageIssue), @spelling_issues : Array(SpellingIssue))
    end
