...
module 
  class MissedEmail include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachment_count : Int32, @bcc : Array(String), @body_excerpt : String | Nil, @cc : Array(String), @created_at : Time, @id : String | Nil, @inbox_ids : Array(String), @subject : String | Nil, @to : Array(String), @updated_at : Time, @user_id : String)
    end
