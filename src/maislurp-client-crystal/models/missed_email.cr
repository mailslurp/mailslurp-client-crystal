...
module 
  class MissedEmail include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @user_id : String | Nil, @subject : String | Nil, @body_excerpt : String | Nil, @attachment_count : Int32 | Nil, @from : String | Nil, @to : Array(String) | Nil, @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @inbox_ids : Array(String) | Nil, @created_at : Time | Nil, @updated_at : Time | Nil)
    end
