...
module 
  ...
  class MissedEmail include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: rawUrl, type: String)]
    property raw_url : String


    @[JSON::Field(key: rawKey, type: String)]
    property raw_key : String


    @[JSON::Field(key: rawBucket, type: String)]
    property raw_bucket : String


    @[JSON::Field(key: canRestore, type: Bool)]
