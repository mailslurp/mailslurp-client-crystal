...
module 
  ...
  class CheckEmailAuthStackResults include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: spf, type: LookupSpfDomainResults)]
    property spf : LookupSpfDomainResults


    @[JSON::Field(key: dmarc, type: LookupDmarcDomainResults)]
    property dmarc : LookupDmarcDomainResults


    @[JSON::Field(key: dkim, type: LookupDkimDomainResults)]
    property dkim : LookupDkimDomainResults


    @[JSON::Field(key: bimi, type: LookupBimiDomainResults)]
    property bimi : LookupBimiDomainResults


    @[JSON::Field(key: mx, type: LookupMxRecordsResults)]
    property mx : LookupMxRecordsResults


    @[JSON::Field(key: mtaSts, type: LookupMtaStsDomainResults)]
    property mta_sts : LookupMtaStsDomainResults


    @[JSON::Field(key: tlsReporting, type: LookupTlsReportingDomainResults)]
    property tls_reporting : LookupTlsReportingDomainResults
    ...
    def initialize(@domain : String, @status : String, @health_score : Int32, @total_checks : Int32, @passing_checks : Int32, @failing_checks : Int32, @spf : LookupSpfDomainResults, @dmarc : LookupDmarcDomainResults, @dkim : LookupDkimDomainResults, @bimi : LookupBimiDomainResults, @mx : LookupMxRecordsResults, @mta_sts : LookupMtaStsDomainResults, @tls_reporting : LookupTlsReportingDomainResults, @insights : Array(String), @warnings : Array(String), @errors : Array(String))
    end
