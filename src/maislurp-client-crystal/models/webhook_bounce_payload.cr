...
module 
  ...
  class WebhookBouncePayload include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: bounceId, type: String)]
    property bounce_id : String
    ...
    def initialize(@message_id : String, @webhook_id : String, @event_name : String, @webhook_name : String | Nil, @bounce_id : String, @sent_to_recipients : Array(String) | Nil, @sender : String, @bounce_recipients : Array(String) | Nil)
    end
