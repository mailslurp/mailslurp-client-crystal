...
module 
  class EmailScreenshotResult include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: base64EncodedImage, type: String)]
    property base64_encoded_image : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@base64_encoded_image : String)
    end
