...
module 
  ...
  class UploadAttachmentOptions include JSON::Serializable
   include JSON::Serializable 
    # Optional contentId for file.
    @[JSON::Field(key: contentId, type: String, nilable: true, emit_null: true)]
    property content_id : String


    # Optional contentType for file. For instance `application/pdf`
    @[JSON::Field(key: contentType, type: String, nilable: true, emit_null: true)]
    property content_type : String


    # Optional filename to save upload with. Will be the name that is shown in email clients
    @[JSON::Field(key: filename, type: String, nilable: true, emit_null: true)]
    ...
    @[JSON::Field(key: base64Contents, type: String)]
    property base64_contents : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@content_id : String | Nil, @content_type : String | Nil, @filename : String | Nil, @base64_contents : String)
    end
    ...
    def base64_contents=(base64_contents)
      if base64_contents.nil?
        raise ArgumentError.new("base64_contents cannot be nil")
      end

      if base64_contents.to_s.length < 1
        raise ArgumentError.new("invalid value for \"base64_contents\", the character length must be great than or equal to 1.")
      end
