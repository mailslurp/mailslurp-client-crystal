...
module 
  ...
  class GenerateStructuredContentEmailOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: instructions, type: String)]
    ...
    def initialize(@email_id : String, @content_selector : String | Nil, @instructions : String | Nil, @output_schema : StructuredOutputSchema)
    end
