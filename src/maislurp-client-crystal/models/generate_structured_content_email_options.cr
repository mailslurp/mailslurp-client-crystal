...
module 
  ...
  class GenerateStructuredContentEmailOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: instructions, type: String, nilable: true, emit_null: true)]
    ...
    @[JSON::Field(key: transformId, type: String, nilable: true, emit_null: true)]
    property transform_id : String
    ...
    def initialize(@email_id : String, @content_selector : String | Nil, @instructions : String | Nil, @output_schema : StructuredOutputSchema | Nil, @transform_id : String | Nil)
    end
