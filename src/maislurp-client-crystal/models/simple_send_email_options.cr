...
module 
  ...
  class SimpleSendEmailOptions include JSON::Serializable
   include JSON::Serializable 
    # ID of inbox to send from. If null an inbox will be created for sending
    @[JSON::Field(key: senderId, type: String, nilable: true, emit_null: true)]
    ...
    def initialize(@sender_id : String | Nil, @to : String, @body : String | Nil, @subject : String | Nil)
    end
