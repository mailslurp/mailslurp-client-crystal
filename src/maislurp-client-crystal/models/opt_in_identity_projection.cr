...
module 
  class OptInIdentityProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @email_address : String, @updated_at : Time, @created_at : Time, @verified : Bool | Nil)
    end
