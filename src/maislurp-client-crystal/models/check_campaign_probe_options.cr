...
module 
  ...
  class CheckCampaignProbeOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@from_address : String | Nil, @subject : String | Nil, @recipient : String | Nil, @message_id : String | Nil, @html_body : String | Nil, @text_body : String | Nil, @captcha_token : String | Nil)
    end
    ...
    def message_id=(message_id)
      if !message_id.nil? && message_id.to_s.length > 998
        raise ArgumentError.new("invalid value for \"message_id\", the character length must be smaller than or equal to 998.")
      end

      if !message_id.nil? && message_id.to_s.length < 0
        raise ArgumentError.new("invalid value for \"message_id\", the character length must be great than or equal to 0.")
      end
