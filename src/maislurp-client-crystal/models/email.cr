...
module 
  ...
  class Email include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@analysis : EmailAnalysis | Nil, @attachments : Array(String) | Nil, @bcc : Array(String) | Nil, @body : String | Nil, @body_excerpt : String | Nil, @body_md5_hash : String | Nil, @cc : Array(String) | Nil, @charset : String | Nil, @created_at : Time | Nil, @from : String | Nil, @headers : Hash(String, String) | Nil, @id : String | Nil, @inbox_id : String | Nil, @is_html : Bool | Nil, @read : Bool | Nil, @recipients : EmailRecipients | Nil, @reply_to : String | Nil, @sender : Sender | Nil, @subject : String | Nil, @team_access : Bool | Nil, @to : Array(String) | Nil, @updated_at : Time | Nil, @user_id : String | Nil)
    end
