...
module 
  ...
  class Email include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String, @inbox_id : String, @to : Array(String), @from : String | Nil, @sender : Sender | Nil, @recipients : EmailRecipients | Nil, @reply_to : String | Nil, @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @headers : Hash(String, String) | Nil, @attachments : Array(String) | Nil, @subject : String | Nil, @body : String | Nil, @body_excerpt : String | Nil, @body_md5_hash : String | Nil, @is_html : Bool | Nil, @charset : String | Nil, @analysis : EmailAnalysis | Nil, @created_at : Time, @updated_at : Time, @read : Bool, @team_access : Bool, @html : Bool | Nil)
    end
