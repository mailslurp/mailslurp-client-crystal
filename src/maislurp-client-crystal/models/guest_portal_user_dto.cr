...
module 
  class GuestPortalUserDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: portalId, type: String)]
    ...
    def initialize(@id : String, @user_id : String, @portal_id : String, @name : String | Nil, @username : String, @email_address : String | Nil, @inbox_id : String | Nil, @login_url : String, @created_at : Time, @updated_at : Time)
    end
