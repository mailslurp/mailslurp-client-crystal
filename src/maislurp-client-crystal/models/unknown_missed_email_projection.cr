...
module 
  class UnknownMissedEmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @from : String | Nil, @subject : String | Nil, @to : Array(String) | Nil, @created_at : Time | Nil)
    end
