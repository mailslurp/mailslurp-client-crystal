...
module 
  class PlusAddressDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @plus_address : String, @full_address : String, @user_id : String, @inbox_id : String, @created_at : Time, @updated_at : Time)
    end
