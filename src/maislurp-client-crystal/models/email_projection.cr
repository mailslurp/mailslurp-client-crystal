...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @inbox_id : String, @attachments : Array(String) | Nil, @body_md5_hash : String | Nil, @body_excerpt : String | Nil, @to : Array(String), @created_at : Time, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @domain_id : String | Nil, @team_access : Bool, @read : Bool)
    end
