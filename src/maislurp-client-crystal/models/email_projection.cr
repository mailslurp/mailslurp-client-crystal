...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @from : String | Nil, @subject : String | Nil, @inbox_id : String | Nil, @to : Array(String) | Nil, @attachments : Array(String) | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @created_at : Time | Nil, @team_access : Bool | Nil, @read : Bool | Nil, @body_md5_hash : String | Nil, @body_excerpt : String | Nil)
    end
