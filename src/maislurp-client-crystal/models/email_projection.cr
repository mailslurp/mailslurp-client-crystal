...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@inbox_id : String, @attachments : Array(String) | Nil, @to : Array(String), @domain_id : String | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @read : Bool, @body_excerpt : String | Nil, @team_access : Bool, @body_md5_hash : String | Nil, @text_excerpt : String | Nil, @created_at : Time, @subject : String | Nil, @id : String, @from : String | Nil)
    end
