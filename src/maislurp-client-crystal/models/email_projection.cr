...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @attachments : Array(String) | Nil, @inbox_id : String, @to : Array(String), @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @created_at : Time, @domain_id : String | Nil, @read : Bool, @team_access : Bool, @body_md5_hash : String | Nil, @body_excerpt : String | Nil)
    end
