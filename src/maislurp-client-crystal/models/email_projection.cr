...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@subject : String | Nil, @created_at : Time, @sender : Sender | Nil, @recipients : EmailRecipients | Nil, @attachments : Array(String) | Nil, @inbox_id : String, @to : Array(String), @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @message_id : String | Nil, @domain_id : String | Nil, @favourite : Bool | Nil, @plus_address : String | Nil, @in_reply_to : String | Nil, @read : Bool, @body_excerpt : String | Nil, @text_excerpt : String | Nil, @body_part_content_types : Array(String) | Nil, @body_md5_hash : String | Nil, @team_access : Bool, @id : String, @thread_id : String | Nil, @from : String)
    end
