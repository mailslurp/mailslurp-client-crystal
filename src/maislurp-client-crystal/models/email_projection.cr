...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @inbox_id : String, @attachments : Array(String) | Nil, @to : Array(String), @team_access : Bool | Nil, @read : Bool | Nil, @body_md5_hash : String | Nil, @body_excerpt : String | Nil, @created_at : Time, @bcc : Array(String) | Nil, @cc : Array(String) | Nil)
    end
