...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @thread_id : String | Nil, @from : String, @subject : String | Nil, @sender : Sender | Nil, @recipients : EmailRecipients | Nil, @inbox_id : String, @attachments : Array(String) | Nil, @size_bytes : Int64 | Nil, @created_at : Time, @to : Array(String), @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @message_id : String | Nil, @favourite : Bool | Nil, @domain_id : String | Nil, @plus_address : String | Nil, @imap_uid : Int64 | Nil, @in_reply_to : String | Nil, @read : Bool, @body_excerpt : String | Nil, @text_excerpt : String | Nil, @body_part_content_types : Array(String) | Nil, @body_md5_hash : String | Nil, @team_access : Bool)
    end
