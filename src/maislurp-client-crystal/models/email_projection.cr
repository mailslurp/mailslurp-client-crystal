...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@sender : Sender | Nil, @recipients : EmailRecipients | Nil, @attachments : Array(String) | Nil, @inbox_id : String, @created_at : Time, @to : Array(String), @cc : Array(String) | Nil, @bcc : Array(String) | Nil, @message_id : String | Nil, @domain_id : String | Nil, @favourite : Bool | Nil, @in_reply_to : String | Nil, @plus_address : String | Nil, @size_bytes : Int64 | Nil, @read : Bool, @body_excerpt : String | Nil, @text_excerpt : String | Nil, @body_part_content_types : Array(String) | Nil, @body_md5_hash : String | Nil, @team_access : Bool, @subject : String | Nil, @id : String, @thread_id : String | Nil, @from : String)
    end
