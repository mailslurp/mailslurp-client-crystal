...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @attachments : Array(String) | Nil, @inbox_id : String, @to : Array(String), @created_at : Time, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @team_access : Bool, @read : Bool, @body_md5_hash : String | Nil, @body_excerpt : String | Nil)
    end
