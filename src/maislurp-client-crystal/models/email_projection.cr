...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @inbox_id : String, @attachments : Array(String) | Nil, @created_at : Time, @to : Array(String), @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @read : Bool, @domain_id : String | Nil, @body_excerpt : String | Nil, @team_access : Bool, @body_md5_hash : String | Nil)
    end
