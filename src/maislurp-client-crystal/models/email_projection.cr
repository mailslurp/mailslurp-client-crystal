...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @inbox_id : String, @created_at : Time, @attachments : Array(String) | Nil, @to : Array(String), @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @domain_id : String | Nil, @body_md5_hash : String | Nil, @read : Bool, @body_excerpt : String | Nil, @team_access : Bool)
    end
