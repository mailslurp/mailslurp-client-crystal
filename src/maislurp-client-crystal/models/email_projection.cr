...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @created_at : Time, @subject : String | Nil, @inbox_id : String, @to : Array(String), @attachments : Array(String) | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @team_access : Bool | Nil, @read : Bool | Nil, @body_md5_hash : String | Nil, @body_excerpt : String | Nil)
    end
