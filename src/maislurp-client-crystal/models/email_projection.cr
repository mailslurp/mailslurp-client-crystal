...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachments : Array(String) | Nil, @inbox_id : String, @to : Array(String), @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @domain_id : String | Nil, @read : Bool, @body_excerpt : String | Nil, @team_access : Bool, @body_md5_hash : String | Nil, @text_excerpt : String | Nil, @created_at : Time, @subject : String | Nil, @id : String, @from : String | Nil)
    end
