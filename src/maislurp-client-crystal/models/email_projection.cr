...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @created_at : Time, @inbox_id : String, @attachments : Array(String) | Nil, @to : Array(String), @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @team_access : Bool | Nil, @read : Bool | Nil, @body_md5_hash : String | Nil, @body_excerpt : String | Nil)
    end
