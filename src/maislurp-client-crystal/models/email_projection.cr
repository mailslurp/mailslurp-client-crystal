...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@attachments : Array(String) | Nil, @bcc : Array(String) | Nil, @body_md5_hash : String | Nil, @cc : Array(String) | Nil, @created_at : Time, @from : String | Nil, @id : String, @inbox_id : String, @read : Bool | Nil, @subject : String | Nil, @team_access : Bool | Nil, @to : Array(String))
    end
