...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @from : String | Nil, @subject : String | Nil, @attachments : Array(String) | Nil, @inbox_id : String, @created_at : Time, @to : Array(String), @domain_id : String | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @read : Bool, @body_excerpt : String | Nil, @team_access : Bool, @body_md5_hash : String | Nil)
    end
