...
module 
  ...
  class EmailProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@created_at : Time, @attachments : Array(String) | Nil, @inbox_id : String, @to : Array(String), @domain_id : String | Nil, @bcc : Array(String) | Nil, @cc : Array(String) | Nil, @read : Bool, @body_excerpt : String | Nil, @team_access : Bool, @body_md5_hash : String | Nil, @text_excerpt : String | Nil, @subject : String | Nil, @id : String, @from : String | Nil)
    end
