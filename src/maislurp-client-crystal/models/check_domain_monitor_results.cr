...
module 
  ...
  class CheckDomainMonitorResults include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@domain : String, @status : String, @health_score : Int32, @total_checks : Int32, @passing_checks : Int32, @failing_checks : Int32, @spf_ok : Bool, @dmarc_ok : Bool, @dmarc_enforced : Bool, @mx_ok : Bool, @insights : Array(String), @error_message : String | Nil)
    end
