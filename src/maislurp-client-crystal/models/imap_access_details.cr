...
module 
  ...
  class ImapAccessDetails include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@secure_imap_server_host : String, @secure_imap_server_port : Int32, @secure_imap_username : String, @secure_imap_password : String, @imap_server_host : String, @imap_server_port : Int32, @imap_username : String, @imap_password : String, @imap_mailbox : String)
    end
