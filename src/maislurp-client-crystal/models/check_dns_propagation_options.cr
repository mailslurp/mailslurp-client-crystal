...
module 
  class CheckDnsPropagationOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: expectedValue, type: String)]
    property expected_value : String


    @[JSON::Field(key: captchaToken, type: String)]
    ...
    def initialize(@host : String, @record_type : String, @expected_value : String | Nil, @captcha_token : String | Nil)
    end
