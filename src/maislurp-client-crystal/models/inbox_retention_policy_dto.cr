...
module 
  class InboxRetentionPolicyDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @inbox_id : String | Nil, @retention_days : Int32, @created_at : Time, @updated_at : Time)
    end
