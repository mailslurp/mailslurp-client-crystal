...
module 
  class GenerateMtaStsRecordResults include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: wellKnownValue, type: String)]
    property well_known_value : String


    @[JSON::Field(key: wellKnownUrl, type: String)]
    property well_known_url : String
    ...
    def initialize(@name : String, @_type : String, @ttl : Int32, @value : String, @well_known_value : String, @well_known_url : String)
    end
    ...
    def valid?
      ...
      _type_validator = EnumAttributeValidator.new("String", ["A", "NS", "MD", "MF", "CNAME", "SOA", "MB", "MG", "MR", "NULL", "WKS", "PTR", "HINFO", "MINFO", "MX", "TXT", "RP", "AFSDB", "X25", "ISDN", "RT", "NSAP", "NSAP_PTR", "SIG", "KEY", "PX", "GPOS", "AAAA", "LOC", "NXT", "EID", "NIMLOC", "SRV", "ATMA", "NAPTR", "KX", "CERT", "A6", "DNAME", "SINK", "OPT", "APL", "DS", "SSHFP", "IPSECKEY", "RRSIG", "NSEC", "DNSKEY", "DHCID", "NSEC3", "NSEC3PARAM", "TLSA", "SMIMEA", "HIP", "NINFO", "RKEY", "TALINK", "CDS", "CDNSKEY", "OPENPGPKEY", "CSYNC", "ZONEMD", "SVCB", "HTTPS", "SPF", "UINFO", "UID", "GID", "UNSPEC", "NID", "L32", "L64", "LP", "EUI48", "EUI64", "TKEY", "TSIG", "IXFR", "AXFR", "MAILB", "MAILA", "ANY", "URI", "CAA", "AVC", "DOA", "AMTRELAY", "TA", "DLV"])
    ...
    def hash
      [name, _type, ttl, value, well_known_value, well_known_url].hash
    end
