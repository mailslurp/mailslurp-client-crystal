...
module 
  ...
  class InboxForwarderDto include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: field, type: String, nilable: true, emit_null: true)]
    property field : String


    # Pattern to apply to field
    @[JSON::Field(key: match, type: String, nilable: true, emit_null: true)]
    ...
    @[JSON::Field(key: should, type: String, nilable: true, emit_null: true)]
    property should : String


    @[JSON::Field(key: matchOptions, type: InboxAutomationMatchOptions, nilable: true, emit_null: true)]
    property match_options : InboxAutomationMatchOptions


    # Method for extracting text from attachments.
    @[JSON::Field(key: attachmentTextExtractionMethod, type: String, nilable: true, emit_null: true)]
    property attachment_text_extraction_method : String
    ...
    def initialize(@id : String, @inbox_id : String | Nil, @name : String | Nil, @field : String | Nil, @match : String | Nil, @forward_to_recipients : Array(String), @created_at : Time, @should : String | Nil, @match_options : InboxAutomationMatchOptions | Nil, @attachment_text_extraction_method : String | Nil)
    end
    ...
    def should=(should)
      ...
      unless validator.valid?(should)
        raise ArgumentError.new("invalid value for \"should\", must be one of #{validator.allowable_values}.")
      end
      @should = should
    end
    ...
    def attachment_text_extraction_method=(attachment_text_extraction_method)
      ...
      unless validator.valid?(attachment_text_extraction_method)
        raise ArgumentError.new("invalid value for \"attachment_text_extraction_method\", must be one of #{validator.allowable_values}.")
      end
