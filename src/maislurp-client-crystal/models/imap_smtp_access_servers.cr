...
module 
  ...
  class ImapSmtpAccessServers include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: imapServer, type: ServerEndpoints)]
    property imap_server : ServerEndpoints


    @[JSON::Field(key: secureImapServer, type: ServerEndpoints)]
    property secure_imap_server : ServerEndpoints


    @[JSON::Field(key: smtpServer, type: ServerEndpoints)]
    property smtp_server : ServerEndpoints


    @[JSON::Field(key: secureSmtpServer, type: ServerEndpoints)]
    property secure_smtp_server : ServerEndpoints

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@imap_server : ServerEndpoints, @secure_imap_server : ServerEndpoints, @smtp_server : ServerEndpoints, @secure_smtp_server : ServerEndpoints)
    end
