...
module 
  class AddPhonePoolNumbersOptions include JSON::Serializable
   include JSON::Serializable 
    @[JSON::Field(key: phoneNumberIds, type: Array(String))]
    property phone_number_ids : Array(String)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@phone_number_ids : Array(String))
    end
