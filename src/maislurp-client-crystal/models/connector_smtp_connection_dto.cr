...
module 
  class ConnectorSmtpConnectionDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@connector_id : String, @smtp_host : String | Nil, @smtp_port : Int32 | Nil, @smtp_username : String | Nil, @smtp_password : String | Nil, @smtp_ssl : Bool | Nil, @enabled : Bool | Nil, @created_at : Time, @id : String)
    end
