...
module 
  ...
  class InboxDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @user_id : String | Nil, @created_at : Time, @name : String | Nil, @description : String | Nil, @email_address : String, @expires_at : String | Nil, @favourite : Bool, @tags : Set(String) | Nil, @inbox_type : String | Nil, @read_only : Bool)
    end
