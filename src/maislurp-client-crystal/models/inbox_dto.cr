...
module 
  ...
  class InboxDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String | Nil, @user_id : String | Nil, @created_at : Time | Nil, @name : String | Nil, @description : String | Nil, @email_address : String | Nil, @expires_at : String | Nil, @favourite : Bool | Nil, @tags : Set(String) | Nil, @inbox_type : String | Nil, @read_only : Bool | Nil)
    end
