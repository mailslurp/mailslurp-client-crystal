...
module 
  class AITransformResultProjectionDto include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@id : String, @ai_transform_id : String, @ai_transform_mapping_id : String | Nil, @user_id : String, @value : Object | Nil, @entity_id : String | Nil, @entity_type : String | Nil, @created_at : Time)
    end
