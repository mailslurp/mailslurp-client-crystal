...
module 
  ...
  class UpdateInboxReplierOptions include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@inbox_id : String, @name : String | Nil, @field : String, @match : String, @reply_to : String | Nil, @subject : String | Nil, @from : String | Nil, @charset : String | Nil, @is_html : Bool | Nil, @ignore_reply_to : Bool | Nil, @body : String | Nil, @template_id : String | Nil, @template_variables : Hash(String, Object) | Nil)
    end
