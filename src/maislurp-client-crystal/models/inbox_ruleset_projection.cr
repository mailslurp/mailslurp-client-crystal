...
module 
  ...
  class InboxRulesetProjection include JSON::Serializable
   include JSON::Serializable 
    ...
    def initialize(@action : String, @handler : String, @id : String, @inbox_id : String, @scope : String, @target : String)
    end
