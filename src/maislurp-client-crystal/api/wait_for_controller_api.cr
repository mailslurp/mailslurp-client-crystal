...
module 
  class WaitForControllerApi
    ...
    # @return [Array(EmailPreview)]
    def wait_for_email_count(before : Time?, count : Int32?, delay : Int64?, inbox_id : String?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      data, _status_code, _headers = wait_for_email_count_with_http_info(before, count, delay, inbox_id, since, sort, timeout, unread_only)
      data
    end
    ...
    # If inbox contains count or more emails at time of request then return count worth of emails. If not wait until the count is reached and return those or return an error if timeout is exceeded.
    # @return [Array<(Array(EmailPreview), Integer, Hash)>] Array(EmailPreview) data, response status code and response headers
    def wait_for_email_count_with_http_info(before : Time?, count : Int32?, delay : Int64?, inbox_id : String?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      if @api_client.config.debugging
    ...
    # @return [Email]
    def wait_for_latest_email(before : Time?, delay : Int64?, inbox_id : String?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      data, _status_code, _headers = wait_for_latest_email_with_http_info(before, delay, inbox_id, since, sort, timeout, unread_only)
      data
    end
    ...
    def wait_for_latest_email_with_http_info(before : Time?, delay : Int64?, inbox_id : String?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      if @api_client.config.debugging
    ...
    # @return [Array(EmailPreview)]
    def wait_for_matching_emails(match_options : MatchOptions, before : Time?, count : Int32?, delay : Int64?, inbox_id : String?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      data, _status_code, _headers = wait_for_matching_emails_with_http_info(match_options, before, count, delay, inbox_id, since, sort, timeout, unread_only)
      data
    end
    ...
    # @param match_options [MatchOptions] matchOptions
    # @return [Array<(Array(EmailPreview), Integer, Hash)>] Array(EmailPreview) data, response status code and response headers
    def wait_for_matching_emails_with_http_info(match_options : MatchOptions, before : Time?, count : Int32?, delay : Int64?, inbox_id : String?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      if @api_client.config.debugging
    ...
    # @param match_options [MatchOptions] matchOptions
    # @return [Email]
    def wait_for_matching_first_email(match_options : MatchOptions, before : Time?, delay : Int64?, inbox_id : String?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      data, _status_code, _headers = wait_for_matching_first_email_with_http_info(match_options, before, delay, inbox_id, since, sort, timeout, unread_only)
      data
    end
    ...
    # @param match_options [MatchOptions] matchOptions
    # @return [Array<(Email, Integer, Hash)>] Email data, response status code and response headers
    def wait_for_matching_first_email_with_http_info(match_options : MatchOptions, before : Time?, delay : Int64?, inbox_id : String?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      if @api_client.config.debugging
    ...
    # @return [Email]
    def wait_for_nth_email(before : Time?, delay : Int64?, inbox_id : String?, index : Int32?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      data, _status_code, _headers = wait_for_nth_email_with_http_info(before, delay, inbox_id, index, since, sort, timeout, unread_only)
      data
    end
    ...
    # If nth email is already present in inbox then return it. If not hold the connection open until timeout expires or the nth email is received and returned.
    # @return [Array<(Email, Integer, Hash)>] Email data, response status code and response headers
    def wait_for_nth_email_with_http_info(before : Time?, delay : Int64?, inbox_id : String?, index : Int32?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      if @api_client.config.debugging
