...
module 
  class WaitForControllerApi
    ...
    # @return [Array(EmailPreview)]
    def wait_for_matching_emails(match_options : MatchOptions, count : Int32?, delay : Int64?, inbox_id : String?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      data, _status_code, _headers = wait_for_matching_emails_with_http_info(match_options, count, delay, inbox_id, since, sort, timeout, unread_only)
      data
    end
    ...
    # @param match_options [MatchOptions] matchOptions
    # @return [Array<(Array(EmailPreview), Integer, Hash)>] Array(EmailPreview) data, response status code and response headers
    def wait_for_matching_emails_with_http_info(match_options : MatchOptions, count : Int32?, delay : Int64?, inbox_id : String?, since : Time?, sort : String?, timeout : Int64?, unread_only : Bool?)
      if @api_client.config.debugging
