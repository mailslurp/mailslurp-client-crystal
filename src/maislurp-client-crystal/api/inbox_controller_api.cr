...
module 
  class InboxControllerApi
    ...
    # @param inbox_id [String] inboxId
    # @return [nil]
    def list_inbox_rulesets(inbox_id : String, page : Int32?, size : Int32?, sort : String?)
      list_inbox_rulesets_with_http_info(inbox_id, page, size, sort)
      nil
    end
    ...
    # @param inbox_id [String] inboxId
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def list_inbox_rulesets_with_http_info(inbox_id : String, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
