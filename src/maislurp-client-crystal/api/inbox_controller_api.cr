...
module 
  class InboxControllerApi
    ...
    def get_all_scheduled_jobs(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_all_scheduled_jobs_with_http_info(page, size, sort, since, before)
      data
    end
    ...
    def get_all_scheduled_jobs_with_http_info(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
    ...
    def get_inboxes(size : Int32?, sort : String?, since : Time?, exclude_catch_all_inboxes : Bool?, before : Time?)
      data, _status_code, _headers = get_inboxes_with_http_info(size, sort, since, exclude_catch_all_inboxes, before)
      data
    end
    ...
    def get_inboxes_with_http_info(size : Int32?, sort : String?, since : Time?, exclude_catch_all_inboxes : Bool?, before : Time?)
      if @api_client.config.debugging
