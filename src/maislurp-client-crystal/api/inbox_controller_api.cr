...
module 
  class InboxControllerApi
    ...
    # @return [InboxDto]
    def create_inbox(email_address : String?, tags : Array(String)?, name : String?, description : String?, use_domain_pool : Bool?, favourite : Bool?, expires_at : Time?, expires_in : Int64?, allow_team_access : Bool?, inbox_type : String?, virtual_inbox : Bool?, use_short_address : Bool?)
      data, _status_code, _headers = create_inbox_with_http_info(email_address, tags, name, description, use_domain_pool, favourite, expires_at, expires_in, allow_team_access, inbox_type, virtual_inbox, use_short_address)
      data
    end
    ...
    def create_inbox_with_http_info(email_address : String?, tags : Array(String)?, name : String?, description : String?, use_domain_pool : Bool?, favourite : Bool?, expires_at : Time?, expires_in : Int64?, allow_team_access : Bool?, inbox_type : String?, virtual_inbox : Bool?, use_short_address : Bool?)
      if @api_client.config.debugging
