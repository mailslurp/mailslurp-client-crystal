...
module 
  class InboxControllerApi
    ...
    def cancel_scheduled_job(job_id : String)
      data, _status_code, _headers = cancel_scheduled_job_with_http_info(job_id)
      data
    end
    ...
    def cancel_scheduled_job_with_http_info(job_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.cancel_scheduled_job ..."}
      end
      # verify the required parameter "job_id" is set
      if @api_client.config.client_side_validation && job_id.nil?
        raise ArgumentError.new("Missing the required parameter 'job_id' when calling InboxControllerApi.cancel_scheduled_job")
      end
      # resource path
      local_var_path = "/inboxes/scheduled-jobs/{jobId}".sub("{" + "jobId" + "}", URI.encode(job_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:DELETE,
                                                        local_var_path,
                                                        :"InboxControllerApi.cancel_scheduled_job",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#cancel_scheduled_job\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ScheduledJobDto.from_json(data), status_code, headers
    end

    # Create an inbox email address. An inbox has a real email address and can send and receive emails. Inboxes can be either `SMTP` or `HTTP` inboxes.
    # Create a new inbox and with a randomized email address to send and receive from. Pass emailAddress parameter if you wish to use a specific email address. Creating an inbox is required before sending or receiving emails. If writing tests it is recommended that you create a new inbox during each test method so that it is unique and empty. 
    # @return [InboxDto]
    def create_inbox(email_address : String?, tags : Array(String)?, name : String?, description : String?, use_domain_pool : Bool?, favourite : Bool?, expires_at : Time?, expires_in : Int64?, allow_team_access : Bool?, inbox_type : String?, virtual_inbox : Bool?, use_short_address : Bool?, domain_id : String?, domain_name : String?, prefix : String?)
      data, _status_code, _headers = create_inbox_with_http_info(email_address, tags, name, description, use_domain_pool, favourite, expires_at, expires_in, allow_team_access, inbox_type, virtual_inbox, use_short_address, domain_id, domain_name, prefix)
      data
    end
    ...
    def create_inbox_with_http_info(email_address : String?, tags : Array(String)?, name : String?, description : String?, use_domain_pool : Bool?, favourite : Bool?, expires_at : Time?, expires_in : Int64?, allow_team_access : Bool?, inbox_type : String?, virtual_inbox : Bool?, use_short_address : Bool?, domain_id : String?, domain_name : String?, prefix : String?)
      if @api_client.config.debugging
      ...
      query_params[:"useShortAddress"] = use_short_address
    ...
    # @return [RulesetDto]
    def create_inbox_ruleset(inbox_id : String, create_ruleset_options : CreateRulesetOptions)
      data, _status_code, _headers = create_inbox_ruleset_with_http_info(inbox_id, create_ruleset_options)
      data
    end
    ...
    def create_inbox_ruleset_with_http_info(inbox_id : String, create_ruleset_options : CreateRulesetOptions)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && create_ruleset_options.nil?
        raise ArgumentError.new("Missing the required parameter 'create_ruleset_options' when calling InboxControllerApi.create_inbox_ruleset")
      end
      # resource path
    ...
    # @return [nil]
    def delete_all_inboxes_by_description(description : String)
      delete_all_inboxes_by_description_with_http_info(description)
      nil
    end
    ...
    # @param description [String] 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_all_inboxes_by_description_with_http_info(description : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.delete_all_inboxes_by_description ..."}
      end
      # verify the required parameter "description" is set
      if @api_client.config.client_side_validation && description.nil?
        raise ArgumentError.new("Missing the required parameter 'description' when calling InboxControllerApi.delete_all_inboxes_by_description")
      end
      if @api_client.config.client_side_validation && description.to_s.length < 1
        raise ArgumentError.new("invalid value for \"description\" when calling InboxControllerApi.delete_all_inboxes_by_description, the character length must be great than or equal to 1.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:DELETE,
                                                        local_var_path,
                                                        :"InboxControllerApi.delete_all_inboxes_by_description",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#delete_all_inboxes_by_description\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
    ...
    # @param name [String] 
    # @return [nil]
    def delete_all_inboxes_by_name(name : String)
      delete_all_inboxes_by_name_with_http_info(name)
      nil
    end
    ...
    # @param name [String] 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_all_inboxes_by_name_with_http_info(name : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.delete_all_inboxes_by_name ..."}
      end
      # verify the required parameter "name" is set
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError.new("Missing the required parameter 'name' when calling InboxControllerApi.delete_all_inboxes_by_name")
      end
      if @api_client.config.client_side_validation && name.to_s.length < 1
        raise ArgumentError.new("invalid value for \"name\" when calling InboxControllerApi.delete_all_inboxes_by_name, the character length must be great than or equal to 1.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:DELETE,
                                                        local_var_path,
                                                        :"InboxControllerApi.delete_all_inboxes_by_name",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#delete_all_inboxes_by_name\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
    ...
    # @param tag [String] 
    # @return [nil]
    def delete_all_inboxes_by_tag(tag : String)
      delete_all_inboxes_by_tag_with_http_info(tag)
      nil
    end
    ...
    # @param tag [String] 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_all_inboxes_by_tag_with_http_info(tag : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.delete_all_inboxes_by_tag ..."}
      end
      # verify the required parameter "tag" is set
      if @api_client.config.client_side_validation && tag.nil?
        raise ArgumentError.new("Missing the required parameter 'tag' when calling InboxControllerApi.delete_all_inboxes_by_tag")
      end
      if @api_client.config.client_side_validation && tag.to_s.length < 1
        raise ArgumentError.new("invalid value for \"tag\" when calling InboxControllerApi.delete_all_inboxes_by_tag, the character length must be great than or equal to 1.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:DELETE,
                                                        local_var_path,
                                                        :"InboxControllerApi.delete_all_inboxes_by_tag",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#delete_all_inboxes_by_tag\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
    ...
    def does_inbox_exist(email_address : String, allow_catch_all : Bool?, ip_address : String?, sender : String?)
      data, _status_code, _headers = does_inbox_exist_with_http_info(email_address, allow_catch_all, ip_address, sender)
      data
    end
    ...
    def does_inbox_exist_with_http_info(email_address : String, allow_catch_all : Bool?, ip_address : String?, sender : String?)
      if @api_client.config.debugging
      ...
      query_params = Hash(Symbol, String).new
      query_params[:"emailAddress"] = email_address
      query_params[:"allowCatchAll"] = allow_catch_all
    ...
    # @return [nil]
    def does_inbox_have_automations()
      does_inbox_have_automations_with_http_info()
      nil
    end
    ...
    # Check if an inbox has automations.
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def does_inbox_have_automations_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.does_inbox_have_automations ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.does_inbox_have_automations",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#does_inbox_have_automations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
    ...
    def get_all_inboxes(page : Int32?, size : Int32?, sort : String?, favourite : Bool?, search : String?, tag : String?, team_access : Bool?, since : Time?, before : Time?, inbox_type : String?, inbox_function : String?, domain_id : String?)
      data, _status_code, _headers = get_all_inboxes_with_http_info(page, size, sort, favourite, search, tag, team_access, since, before, inbox_type, inbox_function, domain_id)
      data
    end
    ...
    def get_all_inboxes_with_http_info(page : Int32?, size : Int32?, sort : String?, favourite : Bool?, search : String?, tag : String?, team_access : Bool?, since : Time?, before : Time?, inbox_type : String?, inbox_function : String?, domain_id : String?)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && inbox_function && !allowable_values.includes?(inbox_function)
        raise ArgumentError.new("invalid value for \"inbox_function\", must be one of #{allowable_values}")
      end
      # resource path
      ...
      query_params[:"before"] = before
      query_params[:"inboxType"] = inbox_type
      query_params[:"inboxFunction"] = inbox_function
      query_params[:"domainId"] = domain_id
    ...
    # List inboxes in paginated form. The results are available on the `content` property of the returned object. This method allows for page index (zero based), page size (how many results to return), and a sort direction (based on createdAt time). You Can also filter by whether an inbox is favorited or use email address pattern. This method is the recommended way to query inboxes. The alternative `getInboxes` method returns a full list of inboxes but is limited to 100 results.
    # @return [PageInboxProjection]
    def get_all_inboxes_offset_paginated(page : Int32?, size : Int32?, sort : String?, favourite : Bool?, search : String?, tag : String?, team_access : Bool?, since : Time?, before : Time?, inbox_type : String?, inbox_function : String?, domain_id : String?)
      data, _status_code, _headers = get_all_inboxes_offset_paginated_with_http_info(page, size, sort, favourite, search, tag, team_access, since, before, inbox_type, inbox_function, domain_id)
      data
    end
    ...
    # List inboxes in paginated form. The results are available on the &#x60;content&#x60; property of the returned object. This method allows for page index (zero based), page size (how many results to return), and a sort direction (based on createdAt time). You Can also filter by whether an inbox is favorited or use email address pattern. This method is the recommended way to query inboxes. The alternative &#x60;getInboxes&#x60; method returns a full list of inboxes but is limited to 100 results.
    # @return [Array<(PageInboxProjection, Integer, Hash)>] PageInboxProjection data, response status code and response headers
    def get_all_inboxes_offset_paginated_with_http_info(page : Int32?, size : Int32?, sort : String?, favourite : Bool?, search : String?, tag : String?, team_access : Bool?, since : Time?, before : Time?, inbox_type : String?, inbox_function : String?, domain_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_all_inboxes_offset_paginated ..."}
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_all_inboxes_offset_paginated",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_all_inboxes_offset_paginated\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageInboxProjection.from_json(data), status_code, headers
    end
    ...
    def get_all_plus_addresses(page : Int32?, size : Int32?, sort : String?, inbox_id : String?)
      data, _status_code, _headers = get_all_plus_addresses_with_http_info(page, size, sort, inbox_id)
      data
    end
    ...
    def get_all_plus_addresses_with_http_info(page : Int32?, size : Int32?, sort : String?, inbox_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_all_plus_addresses ..."}
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      # return_type
      return_type = "PagePlusAddressProjection"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_all_plus_addresses",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_all_plus_addresses\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PagePlusAddressProjection.from_json(data), status_code, headers
    end

    # Get all scheduled email sending jobs for account
    # Schedule sending of emails using scheduled jobs. These can be inbox or account level.
    # @return [PageScheduledJobs]
    def get_all_scheduled_jobs(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, inbox_id : String?)
      data, _status_code, _headers = get_all_scheduled_jobs_with_http_info(page, size, sort, since, before, inbox_id)
      data
    end
    ...
    def get_all_scheduled_jobs_with_http_info(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, inbox_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_all_scheduled_jobs ..."}
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_all_scheduled_jobs",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_all_scheduled_jobs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageScheduledJobs.from_json(data), status_code, headers
    end

    # Get all email delivery statuses for an inbox
    # @param inbox_id [String] 
    # @return [PageDeliveryStatus]
    def get_delivery_statuses_by_inbox_id(inbox_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_delivery_statuses_by_inbox_id_with_http_info(inbox_id, page, size, sort, since, before)
      data
    end
    ...
    def get_delivery_statuses_by_inbox_id_with_http_info(inbox_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_delivery_statuses_by_inbox_id ..."}
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.get_delivery_statuses_by_inbox_id")
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      # resource path
      local_var_path = "/inboxes/{inboxId}/delivery-status".sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))
      ...
      # return_type
      return_type = "PageDeliveryStatus"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_delivery_statuses_by_inbox_id",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_delivery_statuses_by_inbox_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageDeliveryStatus.from_json(data), status_code, headers
    end
    ...
    def get_imap_access(inbox_id : String?)
      data, _status_code, _headers = get_imap_access_with_http_info(inbox_id)
      data
    end

    # Get IMAP access usernames and passwords
    # @return [Array<(ImapAccessDetails, Integer, Hash)>] ImapAccessDetails data, response status code and response headers
    def get_imap_access_with_http_info(inbox_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_imap_access ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_imap_access",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_imap_access\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ImapAccessDetails.from_json(data), status_code, headers
    end
    ...
    # @return [String]
    def get_imap_smtp_access_env(inbox_id : String?)
      data, _status_code, _headers = get_imap_smtp_access_env_with_http_info(inbox_id)
      data
    end

    # Get IMAP and SMTP access details in .env format
    # @return [Array<(String, Integer, Hash)>] String data, response status code and response headers
    def get_imap_smtp_access_env_with_http_info(inbox_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_imap_smtp_access_env ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_imap_smtp_access_env",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_imap_smtp_access_env\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_imap_smtp_access_servers()
      data, _status_code, _headers = get_imap_smtp_access_servers_with_http_info()
      data
    end

    # Get IMAP and SMTP server hosts
    # @return [Array<(ImapSmtpAccessServers, Integer, Hash)>] ImapSmtpAccessServers data, response status code and response headers
    def get_imap_smtp_access_servers_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_imap_smtp_access_servers ..."}
      end
      # resource path
      ...
      # return_type
      return_type = "ImapSmtpAccessServers"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_imap_smtp_access_servers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_imap_smtp_access_servers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ImapSmtpAccessServers.from_json(data), status_code, headers
    end
    ...
    def get_inbox_by_email_address_with_http_info(email_address : String)
      ...
      if @api_client.config.client_side_validation && email_address.to_s.length < 1
        raise ArgumentError.new("invalid value for \"email_address\" when calling InboxControllerApi.get_inbox_by_email_address, the character length must be great than or equal to 1.")
      end
    ...
    def get_inbox_by_name_with_http_info(name : String)
      ...
      if @api_client.config.client_side_validation && name.to_s.length < 1
        raise ArgumentError.new("invalid value for \"name\" when calling InboxControllerApi.get_inbox_by_name, the character length must be great than or equal to 1.")
      end
    ...
    def get_inbox_emails_paginated(inbox_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, sync_connectors : Bool?)
      data, _status_code, _headers = get_inbox_emails_paginated_with_http_info(inbox_id, page, size, sort, since, before, sync_connectors)
      data
    end
    ...
    def get_inbox_emails_paginated_with_http_info(inbox_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, sync_connectors : Bool?)
      if @api_client.config.debugging
    ...
    def get_inbox_plus_address(plus_address_id : String, inbox_id : String)
      data, _status_code, _headers = get_inbox_plus_address_with_http_info(plus_address_id, inbox_id)
      data
    end
    ...
    def get_inbox_plus_address_with_http_info(plus_address_id : String, inbox_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_inbox_plus_address ..."}
      end
      # verify the required parameter "plus_address_id" is set
      if @api_client.config.client_side_validation && plus_address_id.nil?
        raise ArgumentError.new("Missing the required parameter 'plus_address_id' when calling InboxControllerApi.get_inbox_plus_address")
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.get_inbox_plus_address")
      end
      # resource path
      local_var_path = "/inboxes/{inboxId}/plus-addresses/{plusAddressId}".sub("{" + "plusAddressId" + "}", URI.encode(plus_address_id.to_s)).sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_inbox_plus_address",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_inbox_plus_address\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PlusAddressDto.from_json(data), status_code, headers
    end
    ...
    # @param plus_address_id [String] ID of the plus address you want to fetch
    # @return [PlusAddressDto]
    def get_inbox_plus_address_by_id(plus_address_id : String, inbox_id : String?)
      data, _status_code, _headers = get_inbox_plus_address_by_id_with_http_info(plus_address_id, inbox_id)
      data
    end
    ...
    # @param plus_address_id [String] ID of the plus address you want to fetch
    # @return [Array<(PlusAddressDto, Integer, Hash)>] PlusAddressDto data, response status code and response headers
    def get_inbox_plus_address_by_id_with_http_info(plus_address_id : String, inbox_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_inbox_plus_address_by_id ..."}
      end
      # verify the required parameter "plus_address_id" is set
      if @api_client.config.client_side_validation && plus_address_id.nil?
        raise ArgumentError.new("Missing the required parameter 'plus_address_id' when calling InboxControllerApi.get_inbox_plus_address_by_id")
      end
      # resource path
      local_var_path = "/inboxes/plus-addresses/{plusAddressId}".sub("{" + "plusAddressId" + "}", URI.encode(plus_address_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_inbox_plus_address_by_id",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_inbox_plus_address_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PlusAddressDto.from_json(data), status_code, headers
    end
    ...
    # @return [PageEmailPreview]
    def get_inbox_plus_address_emails(plus_address : String, inbox_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_inbox_plus_address_emails_with_http_info(plus_address, inbox_id, page, size, sort, since, before)
      data
    end
    ...
    # @param inbox_id [String] ID of the inbox you want to send the email from
    # @return [Array<(PageEmailPreview, Integer, Hash)>] PageEmailPreview data, response status code and response headers
    def get_inbox_plus_address_emails_with_http_info(plus_address : String, inbox_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_inbox_plus_address_emails ..."}
      end
      # verify the required parameter "plus_address" is set
      if @api_client.config.client_side_validation && plus_address.nil?
        raise ArgumentError.new("Missing the required parameter 'plus_address' when calling InboxControllerApi.get_inbox_plus_address_emails")
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.get_inbox_plus_address_emails")
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      # resource path
      local_var_path = "/inboxes/{inboxId}/plus-addresses/emails".sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_inbox_plus_address_emails",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_inbox_plus_address_emails\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageEmailPreview.from_json(data), status_code, headers
    end
    ...
    # @param inbox_id [String] ID of the inbox you want to send the email from
    # @return [PageEmailPreview]
    def get_inbox_plus_address_emails_for_plus_address_id(plus_address_id : String, inbox_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_inbox_plus_address_emails_for_plus_address_id_with_http_info(plus_address_id, inbox_id, page, size, sort, since, before)
      data
    end
    ...
    # @param inbox_id [String] ID of the inbox you want to send the email from
    # @return [Array<(PageEmailPreview, Integer, Hash)>] PageEmailPreview data, response status code and response headers
    def get_inbox_plus_address_emails_for_plus_address_id_with_http_info(plus_address_id : String, inbox_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_inbox_plus_address_emails_for_plus_address_id ..."}
      end
      # verify the required parameter "plus_address_id" is set
      if @api_client.config.client_side_validation && plus_address_id.nil?
        raise ArgumentError.new("Missing the required parameter 'plus_address_id' when calling InboxControllerApi.get_inbox_plus_address_emails_for_plus_address_id")
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.get_inbox_plus_address_emails_for_plus_address_id")
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      # resource path
      local_var_path = "/inboxes/{inboxId}/plus-addresses/{plusAddressId}/emails".sub("{" + "plusAddressId" + "}", URI.encode(plus_address_id.to_s)).sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_inbox_plus_address_emails_for_plus_address_id",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_inbox_plus_address_emails_for_plus_address_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageEmailPreview.from_json(data), status_code, headers
    end
    ...
    # @param inbox_id [String] ID of the inbox you want to send the email from
    # @return [PagePlusAddressProjection]
    def get_inbox_plus_addresses(inbox_id : String, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_inbox_plus_addresses_with_http_info(inbox_id, page, size, sort)
      data
    end
    ...
    # @param inbox_id [String] ID of the inbox you want to send the email from
    # @return [Array<(PagePlusAddressProjection, Integer, Hash)>] PagePlusAddressProjection data, response status code and response headers
    def get_inbox_plus_addresses_with_http_info(inbox_id : String, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_inbox_plus_addresses ..."}
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.get_inbox_plus_addresses")
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      # resource path
      local_var_path = "/inboxes/{inboxId}/plus-addresses".sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_inbox_plus_addresses",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_inbox_plus_addresses\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PagePlusAddressProjection.from_json(data), status_code, headers
    end
    ...
    # @return [CountDto]
    def get_inbox_sent_count(inbox_id : String)
      data, _status_code, _headers = get_inbox_sent_count_with_http_info(inbox_id)
      data
    end
    ...
    # @param inbox_id [String] Id of inbox that emails were sent from
    # @return [Array<(CountDto, Integer, Hash)>] CountDto data, response status code and response headers
    def get_inbox_sent_count_with_http_info(inbox_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_inbox_sent_count ..."}
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.get_inbox_sent_count")
      end
      # resource path
      local_var_path = "/inboxes/{inboxId}/sent/count".sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_inbox_sent_count",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_inbox_sent_count\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return CountDto.from_json(data), status_code, headers
    end
    ...
    # Get all inbox tags
    # @return [Array(String)]
    def get_inbox_tags(page : Int32?, size : Int32?, sort : String?, search_filter : String?)
      data, _status_code, _headers = get_inbox_tags_with_http_info(page, size, sort, search_filter)
      data
    end
    ...
    def get_inbox_tags_with_http_info(page : Int32?, size : Int32?, sort : String?, search_filter : String?)
      if @api_client.config.debugging
    ...
    def get_inbox_tags_paginated(page : Int32?, size : Int32?, sort : String?, search_filter : String?)
      data, _status_code, _headers = get_inbox_tags_paginated_with_http_info(page, size, sort, search_filter)
      data
    end
    ...
    def get_inbox_tags_paginated_with_http_info(page : Int32?, size : Int32?, sort : String?, search_filter : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_inbox_tags_paginated ..."}
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_inbox_tags_paginated",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_inbox_tags_paginated\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageInboxTags.from_json(data), status_code, headers
    end

    # List Inboxes and email addresses
    # List the inboxes you have created. Note use of the more advanced `getAllInboxes` is recommended and allows paginated access using a limit and sort parameter.
    # @return [Array(InboxDto)]
    def get_inboxes(size : Int32?, sort : String?, since : Time?, exclude_catch_all_inboxes : Bool?, before : Time?, _include : Array(String)?)
      data, _status_code, _headers = get_inboxes_with_http_info(size, sort, since, exclude_catch_all_inboxes, before, _include)
      data
    end
    ...
    def get_inboxes_with_http_info(size : Int32?, sort : String?, since : Time?, exclude_catch_all_inboxes : Bool?, before : Time?, _include : Array(String)?)
      if @api_client.config.debugging
      ...
      query_params[:"sort"] = sort
      query_params[:"since"] = since
      query_params[:"excludeCatchAllInboxes"] = exclude_catch_all_inboxes
      query_params[:"before"] = before
    ...
    # @return [PageInboxProjection]
    def get_inboxes_by_tag(tag : String, page : Int32?, size : Int32?, sort : String?, search_filter : String?)
      data, _status_code, _headers = get_inboxes_by_tag_with_http_info(tag, page, size, sort, search_filter)
      data
    end
    ...
    # @param tag [String] Tag to filter by
    # @return [Array<(PageInboxProjection, Integer, Hash)>] PageInboxProjection data, response status code and response headers
    def get_inboxes_by_tag_with_http_info(tag : String, page : Int32?, size : Int32?, sort : String?, search_filter : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_inboxes_by_tag ..."}
      end
      # verify the required parameter "tag" is set
      if @api_client.config.client_side_validation && tag.nil?
        raise ArgumentError.new("Missing the required parameter 'tag' when calling InboxControllerApi.get_inboxes_by_tag")
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_inboxes_by_tag",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_inboxes_by_tag\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageInboxProjection.from_json(data), status_code, headers
    end
    ...
    # @return [PlusAddressDto]
    def get_or_create_inbox_plus_address(inbox_id : String, full_address : String)
      data, _status_code, _headers = get_or_create_inbox_plus_address_with_http_info(inbox_id, full_address)
      data
    end
    ...
    # @param full_address [String] Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60;
    # @return [Array<(PlusAddressDto, Integer, Hash)>] PlusAddressDto data, response status code and response headers
    def get_or_create_inbox_plus_address_with_http_info(inbox_id : String, full_address : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_or_create_inbox_plus_address ..."}
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.get_or_create_inbox_plus_address")
      end
      # verify the required parameter "full_address" is set
      if @api_client.config.client_side_validation && full_address.nil?
        raise ArgumentError.new("Missing the required parameter 'full_address' when calling InboxControllerApi.get_or_create_inbox_plus_address")
      end
      if @api_client.config.client_side_validation && full_address.to_s.length < 1
        raise ArgumentError.new("invalid value for \"full_address\" when calling InboxControllerApi.get_or_create_inbox_plus_address, the character length must be great than or equal to 1.")
      end

      # resource path
      local_var_path = "/inboxes/{inboxId}/plus-addresses/get-or-create".sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_or_create_inbox_plus_address",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_or_create_inbox_plus_address\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PlusAddressDto.from_json(data), status_code, headers
    end
    ...
    # @param full_address [String] Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60;
    # @return [PlusAddressDto]
    def get_or_create_plus_address_by_full_address(full_address : String)
      data, _status_code, _headers = get_or_create_plus_address_by_full_address_with_http_info(full_address)
      data
    end
    ...
    # @param full_address [String] Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60;
    # @return [Array<(PlusAddressDto, Integer, Hash)>] PlusAddressDto data, response status code and response headers
    def get_or_create_plus_address_by_full_address_with_http_info(full_address : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_or_create_plus_address_by_full_address ..."}
      end
      # verify the required parameter "full_address" is set
      if @api_client.config.client_side_validation && full_address.nil?
        raise ArgumentError.new("Missing the required parameter 'full_address' when calling InboxControllerApi.get_or_create_plus_address_by_full_address")
      end
      if @api_client.config.client_side_validation && full_address.to_s.length < 1
        raise ArgumentError.new("invalid value for \"full_address\" when calling InboxControllerApi.get_or_create_plus_address_by_full_address, the character length must be great than or equal to 1.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_or_create_plus_address_by_full_address",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_or_create_plus_address_by_full_address\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PlusAddressDto.from_json(data), status_code, headers
    end
    ...
    # @return [PageInboxProjection]
    def get_outboxes(page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_outboxes_with_http_info(page, size, sort)
      data
    end
    ...
    # List inboxes that have sent emails
    # @return [Array<(PageInboxProjection, Integer, Hash)>] PageInboxProjection data, response status code and response headers
    def get_outboxes_with_http_info(page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_outboxes ..."}
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_outboxes",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_outboxes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageInboxProjection.from_json(data), status_code, headers
    end
    ...
    # @param job_id [String] 
    # @return [ScheduledJobDto]
    def get_scheduled_job(job_id : String)
      data, _status_code, _headers = get_scheduled_job_with_http_info(job_id)
      data
    end
    ...
    # @param job_id [String] 
    # @return [Array<(ScheduledJobDto, Integer, Hash)>] ScheduledJobDto data, response status code and response headers
    def get_scheduled_job_with_http_info(job_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_scheduled_job ..."}
      end
      # verify the required parameter "job_id" is set
      if @api_client.config.client_side_validation && job_id.nil?
        raise ArgumentError.new("Missing the required parameter 'job_id' when calling InboxControllerApi.get_scheduled_job")
      end
      # resource path
      local_var_path = "/inboxes/scheduled-jobs/{jobId}".sub("{" + "jobId" + "}", URI.encode(job_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_scheduled_job",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_scheduled_job\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ScheduledJobDto.from_json(data), status_code, headers
    end
    ...
    # @param inbox_id [String] 
    # @return [PageScheduledJobs]
    def get_scheduled_jobs_by_inbox_id(inbox_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_scheduled_jobs_by_inbox_id_with_http_info(inbox_id, page, size, sort, since, before)
      data
    end
    ...
    # @param inbox_id [String] 
    # @return [Array<(PageScheduledJobs, Integer, Hash)>] PageScheduledJobs data, response status code and response headers
    def get_scheduled_jobs_by_inbox_id_with_http_info(inbox_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_scheduled_jobs_by_inbox_id ..."}
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.get_scheduled_jobs_by_inbox_id")
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      # resource path
      local_var_path = "/inboxes/{inboxId}/scheduled-jobs".sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_scheduled_jobs_by_inbox_id",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_scheduled_jobs_by_inbox_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageScheduledJobs.from_json(data), status_code, headers
    end
    ...
    def get_smtp_access(inbox_id : String?)
      data, _status_code, _headers = get_smtp_access_with_http_info(inbox_id)
      data
    end

    # Get SMTP access usernames and passwords
    # @return [Array<(SmtpAccessDetails, Integer, Hash)>] SmtpAccessDetails data, response status code and response headers
    def get_smtp_access_with_http_info(inbox_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.get_smtp_access ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxControllerApi.get_smtp_access",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#get_smtp_access\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return SmtpAccessDetails.from_json(data), status_code, headers
    end
    ...
    # @return [Email]
    def import_email_into_inbox(inbox_id : String, import_email_options : ImportEmailOptions)
      data, _status_code, _headers = import_email_into_inbox_with_http_info(inbox_id, import_email_options)
      data
    end
    ...
    # @param import_email_options [ImportEmailOptions] 
    # @return [Array<(Email, Integer, Hash)>] Email data, response status code and response headers
    def import_email_into_inbox_with_http_info(inbox_id : String, import_email_options : ImportEmailOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.import_email_into_inbox ..."}
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.import_email_into_inbox")
      end
      ...
      if @api_client.config.client_side_validation && import_email_options.nil?
        raise ArgumentError.new("Missing the required parameter 'import_email_options' when calling InboxControllerApi.import_email_into_inbox")
      end
      # resource path
      local_var_path = "/inboxes/{inboxId}/emails/import".sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))
      ...
      # http body (model)
      post_body = import_email_options.to_json
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"InboxControllerApi.import_email_into_inbox",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#import_email_into_inbox\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return Email.from_json(data), status_code, headers
    end
    ...
    # @param body [String] 
    # @return [Email]
    def import_email_into_inbox_bytes(inbox_id : String, body : String, external_id : String?, run_pipeline : Bool?, override_message_id : Bool?)
      data, _status_code, _headers = import_email_into_inbox_bytes_with_http_info(inbox_id, body, external_id, run_pipeline, override_message_id)
      data
    end
    ...
    # @param body [String] 
    # @return [Array<(Email, Integer, Hash)>] Email data, response status code and response headers
    def import_email_into_inbox_bytes_with_http_info(inbox_id : String, body : String, external_id : String?, run_pipeline : Bool?, override_message_id : Bool?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.import_email_into_inbox_bytes ..."}
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.import_email_into_inbox_bytes")
      end
      # verify the required parameter "body" is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError.new("Missing the required parameter 'body' when calling InboxControllerApi.import_email_into_inbox_bytes")
      end
      # resource path
      local_var_path = "/inboxes/{inboxId}/emails/import/raw".sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))

      # query parameters
      query_params = Hash(Symbol, String).new
      query_params[:"externalId"] = external_id
      query_params[:"runPipeline"] = run_pipeline
      query_params[:"overrideMessageId"] = override_message_id
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"InboxControllerApi.import_email_into_inbox_bytes",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#import_email_into_inbox_bytes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return Email.from_json(data), status_code, headers
    end
    ...
    # @param file [File] 
    # @return [Email]
    def import_email_into_inbox_multipart(inbox_id : String, file : File, external_id : String?, run_pipeline : Bool?, override_message_id : Bool?)
      data, _status_code, _headers = import_email_into_inbox_multipart_with_http_info(inbox_id, file, external_id, run_pipeline, override_message_id)
      data
    end
    ...
    # @param file [File] 
    # @return [Array<(Email, Integer, Hash)>] Email data, response status code and response headers
    def import_email_into_inbox_multipart_with_http_info(inbox_id : String, file : File, external_id : String?, run_pipeline : Bool?, override_message_id : Bool?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.import_email_into_inbox_multipart ..."}
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.import_email_into_inbox_multipart")
      end
      # verify the required parameter "file" is set
      if @api_client.config.client_side_validation && file.nil?
        raise ArgumentError.new("Missing the required parameter 'file' when calling InboxControllerApi.import_email_into_inbox_multipart")
      end
      # resource path
      local_var_path = "/inboxes/{inboxId}/emails/import/multipart".sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"InboxControllerApi.import_email_into_inbox_multipart",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#import_email_into_inbox_multipart\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return Email.from_json(data), status_code, headers
    end
    ...
    def is_email_address_available(email_address : String)
      data, _status_code, _headers = is_email_address_available_with_http_info(email_address)
      data
    end
    ...
    def is_email_address_available_with_http_info(email_address : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.is_email_address_available ..."}
      end
      # verify the required parameter "email_address" is set
      if @api_client.config.client_side_validation && email_address.nil?
        raise ArgumentError.new("Missing the required parameter 'email_address' when calling InboxControllerApi.is_email_address_available")
      end
      # resource path
      ...
      # return_type
      return_type = "EmailAvailableResult"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"InboxControllerApi.is_email_address_available",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#is_email_address_available\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmailAvailableResult.from_json(data), status_code, headers
    end
    ...
    # @return [PageInboxProjection]
    def search_inboxes(search_inboxes_options : SearchInboxesOptions)
      data, _status_code, _headers = search_inboxes_with_http_info(search_inboxes_options)
      data
    end
    ...
    # @param search_inboxes_options [SearchInboxesOptions] 
    # @return [Array<(PageInboxProjection, Integer, Hash)>] PageInboxProjection data, response status code and response headers
    def search_inboxes_with_http_info(search_inboxes_options : SearchInboxesOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.search_inboxes ..."}
      end
      ...
      if @api_client.config.client_side_validation && search_inboxes_options.nil?
        raise ArgumentError.new("Missing the required parameter 'search_inboxes_options' when calling InboxControllerApi.search_inboxes")
      end
      # resource path
      ...
      # http body (model)
      post_body = search_inboxes_options.to_json
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"InboxControllerApi.search_inboxes",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#search_inboxes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageInboxProjection.from_json(data), status_code, headers
    end
    ...
    # @param send_email_options [SendEmailOptions] 
    # @return [ScheduledJobDto]
    def send_with_schedule(inbox_id : String, send_email_options : SendEmailOptions, send_at_timestamp : Time?, send_at_now_plus_seconds : Int64?, validate_before_enqueue : Bool?)
      data, _status_code, _headers = send_with_schedule_with_http_info(inbox_id, send_email_options, send_at_timestamp, send_at_now_plus_seconds, validate_before_enqueue)
      data
    end
    ...
    # @param send_email_options [SendEmailOptions] 
    # @return [Array<(ScheduledJobDto, Integer, Hash)>] ScheduledJobDto data, response status code and response headers
    def send_with_schedule_with_http_info(inbox_id : String, send_email_options : SendEmailOptions, send_at_timestamp : Time?, send_at_now_plus_seconds : Int64?, validate_before_enqueue : Bool?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.send_with_schedule ..."}
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxControllerApi.send_with_schedule")
      end
      # verify the required parameter "send_email_options" is set
      if @api_client.config.client_side_validation && send_email_options.nil?
        raise ArgumentError.new("Missing the required parameter 'send_email_options' when calling InboxControllerApi.send_with_schedule")
      end
      # resource path
      local_var_path = "/inboxes/{inboxId}/with-schedule".sub("{" + "inboxId" + "}", URI.encode(inbox_id.to_s))

      # query parameters
      query_params = Hash(Symbol, String).new
      query_params[:"sendAtTimestamp"] = send_at_timestamp
      query_params[:"sendAtNowPlusSeconds"] = send_at_now_plus_seconds
      query_params[:"validateBeforeEnqueue"] = validate_before_enqueue
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"InboxControllerApi.send_with_schedule",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#send_with_schedule\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ScheduledJobDto.from_json(data), status_code, headers
    end
    ...
    # @return [nil]
    def update_imap_access(update_imap_access_options : UpdateImapAccessOptions, inbox_id : String?)
      update_imap_access_with_http_info(update_imap_access_options, inbox_id)
      nil
    end
    ...
    # @param update_imap_access_options [UpdateImapAccessOptions] 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_imap_access_with_http_info(update_imap_access_options : UpdateImapAccessOptions, inbox_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.update_imap_access ..."}
      end
      ...
      if @api_client.config.client_side_validation && update_imap_access_options.nil?
        raise ArgumentError.new("Missing the required parameter 'update_imap_access_options' when calling InboxControllerApi.update_imap_access")
      end
      # resource path
      local_var_path = "/inboxes/imap-access"
      ...
      # http body (model)
      post_body = update_imap_access_options.to_json
      ...
      data, status_code, headers = @api_client.call_api(:PATCH,
                                                        local_var_path,
                                                        :"InboxControllerApi.update_imap_access",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#update_imap_access\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
    ...
    # @return [nil]
    def update_smtp_access(update_smtp_access_options : UpdateSmtpAccessOptions, inbox_id : String?)
      update_smtp_access_with_http_info(update_smtp_access_options, inbox_id)
      nil
    end
    ...
    # @param update_smtp_access_options [UpdateSmtpAccessOptions] 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_smtp_access_with_http_info(update_smtp_access_options : UpdateSmtpAccessOptions, inbox_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxControllerApi.update_smtp_access ..."}
      end
      ...
      if @api_client.config.client_side_validation && update_smtp_access_options.nil?
        raise ArgumentError.new("Missing the required parameter 'update_smtp_access_options' when calling InboxControllerApi.update_smtp_access")
      end
      # resource path
      local_var_path = "/inboxes/smtp-access"
      ...
      # http body (model)
      post_body = update_smtp_access_options.to_json
      ...
      data, status_code, headers = @api_client.call_api(:PATCH,
                                                        local_var_path,
                                                        :"InboxControllerApi.update_smtp_access",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxControllerApi#update_smtp_access\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
  end
