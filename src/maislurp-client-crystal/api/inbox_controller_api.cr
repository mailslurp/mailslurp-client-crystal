...
module 
  class InboxControllerApi
    ...
    # @return [InboxDto]
    def create_inbox(email_address : String?, tags : Array(String)?, name : String?, description : String?, use_domain_pool : Bool?, favourite : Bool?, expires_at : Time?, expires_in : Int64?, allow_team_access : Bool?, inbox_type : String?, virtual_inbox : Bool?, use_short_address : Bool?, domain_id : String?, domain_name : String?)
      data, _status_code, _headers = create_inbox_with_http_info(email_address, tags, name, description, use_domain_pool, favourite, expires_at, expires_in, allow_team_access, inbox_type, virtual_inbox, use_short_address, domain_id, domain_name)
      data
    end
    ...
    def create_inbox_with_http_info(email_address : String?, tags : Array(String)?, name : String?, description : String?, use_domain_pool : Bool?, favourite : Bool?, expires_at : Time?, expires_in : Int64?, allow_team_access : Bool?, inbox_type : String?, virtual_inbox : Bool?, use_short_address : Bool?, domain_id : String?, domain_name : String?)
      if @api_client.config.debugging
    ...
    def get_all_inboxes(page : Int32?, size : Int32?, sort : String?, favourite : Bool?, search : String?, tag : String?, team_access : Bool?, since : Time?, before : Time?, inbox_type : String?, domain_id : String?)
      data, _status_code, _headers = get_all_inboxes_with_http_info(page, size, sort, favourite, search, tag, team_access, since, before, inbox_type, domain_id)
      data
    end
    ...
    def get_all_inboxes_with_http_info(page : Int32?, size : Int32?, sort : String?, favourite : Bool?, search : String?, tag : String?, team_access : Bool?, since : Time?, before : Time?, inbox_type : String?, domain_id : String?)
      if @api_client.config.debugging
