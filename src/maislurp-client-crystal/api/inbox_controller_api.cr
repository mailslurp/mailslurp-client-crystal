...
module 
  class InboxControllerApi
    ...
    # @return [InboxDto]
    def create_inbox(email_address : String?, tags : Array(String)?, name : String?, description : String?, use_domain_pool : Bool?, favourite : Bool?, expires_at : Time?, expires_in : Int64?, allow_team_access : Bool?, inbox_type : String?)
      data, _status_code, _headers = create_inbox_with_http_info(email_address, tags, name, description, use_domain_pool, favourite, expires_at, expires_in, allow_team_access, inbox_type)
      data
    end
    ...
    def create_inbox_with_http_info(email_address : String?, tags : Array(String)?, name : String?, description : String?, use_domain_pool : Bool?, favourite : Bool?, expires_at : Time?, expires_in : Int64?, allow_team_access : Bool?, inbox_type : String?)
    ...
    def get_emails(inbox_id : String, alias_for_limit__assessed_first_before_assessing_any_passed_limit_ : Int32?, limit : Int32?, sort_the_results_by_received_date_and_direction_asc_or_desc : String?, retry_timeout : Int64?, delay_timeout : Int64?, min_count : Int64?, unread_only : Bool?, before : Time?, since : Time?)
      data, _status_code, _headers = get_emails_with_http_info(inbox_id, alias_for_limit__assessed_first_before_assessing_any_passed_limit_, limit, sort_the_results_by_received_date_and_direction_asc_or_desc, retry_timeout, delay_timeout, min_count, unread_only, before, since)
      data
    end
    ...
    def get_emails_with_http_info(inbox_id : String, alias_for_limit__assessed_first_before_assessing_any_passed_limit_ : Int32?, limit : Int32?, sort_the_results_by_received_date_and_direction_asc_or_desc : String?, retry_timeout : Int64?, delay_timeout : Int64?, min_count : Int64?, unread_only : Bool?, before : Time?, since : Time?)
      if @api_client.config.debugging
