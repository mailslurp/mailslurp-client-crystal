...
module 
  class InboxControllerApi
    ...
    def get_emails(inbox_id : String, limit : Int32?, min_count : Int64?, retry_timeout : Int64?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_emails_with_http_info(inbox_id, limit, min_count, retry_timeout, since, size, sort)
      data
    end
    ...
    def get_emails_with_http_info(inbox_id : String, limit : Int32?, min_count : Int64?, retry_timeout : Int64?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
