...
module 
  class InboxControllerApi
    ...
    def get_all_inboxes(favourite : Bool?, page : Int32?, search : String?, size : Int32?, sort : String?, tag : String?, team_access : Bool?)
      data, _status_code, _headers = get_all_inboxes_with_http_info(favourite, page, search, size, sort, tag, team_access)
      data
    end
    ...
    def get_all_inboxes_with_http_info(favourite : Bool?, page : Int32?, search : String?, size : Int32?, sort : String?, tag : String?, team_access : Bool?)
      if @api_client.config.debugging
    ...
    def get_emails(inbox_id : String, delay_timeout : Int64?, limit : Int32?, min_count : Int64?, retry_timeout : Int64?, since : Time?, size : Int32?, sort : String?, unread_only : Bool?)
      data, _status_code, _headers = get_emails_with_http_info(inbox_id, delay_timeout, limit, min_count, retry_timeout, since, size, sort, unread_only)
      data
    end
    ...
    def get_emails_with_http_info(inbox_id : String, delay_timeout : Int64?, limit : Int32?, min_count : Int64?, retry_timeout : Int64?, since : Time?, size : Int32?, sort : String?, unread_only : Bool?)
      if @api_client.config.debugging
    ...
    def get_inbox_emails_paginated(inbox_id : String, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_inbox_emails_paginated_with_http_info(inbox_id, page, size, sort)
      data
    end
    ...
    def get_inbox_emails_paginated_with_http_info(inbox_id : String, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    def get_inbox_sent_emails(inbox_id : String, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_inbox_sent_emails_with_http_info(inbox_id, page, search_filter, size, sort)
      data
    end
    ...
    def get_inbox_sent_emails_with_http_info(inbox_id : String, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    # @return [Array(Inbox)]
    def get_inboxes(size : Int32?, sort : String?)
      data, _status_code, _headers = get_inboxes_with_http_info(size, sort)
      data
    end
    ...
    def get_inboxes_with_http_info(size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    def get_organization_inboxes(page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_organization_inboxes_with_http_info(page, search_filter, size, sort)
      data
    end
    ...
    def get_organization_inboxes_with_http_info(page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    def list_inbox_rulesets(inbox_id : String, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = list_inbox_rulesets_with_http_info(inbox_id, page, search_filter, size, sort)
      data
    end
    ...
    def list_inbox_rulesets_with_http_info(inbox_id : String, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    def list_inbox_tracking_pixels(inbox_id : String, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = list_inbox_tracking_pixels_with_http_info(inbox_id, page, search_filter, size, sort)
      data
    end
    ...
    def list_inbox_tracking_pixels_with_http_info(inbox_id : String, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      if @api_client.config.debugging
