...
module 
  class InboxControllerApi
    ...
    def get_inbox_sent_emails(inbox_id : String, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_inbox_sent_emails_with_http_info(inbox_id, page, size, sort)
      data
    end
    ...
    def get_inbox_sent_emails_with_http_info(inbox_id : String, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    def get_organization_inboxes(page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_organization_inboxes_with_http_info(page, size, sort)
      data
    end
    ...
    def get_organization_inboxes_with_http_info(page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
