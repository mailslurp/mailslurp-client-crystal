...
module 
  class InboxControllerApi
    ...
    def does_inbox_exist(email_address : String, allow_catch_all : Bool?)
      data, _status_code, _headers = does_inbox_exist_with_http_info(email_address, allow_catch_all)
      data
    end
    ...
    def does_inbox_exist_with_http_info(email_address : String, allow_catch_all : Bool?)
      if @api_client.config.debugging
