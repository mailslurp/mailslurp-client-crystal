...
module 
  class InboxControllerApi
    ...
    # @return [Inbox]
    def create_inbox(allow_team_access : Bool?, description : String?, email_address : String?, expires_at : Time?, expires_in : Int64?, favourite : Bool?, name : String?, tags : Array(String)?, use_domain_pool : Bool?)
      data, _status_code, _headers = create_inbox_with_http_info(allow_team_access, description, email_address, expires_at, expires_in, favourite, name, tags, use_domain_pool)
      data
    end
    ...
    def create_inbox_with_http_info(allow_team_access : Bool?, description : String?, email_address : String?, expires_at : Time?, expires_in : Int64?, favourite : Bool?, name : String?, tags : Array(String)?, use_domain_pool : Bool?)
