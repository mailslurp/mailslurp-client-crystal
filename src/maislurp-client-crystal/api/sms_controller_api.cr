...
module 
  class SmsControllerApi
    ...
    def get_sms_codes(sms_id : String, extract_codes_options : ExtractCodesOptions?)
      data, _status_code, _headers = get_sms_codes_with_http_info(sms_id, extract_codes_options)
      data
    end
    ...
    def get_sms_codes_with_http_info(sms_id : String, extract_codes_options : ExtractCodesOptions?)
      if @api_client.config.debugging
        Log.debug {"Calling API: SmsControllerApi.get_sms_codes ..."}
      end
      # verify the required parameter "sms_id" is set
      if @api_client.config.client_side_validation && sms_id.nil?
        raise ArgumentError.new("Missing the required parameter 'sms_id' when calling SmsControllerApi.get_sms_codes")
      end
      # resource path
      local_var_path = "/sms/{smsId}/codes".sub("{" + "smsId" + "}", URI.encode(sms_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"SmsControllerApi.get_sms_codes",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: SmsControllerApi#get_sms_codes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    # @return [nil]
    def mark_all_sms_as_read(read : Bool?, phone_number_id : String?)
      mark_all_sms_as_read_with_http_info(read, phone_number_id)
      nil
    end
    ...
    # Sets read state for all SMS messages, optionally scoped to a single phone number. Use &#x60;read&#x3D;false&#x60; to reset unread state in bulk.
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def mark_all_sms_as_read_with_http_info(read : Bool?, phone_number_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: SmsControllerApi.mark_all_sms_as_read ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PATCH,
                                                        local_var_path,
                                                        :"SmsControllerApi.mark_all_sms_as_read",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: SmsControllerApi#mark_all_sms_as_read\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
    ...
    # @param sms_id [String] 
    # @return [SmsDto]
    def mark_sms_as_read(sms_id : String, read : Bool?)
      data, _status_code, _headers = mark_sms_as_read_with_http_info(sms_id, read)
      data
    end
    ...
    # @param sms_id [String] 
    # @return [Array<(SmsDto, Integer, Hash)>] SmsDto data, response status code and response headers
    def mark_sms_as_read_with_http_info(sms_id : String, read : Bool?)
      if @api_client.config.debugging
        Log.debug {"Calling API: SmsControllerApi.mark_sms_as_read ..."}
      end
      # verify the required parameter "sms_id" is set
      if @api_client.config.client_side_validation && sms_id.nil?
        raise ArgumentError.new("Missing the required parameter 'sms_id' when calling SmsControllerApi.mark_sms_as_read")
      end
      # resource path
      local_var_path = "/sms/{smsId}/read".sub("{" + "smsId" + "}", URI.encode(sms_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:PATCH,
                                                        local_var_path,
                                                        :"SmsControllerApi.mark_sms_as_read",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: SmsControllerApi#mark_sms_as_read\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return SmsDto.from_json(data), status_code, headers
    end
