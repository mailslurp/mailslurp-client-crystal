...
module 
  class AIControllerApi
    ...
    def create_transformer(options : AITranformCreateOptions, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = create_transformer_with_http_info(options, page, size, sort)
      data
    end
    ...
    def create_transformer_with_http_info(options : AITranformCreateOptions, page : Int32?, size : Int32?, sort : String?)
      ...
      if @api_client.config.client_side_validation && options.nil?
        raise ArgumentError.new("Missing the required parameter 'options' when calling AIControllerApi.create_transformer")
      end
      if @api_client.config.client_side_validation && !size.nil? && size > 100
        raise ArgumentError.new("invalid value for \"size\" when calling AIControllerApi.create_transformer, must be smaller than or equal to 100.")
      end
    ...
    def create_transformer1(ai_tranform_create_options : AITranformCreateOptions)
      data, _status_code, _headers = create_transformer1_with_http_info(ai_tranform_create_options)
      data
    end
    ...
    def create_transformer1_with_http_info(ai_tranform_create_options : AITranformCreateOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: AIControllerApi.create_transformer1 ..."}
      end
      ...
      if @api_client.config.client_side_validation && ai_tranform_create_options.nil?
        raise ArgumentError.new("Missing the required parameter 'ai_tranform_create_options' when calling AIControllerApi.create_transformer1")
      end
      # resource path
      local_var_path = "/ai/transformer"
      ...
      # http body (model)
      post_body = ai_tranform_create_options.to_json
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"AIControllerApi.create_transformer1",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: AIControllerApi#create_transformer1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
