...
module 
  class AIControllerApi
    ...
    def export_transformer_results(export_transformer_options : ExportTransformerOptions)
      data, _status_code, _headers = export_transformer_results_with_http_info(export_transformer_options)
      data
    end
    ...
    def export_transformer_results_with_http_info(export_transformer_options : ExportTransformerOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: AIControllerApi.export_transformer_results ..."}
      end
      ...
      if @api_client.config.client_side_validation && export_transformer_options.nil?
        raise ArgumentError.new("Missing the required parameter 'export_transformer_options' when calling AIControllerApi.export_transformer_results")
      end
      # resource path
      ...
      # http body (model)
      post_body = export_transformer_options.to_json

      # return_type
      return_type = "ExportTransformerResponse"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"AIControllerApi.export_transformer_results",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: AIControllerApi#export_transformer_results\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ExportTransformerResponse.from_json(data), status_code, headers
    end
    ...
    def get_export_transformer_results_job(id : String)
      data, _status_code, _headers = get_export_transformer_results_job_with_http_info(id)
      data
    end
    ...
    def get_export_transformer_results_job_with_http_info(id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: AIControllerApi.get_export_transformer_results_job ..."}
      end
      # verify the required parameter "id" is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError.new("Missing the required parameter 'id' when calling AIControllerApi.get_export_transformer_results_job")
      end
      # resource path
      local_var_path = "/ai/transformer/results/export/{id}".sub("{" + "id" + "}", URI.encode(id.to_s))
      ...
      # return_type
      return_type = "ExportTransformerResultJobDto"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"AIControllerApi.get_export_transformer_results_job",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: AIControllerApi#get_export_transformer_results_job\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ExportTransformerResultJobDto.from_json(data), status_code, headers
    end
    ...
    def get_transformer_results(email_id : String?, sms_id : String?, attachment_id : String?, ai_transform_id : String?, ai_transform_mapping_id : String?, entity_id : String?, entity_type : String?, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_transformer_results_with_http_info(email_id, sms_id, attachment_id, ai_transform_id, ai_transform_mapping_id, entity_id, entity_type, page, size, sort)
      data
    end
    ...
    def get_transformer_results_with_http_info(email_id : String?, sms_id : String?, attachment_id : String?, ai_transform_id : String?, ai_transform_mapping_id : String?, entity_id : String?, entity_type : String?, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    # @param include_meta_data [Bool] 
    # @param flatten_arrays_to_rows [Bool] 
    # @return [PageTableData]
    def get_transformer_results_table(include_meta_data : Bool, flatten_arrays_to_rows : Bool, email_id : String?, sms_id : String?, attachment_id : String?, ai_transform_id : String?, ai_transform_mapping_id : String?, entity_id : String?, entity_type : String?, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_transformer_results_table_with_http_info(include_meta_data, flatten_arrays_to_rows, email_id, sms_id, attachment_id, ai_transform_id, ai_transform_mapping_id, entity_id, entity_type, page, size, sort)
      data
    end
    ...
    def get_transformer_results_table_with_http_info(include_meta_data : Bool, flatten_arrays_to_rows : Bool, email_id : String?, sms_id : String?, attachment_id : String?, ai_transform_id : String?, ai_transform_mapping_id : String?, entity_id : String?, entity_type : String?, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: AIControllerApi.get_transformer_results_table ..."}
      end
      # verify the required parameter "include_meta_data" is set
      if @api_client.config.client_side_validation && include_meta_data.nil?
        raise ArgumentError.new("Missing the required parameter 'include_meta_data' when calling AIControllerApi.get_transformer_results_table")
      end
      ...
      if @api_client.config.client_side_validation && flatten_arrays_to_rows.nil?
        raise ArgumentError.new("Missing the required parameter 'flatten_arrays_to_rows' when calling AIControllerApi.get_transformer_results_table")
      end
      allowable_values = ["INBOX", "PHONE"]
      if @api_client.config.client_side_validation && entity_type && !allowable_values.includes?(entity_type)
        raise ArgumentError.new("invalid value for \"entity_type\", must be one of #{allowable_values}")
      ...
      if @api_client.config.client_side_validation && !size.nil? && size > 100
        raise ArgumentError.new("invalid value for \"size\" when calling AIControllerApi.get_transformer_results_table, must be smaller than or equal to 100.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"AIControllerApi.get_transformer_results_table",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: AIControllerApi#get_transformer_results_table\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageTableData.from_json(data), status_code, headers
    end
    ...
    def test_transformer_mapping_match(id : String, email_id : String?, sms_id : String?, attachment_id : String?)
      data, _status_code, _headers = test_transformer_mapping_match_with_http_info(id, email_id, sms_id, attachment_id)
      data
    end
    ...
    def test_transformer_mapping_match_with_http_info(id : String, email_id : String?, sms_id : String?, attachment_id : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: AIControllerApi.test_transformer_mapping_match ..."}
      end
      # verify the required parameter "id" is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError.new("Missing the required parameter 'id' when calling AIControllerApi.test_transformer_mapping_match")
      end
      # resource path
      local_var_path = "/ai/transformer/mappings/{id}/match".sub("{" + "id" + "}", URI.encode(id.to_s))
      ...
      # return_type
      return_type = "AITransformMappingMatchResult"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"AIControllerApi.test_transformer_mapping_match",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: AIControllerApi#test_transformer_mapping_match\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return AITransformMappingMatchResult.from_json(data), status_code, headers
    end
