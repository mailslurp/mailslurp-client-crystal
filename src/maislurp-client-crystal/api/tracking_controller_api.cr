...
module 
  class TrackingControllerApi
    ...
    def get_all_tracking_pixels(before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_tracking_pixels_with_http_info(before, page, search_filter, since, size, sort)
      data
    end
    ...
    def get_all_tracking_pixels_with_http_info(before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
