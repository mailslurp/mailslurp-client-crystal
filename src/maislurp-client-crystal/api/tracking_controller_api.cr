...
module 
  class TrackingControllerApi
    ...
    def get_all_tracking_pixels(page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_tracking_pixels_with_http_info(page, search_filter, size, sort)
      data
    end
    ...
    def get_all_tracking_pixels_with_http_info(page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      if @api_client.config.debugging
