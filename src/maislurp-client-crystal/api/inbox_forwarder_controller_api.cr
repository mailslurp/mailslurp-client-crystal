...
module 
  class InboxForwarderControllerApi
    ...
    def get_all_inbox_forwarder_events(page : Int32?, size : Int32?, inbox_id : String?, email_id : String?, sent_id : String?, sort : String?)
      data, _status_code, _headers = get_all_inbox_forwarder_events_with_http_info(page, size, inbox_id, email_id, sent_id, sort)
      data
    end
    ...
    def get_all_inbox_forwarder_events_with_http_info(page : Int32?, size : Int32?, inbox_id : String?, email_id : String?, sent_id : String?, sort : String?)
      if @api_client.config.debugging
