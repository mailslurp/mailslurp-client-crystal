...
module 
  class InboxForwarderControllerApi
    ...
    def get_all_inbox_forwarder_events(page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_inbox_forwarder_events_with_http_info(page, size, sort)
      data
    end
    ...
    def get_all_inbox_forwarder_events_with_http_info(page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
