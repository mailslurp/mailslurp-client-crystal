...
module 
  class InboxForwarderControllerApi
    ...
    def create_new_inbox_forwarder(inbox_id : String, create_inbox_forwarder_options : CreateInboxForwarderOptions)
      data, _status_code, _headers = create_new_inbox_forwarder_with_http_info(inbox_id, create_inbox_forwarder_options)
      data
    end
    ...
    def create_new_inbox_forwarder_with_http_info(inbox_id : String, create_inbox_forwarder_options : CreateInboxForwarderOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxForwarderControllerApi.create_new_inbox_forwarder ..."}
      end
      # verify the required parameter "inbox_id" is set
      if @api_client.config.client_side_validation && inbox_id.nil?
        raise ArgumentError.new("Missing the required parameter 'inbox_id' when calling InboxForwarderControllerApi.create_new_inbox_forwarder")
      end
    ...
    def get_all_inbox_forwarder_events(page : Int32?, size : Int32?, inbox_id : String?, sort : String?)
      data, _status_code, _headers = get_all_inbox_forwarder_events_with_http_info(page, size, inbox_id, sort)
      data
    end
    ...
    def get_all_inbox_forwarder_events_with_http_info(page : Int32?, size : Int32?, inbox_id : String?, sort : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxForwarderControllerApi.get_all_inbox_forwarder_events ..."}
      end
      ...
      # return_type
      return_type = "PageInboxForwarderEvents"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxForwarderControllerApi.get_all_inbox_forwarder_events",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxForwarderControllerApi#get_all_inbox_forwarder_events\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageInboxForwarderEvents.from_json(data), status_code, headers
    end
    ...
    def get_forwarder_event(event_id : String)
      data, _status_code, _headers = get_forwarder_event_with_http_info(event_id)
      data
    end
    ...
    def get_forwarder_event_with_http_info(event_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxForwarderControllerApi.get_forwarder_event ..."}
      end
      # verify the required parameter "event_id" is set
      if @api_client.config.client_side_validation && event_id.nil?
        raise ArgumentError.new("Missing the required parameter 'event_id' when calling InboxForwarderControllerApi.get_forwarder_event")
      end
      # resource path
      local_var_path = "/forwarders/events/{eventId}".sub("{" + "eventId" + "}", URI.encode(event_id.to_s))
      ...
      # return_type
      return_type = "InboxForwarderEventDto"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxForwarderControllerApi.get_forwarder_event",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxForwarderControllerApi#get_forwarder_event\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return InboxForwarderEventDto.from_json(data), status_code, headers
    end
    ...
    # @param event_id [String] ID of inbox forwarder event
    # @return [InboxForwarderEventDto]
    def get_inbox_forwarder_event(id : String, event_id : String)
      data, _status_code, _headers = get_inbox_forwarder_event_with_http_info(id, event_id)
      data
    end
    ...
    # @param event_id [String] ID of inbox forwarder event
    # @return [Array<(InboxForwarderEventDto, Integer, Hash)>] InboxForwarderEventDto data, response status code and response headers
    def get_inbox_forwarder_event_with_http_info(id : String, event_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxForwarderControllerApi.get_inbox_forwarder_event ..."}
      end
      # verify the required parameter "id" is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError.new("Missing the required parameter 'id' when calling InboxForwarderControllerApi.get_inbox_forwarder_event")
      end
      # verify the required parameter "event_id" is set
      if @api_client.config.client_side_validation && event_id.nil?
        raise ArgumentError.new("Missing the required parameter 'event_id' when calling InboxForwarderControllerApi.get_inbox_forwarder_event")
      end
      # resource path
      local_var_path = "/forwarders/{id}/events/{eventId}".sub("{" + "id" + "}", URI.encode(id.to_s)).sub("{" + "eventId" + "}", URI.encode(event_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxForwarderControllerApi.get_inbox_forwarder_event",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxForwarderControllerApi#get_inbox_forwarder_event\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return InboxForwarderEventDto.from_json(data), status_code, headers
    end
    ...
    # @param id [String] ID of inbox forwarder
    # @return [PageInboxForwarderEvents]
    def get_inbox_forwarder_events(id : String, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_inbox_forwarder_events_with_http_info(id, page, size, sort)
      data
    end
    ...
    # @param id [String] ID of inbox forwarder
    # @return [Array<(PageInboxForwarderEvents, Integer, Hash)>] PageInboxForwarderEvents data, response status code and response headers
    def get_inbox_forwarder_events_with_http_info(id : String, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxForwarderControllerApi.get_inbox_forwarder_events ..."}
      end
      # verify the required parameter "id" is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError.new("Missing the required parameter 'id' when calling InboxForwarderControllerApi.get_inbox_forwarder_events")
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      # resource path
      local_var_path = "/forwarders/{id}/events".sub("{" + "id" + "}", URI.encode(id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxForwarderControllerApi.get_inbox_forwarder_events",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxForwarderControllerApi#get_inbox_forwarder_events\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageInboxForwarderEvents.from_json(data), status_code, headers
    end
    ...
    def get_inbox_forwarders(inbox_id : String?, page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_inbox_forwarders_with_http_info(inbox_id, page, size, sort, search_filter, since, before)
      data
    end
    ...
    def get_inbox_forwarders_with_http_info(inbox_id : String?, page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
    ...
    # @param create_inbox_forwarder_options [CreateInboxForwarderOptions] 
    # @return [InboxForwarderDto]
    def update_inbox_forwarder(id : String, create_inbox_forwarder_options : CreateInboxForwarderOptions)
      data, _status_code, _headers = update_inbox_forwarder_with_http_info(id, create_inbox_forwarder_options)
      data
    end
    ...
    # @param create_inbox_forwarder_options [CreateInboxForwarderOptions] 
    # @return [Array<(InboxForwarderDto, Integer, Hash)>] InboxForwarderDto data, response status code and response headers
    def update_inbox_forwarder_with_http_info(id : String, create_inbox_forwarder_options : CreateInboxForwarderOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxForwarderControllerApi.update_inbox_forwarder ..."}
      end
      # verify the required parameter "id" is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError.new("Missing the required parameter 'id' when calling InboxForwarderControllerApi.update_inbox_forwarder")
      end
      # verify the required parameter "create_inbox_forwarder_options" is set
      if @api_client.config.client_side_validation && create_inbox_forwarder_options.nil?
        raise ArgumentError.new("Missing the required parameter 'create_inbox_forwarder_options' when calling InboxForwarderControllerApi.update_inbox_forwarder")
      end
      # resource path
      local_var_path = "/forwarders/{id}".sub("{" + "id" + "}", URI.encode(id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        local_var_path,
                                                        :"InboxForwarderControllerApi.update_inbox_forwarder",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxForwarderControllerApi#update_inbox_forwarder\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return InboxForwarderDto.from_json(data), status_code, headers
    end
  end
