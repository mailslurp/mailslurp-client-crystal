...
module 
  class InboxForwarderControllerApi
    ...
    def get_inbox_forwarders(before : Time?, inbox_id : String?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_inbox_forwarders_with_http_info(before, inbox_id, page, search_filter, since, size, sort)
      data
    end
    ...
    def get_inbox_forwarders_with_http_info(before : Time?, inbox_id : String?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
