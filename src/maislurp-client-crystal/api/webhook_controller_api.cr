...
module 
  class WebhookControllerApi
    ...
    def get_all_webhook_results(before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?, unseen_only : Bool?)
      data, _status_code, _headers = get_all_webhook_results_with_http_info(before, page, search_filter, since, size, sort, unseen_only)
      data
    end

    # Get results for all webhooks
    # @return [Array<(PageWebhookResult, Integer, Hash)>] PageWebhookResult data, response status code and response headers
    def get_all_webhook_results_with_http_info(before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?, unseen_only : Bool?)
      if @api_client.config.debugging
    ...
    def get_all_webhooks(before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_webhooks_with_http_info(before, page, search_filter, since, size, sort)
      data
    end
    ...
    def get_all_webhooks_with_http_info(before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    # @param inbox_id [String] inboxId
    # @return [PageWebhookProjection]
    def get_inbox_webhooks_paginated(inbox_id : String, before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_inbox_webhooks_paginated_with_http_info(inbox_id, before, page, search_filter, since, size, sort)
      data
    end
    ...
    # @param inbox_id [String] inboxId
    # @return [Array<(PageWebhookProjection, Integer, Hash)>] PageWebhookProjection data, response status code and response headers
    def get_inbox_webhooks_paginated_with_http_info(inbox_id : String, before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    # @return [PageWebhookResult]
    def get_webhook_results(webhook_id : String, before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?, unseen_only : Bool?)
      data, _status_code, _headers = get_webhook_results_with_http_info(webhook_id, before, page, search_filter, since, size, sort, unseen_only)
      data
    end
    ...
    # @param webhook_id [String] ID of webhook to get results for
    # @return [Array<(PageWebhookResult, Integer, Hash)>] PageWebhookResult data, response status code and response headers
    def get_webhook_results_with_http_info(webhook_id : String, before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?, unseen_only : Bool?)
      if @api_client.config.debugging
