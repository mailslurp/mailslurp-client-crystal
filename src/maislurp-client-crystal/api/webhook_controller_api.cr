...
module 
  class WebhookControllerApi
    ...
    # @param create_webhook_options [CreateWebhookOptions] 
    # @return [WebhookDto]
    def create_webhook_for_ai_transformer(transformer_id : String, create_webhook_options : CreateWebhookOptions)
      data, _status_code, _headers = create_webhook_for_ai_transformer_with_http_info(transformer_id, create_webhook_options)
      data
    end
    ...
    # @param create_webhook_options [CreateWebhookOptions] 
    # @return [Array<(WebhookDto, Integer, Hash)>] WebhookDto data, response status code and response headers
    def create_webhook_for_ai_transformer_with_http_info(transformer_id : String, create_webhook_options : CreateWebhookOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: WebhookControllerApi.create_webhook_for_ai_transformer ..."}
      end
      # verify the required parameter "transformer_id" is set
      if @api_client.config.client_side_validation && transformer_id.nil?
        raise ArgumentError.new("Missing the required parameter 'transformer_id' when calling WebhookControllerApi.create_webhook_for_ai_transformer")
      end
      # verify the required parameter "create_webhook_options" is set
      if @api_client.config.client_side_validation && create_webhook_options.nil?
        raise ArgumentError.new("Missing the required parameter 'create_webhook_options' when calling WebhookControllerApi.create_webhook_for_ai_transformer")
      end
      # resource path
      local_var_path = "/ai-transformers/{transformerId}/webhooks".sub("{" + "transformerId" + "}", URI.encode(transformer_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"WebhookControllerApi.create_webhook_for_ai_transformer",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: WebhookControllerApi#create_webhook_for_ai_transformer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return WebhookDto.from_json(data), status_code, headers
    end
    ...
    def get_all_account_webhooks(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, event_type : String?, health : String?, search_filter : String?)
      data, _status_code, _headers = get_all_account_webhooks_with_http_info(page, size, sort, since, before, event_type, health, search_filter)
      data
    end
    ...
    def get_all_account_webhooks_with_http_info(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, event_type : String?, health : String?, search_filter : String?)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && health && !allowable_values.includes?(health)
        raise ArgumentError.new("invalid value for \"health\", must be one of #{allowable_values}")
      end
      # resource path
    ...
    def get_all_webhook_endpoints(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, inbox_id : String?, phone_id : String?, before : Time?, health : String?, event_type : String?)
      data, _status_code, _headers = get_all_webhook_endpoints_with_http_info(page, size, sort, search_filter, since, inbox_id, phone_id, before, health, event_type)
      data
    end
    ...
    def get_all_webhook_endpoints_with_http_info(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, inbox_id : String?, phone_id : String?, before : Time?, health : String?, event_type : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: WebhookControllerApi.get_all_webhook_endpoints ..."}
      end
      if @api_client.config.client_side_validation && !page.nil? && page > 9223372036854775807
        raise ArgumentError.new("invalid value for \"page\" when calling WebhookControllerApi.get_all_webhook_endpoints, must be smaller than or equal to 9223372036854775807.")
      end

      if @api_client.config.client_side_validation && !page.nil? && page < 0
        raise ArgumentError.new("invalid value for \"page\" when calling WebhookControllerApi.get_all_webhook_endpoints, must be greater than or equal to 0.")
      end

      if @api_client.config.client_side_validation && !size.nil? && size > 100
        raise ArgumentError.new("invalid value for \"size\" when calling WebhookControllerApi.get_all_webhook_endpoints, must be smaller than or equal to 100.")
      end

      if @api_client.config.client_side_validation && !size.nil? && size < 1
        raise ArgumentError.new("invalid value for \"size\" when calling WebhookControllerApi.get_all_webhook_endpoints, must be greater than or equal to 1.")
      end
      ...
      # return_type
      return_type = "PageWebhookEndpointProjection"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"WebhookControllerApi.get_all_webhook_endpoints",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: WebhookControllerApi#get_all_webhook_endpoints\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageWebhookEndpointProjection.from_json(data), status_code, headers
    end

    # Get results for all webhooks
    # @return [PageWebhookResult]
    def get_all_webhook_results(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?, unseen_only : Bool?, result_type : String?, event_name : String?, min_status_code : Int32?, max_status_code : Int32?, inbox_id : String?, sms_id : String?, attachment_id : String?, email_id : String?, phone_id : String?, ai_transformer_id : String?)
      data, _status_code, _headers = get_all_webhook_results_with_http_info(page, size, sort, search_filter, since, before, unseen_only, result_type, event_name, min_status_code, max_status_code, inbox_id, sms_id, attachment_id, email_id, phone_id, ai_transformer_id)
      data
    end

    # Get results for all webhooks
    # @return [Array<(PageWebhookResult, Integer, Hash)>] PageWebhookResult data, response status code and response headers
    def get_all_webhook_results_with_http_info(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?, unseen_only : Bool?, result_type : String?, event_name : String?, min_status_code : Int32?, max_status_code : Int32?, inbox_id : String?, sms_id : String?, attachment_id : String?, email_id : String?, phone_id : String?, ai_transformer_id : String?)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && result_type && !allowable_values.includes?(result_type)
        raise ArgumentError.new("invalid value for \"result_type\", must be one of #{allowable_values}")
      end
      allowable_values = ["EMAIL_RECEIVED", "NEW_AI_TRANSFORM_RESULT", "NEW_EMAIL", "NEW_CONTACT", "NEW_ATTACHMENT", "EMAIL_OPENED", "EMAIL_READ", "DELIVERY_STATUS", "BOUNCE", "BOUNCE_RECIPIENT", "NEW_SMS", "NEW_GUEST_USER"]
      ...
      query_params[:"minStatusCode"] = min_status_code
      query_params[:"maxStatusCode"] = max_status_code
      query_params[:"inboxId"] = inbox_id
      query_params[:"smsId"] = sms_id
      query_params[:"attachmentId"] = attachment_id
      query_params[:"emailId"] = email_id
      query_params[:"phoneId"] = phone_id
      query_params[:"aiTransformerId"] = ai_transformer_id
    ...
    # @return [PageWebhookProjection]
    def get_all_webhooks(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, inbox_id : String?, ai_transformer_id : String?, phone_id : String?, before : Time?, health : String?, event_type : String?, url : String?, event_type_source : String?, include_account_wide : Bool?)
      data, _status_code, _headers = get_all_webhooks_with_http_info(page, size, sort, search_filter, since, inbox_id, ai_transformer_id, phone_id, before, health, event_type, url, event_type_source, include_account_wide)
      data
    end
    ...
    # List webhooks in paginated form. Allows for page index, page size, and sort direction.
    # @return [Array<(PageWebhookProjection, Integer, Hash)>] PageWebhookProjection data, response status code and response headers
    def get_all_webhooks_with_http_info(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, inbox_id : String?, ai_transformer_id : String?, phone_id : String?, before : Time?, health : String?, event_type : String?, url : String?, event_type_source : String?, include_account_wide : Bool?)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && event_type_source && !allowable_values.includes?(event_type_source)
        raise ArgumentError.new("invalid value for \"event_type_source\", must be one of #{allowable_values}")
      end
      # resource path
      ...
      query_params[:"eventTypeSource"] = event_type_source
      query_params[:"includeAccountWide"] = include_account_wide
    ...
    # @param inbox_id [String] 
    # @return [PageWebhookProjection]
    def get_inbox_webhooks_paginated(inbox_id : String, page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?, health : String?, event_type : String?, include_account_wide : Bool?)
      data, _status_code, _headers = get_inbox_webhooks_paginated_with_http_info(inbox_id, page, size, sort, search_filter, since, before, health, event_type, include_account_wide)
      data
    end
    ...
    # @param inbox_id [String] 
    # @return [Array<(PageWebhookProjection, Integer, Hash)>] PageWebhookProjection data, response status code and response headers
    def get_inbox_webhooks_paginated_with_http_info(inbox_id : String, page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?, health : String?, event_type : String?, include_account_wide : Bool?)
      if @api_client.config.debugging
    ...
    # @return [PageWebhookProjection]
    def get_phone_number_webhooks_paginated(phone_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, event_type : String?, search_filter : String?, health : String?, include_account_wide : Bool?)
      data, _status_code, _headers = get_phone_number_webhooks_paginated_with_http_info(phone_id, page, size, sort, since, before, event_type, search_filter, health, include_account_wide)
      data
    end
    ...
    # @param phone_id [String] 
    # @return [Array<(PageWebhookProjection, Integer, Hash)>] PageWebhookProjection data, response status code and response headers
    def get_phone_number_webhooks_paginated_with_http_info(phone_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, event_type : String?, search_filter : String?, health : String?, include_account_wide : Bool?)
      if @api_client.config.debugging
    ...
    def get_test_webhook_payload_new_ai_transform_result()
      data, _status_code, _headers = get_test_webhook_payload_new_ai_transform_result_with_http_info()
      data
    end
    ...
    def get_test_webhook_payload_new_ai_transform_result_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: WebhookControllerApi.get_test_webhook_payload_new_ai_transform_result ..."}
      end
      # resource path
      ...
      # return_type
      return_type = "WebhookNewAITransformResultPayload"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"WebhookControllerApi.get_test_webhook_payload_new_ai_transform_result",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: WebhookControllerApi#get_test_webhook_payload_new_ai_transform_result\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return WebhookNewAITransformResultPayload.from_json(data), status_code, headers
    end
    ...
    # @return [PageWebhookResult]
    def get_webhook_results(webhook_id : String, page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?, unseen_only : Bool?, result_type : String?, event_name : String?, min_status_code : Int32?, max_status_code : Int32?, inbox_id : String?, sms_id : String?, attachment_id : String?, email_id : String?, phone_id : String?, ai_transformer_id : String?)
      data, _status_code, _headers = get_webhook_results_with_http_info(webhook_id, page, size, sort, search_filter, since, before, unseen_only, result_type, event_name, min_status_code, max_status_code, inbox_id, sms_id, attachment_id, email_id, phone_id, ai_transformer_id)
      data
    end
    ...
    # @param webhook_id [String] ID of webhook to get results for
    # @return [Array<(PageWebhookResult, Integer, Hash)>] PageWebhookResult data, response status code and response headers
    def get_webhook_results_with_http_info(webhook_id : String, page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?, unseen_only : Bool?, result_type : String?, event_name : String?, min_status_code : Int32?, max_status_code : Int32?, inbox_id : String?, sms_id : String?, attachment_id : String?, email_id : String?, phone_id : String?, ai_transformer_id : String?)
      if @api_client.config.debugging
    ...
    # @param webhook_id [String] ID of webhook to get results for
    # @return [CountDto]
    def get_webhook_results_count(webhook_id : String)
      data, _status_code, _headers = get_webhook_results_count_with_http_info(webhook_id)
      data
    end
    ...
    def get_webhook_results_count_with_http_info(webhook_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: WebhookControllerApi.get_webhook_results_count ..."}
      end
      # verify the required parameter "webhook_id" is set
      if @api_client.config.client_side_validation && webhook_id.nil?
        raise ArgumentError.new("Missing the required parameter 'webhook_id' when calling WebhookControllerApi.get_webhook_results_count")
      end
      # resource path
      local_var_path = "/webhooks/{webhookId}/results/count".sub("{" + "webhookId" + "}", URI.encode(webhook_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"WebhookControllerApi.get_webhook_results_count",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: WebhookControllerApi#get_webhook_results_count\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_webhooks(inbox_id : String, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_webhooks_with_http_info(inbox_id, page, size, sort)
      data
    end
    ...
    def get_webhooks_with_http_info(inbox_id : String, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
      ...
      # return_type
      return_type = "Array(WebhookProjection)"
      ...
      return Array(WebhookProjection).from_json(data), status_code, headers
    end
    ...
    def redrive_all_webhook_results()
      data, _status_code, _headers = redrive_all_webhook_results_with_http_info()
      data
    end
    ...
    def redrive_all_webhook_results_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: WebhookControllerApi.redrive_all_webhook_results ..."}
      end
      # resource path
      ...
      # return_type
      return_type = "WebhookRedriveAllResult"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"WebhookControllerApi.redrive_all_webhook_results",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: WebhookControllerApi#redrive_all_webhook_results\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return WebhookRedriveAllResult.from_json(data), status_code, headers
    end
    ...
    # @param create_webhook_options [CreateWebhookOptions] 
    # @return [WebhookDto]
    def update_webhook(webhook_id : String, create_webhook_options : CreateWebhookOptions, inbox_id : String?, ai_transformer_id : String?, phone_number_id : String?, override_auth : Bool?)
      data, _status_code, _headers = update_webhook_with_http_info(webhook_id, create_webhook_options, inbox_id, ai_transformer_id, phone_number_id, override_auth)
      data
    end
    ...
    # @param create_webhook_options [CreateWebhookOptions] 
    # @return [Array<(WebhookDto, Integer, Hash)>] WebhookDto data, response status code and response headers
    def update_webhook_with_http_info(webhook_id : String, create_webhook_options : CreateWebhookOptions, inbox_id : String?, ai_transformer_id : String?, phone_number_id : String?, override_auth : Bool?)
      if @api_client.config.debugging
        Log.debug {"Calling API: WebhookControllerApi.update_webhook ..."}
      end
      # verify the required parameter "webhook_id" is set
      if @api_client.config.client_side_validation && webhook_id.nil?
        raise ArgumentError.new("Missing the required parameter 'webhook_id' when calling WebhookControllerApi.update_webhook")
      end
      # verify the required parameter "create_webhook_options" is set
      if @api_client.config.client_side_validation && create_webhook_options.nil?
        raise ArgumentError.new("Missing the required parameter 'create_webhook_options' when calling WebhookControllerApi.update_webhook")
      end
      # resource path
      local_var_path = "/webhooks/{webhookId}".sub("{" + "webhookId" + "}", URI.encode(webhook_id.to_s))
      ...
      query_params[:"overrideAuth"] = override_auth
      ...
      data, status_code, headers = @api_client.call_api(:PATCH,
                                                        local_var_path,
                                                        :"WebhookControllerApi.update_webhook",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: WebhookControllerApi#update_webhook\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return WebhookDto.from_json(data), status_code, headers
    end
