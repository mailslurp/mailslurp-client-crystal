...
module 
  class WebhookControllerApi
    ...
    def get_all_webhook_results(page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_webhook_results_with_http_info(page, size, sort)
      data
    end

    # Get results for all webhooks
    # @return [Array<(PageWebhookResult, Integer, Hash)>] PageWebhookResult data, response status code and response headers
    def get_all_webhook_results_with_http_info(page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    def get_all_webhooks(page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_webhooks_with_http_info(page, size, sort)
      data
    end
    ...
    def get_all_webhooks_with_http_info(page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    # @return [PageWebhookResult]
    def get_webhook_results(webhook_id : String, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_webhook_results_with_http_info(webhook_id, page, size, sort)
      data
    end
    ...
    # @param webhook_id [String] ID of webhook to get results for
    # @return [Array<(PageWebhookResult, Integer, Hash)>] PageWebhookResult data, response status code and response headers
    def get_webhook_results_with_http_info(webhook_id : String, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
