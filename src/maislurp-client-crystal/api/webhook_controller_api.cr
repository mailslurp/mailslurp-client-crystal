...
module 
  class WebhookControllerApi
    ...
    # @return [PageWebhookProjection]
    def get_all_webhooks(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, inbox_id : String?, ai_transformer_id : String?, phone_id : String?, before : Time?, health : String?, event_type : String?, url : String?)
      data, _status_code, _headers = get_all_webhooks_with_http_info(page, size, sort, search_filter, since, inbox_id, ai_transformer_id, phone_id, before, health, event_type, url)
      data
    end
    ...
    # List webhooks in paginated form. Allows for page index, page size, and sort direction.
    # @return [Array<(PageWebhookProjection, Integer, Hash)>] PageWebhookProjection data, response status code and response headers
    def get_all_webhooks_with_http_info(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, inbox_id : String?, ai_transformer_id : String?, phone_id : String?, before : Time?, health : String?, event_type : String?, url : String?)
      if @api_client.config.debugging
    ...
    # @param inbox_id [String] 
    # @return [PageWebhookProjection]
    def get_inbox_webhooks_paginated(inbox_id : String, page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?, health : String?, event_type : String?)
      data, _status_code, _headers = get_inbox_webhooks_paginated_with_http_info(inbox_id, page, size, sort, search_filter, since, before, health, event_type)
      data
    end
    ...
    # @param inbox_id [String] 
    # @return [Array<(PageWebhookProjection, Integer, Hash)>] PageWebhookProjection data, response status code and response headers
    def get_inbox_webhooks_paginated_with_http_info(inbox_id : String, page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?, health : String?, event_type : String?)
      if @api_client.config.debugging
    ...
    # @return [PageWebhookProjection]
    def get_phone_number_webhooks_paginated(phone_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, event_type : String?, search_filter : String?, health : String?)
      data, _status_code, _headers = get_phone_number_webhooks_paginated_with_http_info(phone_id, page, size, sort, since, before, event_type, search_filter, health)
      data
    end
    ...
    # @param phone_id [String] 
    # @return [Array<(PageWebhookProjection, Integer, Hash)>] PageWebhookProjection data, response status code and response headers
    def get_phone_number_webhooks_paginated_with_http_info(phone_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, event_type : String?, search_filter : String?, health : String?)
      if @api_client.config.debugging
