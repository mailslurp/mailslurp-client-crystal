...
module 
  class WebhookControllerApi
    ...
    def get_all_webhook_results(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?, unseen_only : Bool?, result_type : String?, event_name : String?, min_status_code : Int32?, max_status_code : Int32?, inbox_id : String?, sms_id : String?, attachment_id : String?, email_id : String?, phone_id : String?)
      data, _status_code, _headers = get_all_webhook_results_with_http_info(page, size, sort, search_filter, since, before, unseen_only, result_type, event_name, min_status_code, max_status_code, inbox_id, sms_id, attachment_id, email_id, phone_id)
      data
    end
    ...
    # @return [PageWebhookProjection]
    def get_all_webhooks(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, inbox_id : String?, phone_id : String?, before : Time?, health : String?, event_type : String?, url : String?)
      data, _status_code, _headers = get_all_webhooks_with_http_info(page, size, sort, search_filter, since, inbox_id, phone_id, before, health, event_type, url)
      data
    end
    ...
    # List webhooks in paginated form. Allows for page index, page size, and sort direction.
    # @return [Array<(PageWebhookProjection, Integer, Hash)>] PageWebhookProjection data, response status code and response headers
    def get_all_webhooks_with_http_info(page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, inbox_id : String?, phone_id : String?, before : Time?, health : String?, event_type : String?, url : String?)
      if @api_client.config.debugging
    ...
    # @return [PageWebhookResult]
    def get_webhook_results(webhook_id : String, page : Int32?, size : Int32?, sort : String?, search_filter : String?, since : Time?, before : Time?, unseen_only : Bool?, result_type : String?, event_name : String?, min_status_code : Int32?, max_status_code : Int32?, inbox_id : String?, sms_id : String?, attachment_id : String?, email_id : String?, phone_id : String?)
      data, _status_code, _headers = get_webhook_results_with_http_info(webhook_id, page, size, sort, search_filter, since, before, unseen_only, result_type, event_name, min_status_code, max_status_code, inbox_id, sms_id, attachment_id, email_id, phone_id)
      data
    end
    ...
    # @param create_webhook_options [CreateWebhookOptions] 
    # @return [WebhookDto]
    def update_webhook(webhook_id : String, create_webhook_options : CreateWebhookOptions, inbox_id : String?, phone_number_id : String?, override_auth : Bool?)
      data, _status_code, _headers = update_webhook_with_http_info(webhook_id, create_webhook_options, inbox_id, phone_number_id, override_auth)
      data
    end
    ...
    # @param create_webhook_options [CreateWebhookOptions] 
    # @return [Array<(WebhookDto, Integer, Hash)>] WebhookDto data, response status code and response headers
    def update_webhook_with_http_info(webhook_id : String, create_webhook_options : CreateWebhookOptions, inbox_id : String?, phone_number_id : String?, override_auth : Bool?)
      if @api_client.config.debugging
