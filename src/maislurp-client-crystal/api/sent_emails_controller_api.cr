...
module 
  class SentEmailsControllerApi
    ...
    def get_all_sent_tracking_pixels(before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_sent_tracking_pixels_with_http_info(before, page, search_filter, since, size, sort)
      data
    end
    ...
    def get_all_sent_tracking_pixels_with_http_info(before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
    ...
    # @param id [String] id
    # @return [PageTrackingPixelProjection]
    def get_sent_email_tracking_pixels(id : String, before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_sent_email_tracking_pixels_with_http_info(id, before, page, search_filter, since, size, sort)
      data
    end
    ...
    # @param id [String] id
    # @return [Array<(PageTrackingPixelProjection, Integer, Hash)>] PageTrackingPixelProjection data, response status code and response headers
    def get_sent_email_tracking_pixels_with_http_info(id : String, before : Time?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    def get_sent_emails(before : Time?, inbox_id : String?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_sent_emails_with_http_info(before, inbox_id, page, search_filter, since, size, sort)
      data
    end

    # Get all sent emails in paginated form
    # @return [Array<(PageSentEmailProjection, Integer, Hash)>] PageSentEmailProjection data, response status code and response headers
    def get_sent_emails_with_http_info(before : Time?, inbox_id : String?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    # @return [PageSentEmailProjection]
    def get_sent_organization_emails(before : Time?, inbox_id : String?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_sent_organization_emails_with_http_info(before, inbox_id, page, search_filter, since, size, sort)
      data
    end

    # Get all sent organization emails in paginated form
    # @return [Array<(PageSentEmailProjection, Integer, Hash)>] PageSentEmailProjection data, response status code and response headers
    def get_sent_organization_emails_with_http_info(before : Time?, inbox_id : String?, page : Int32?, search_filter : String?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
