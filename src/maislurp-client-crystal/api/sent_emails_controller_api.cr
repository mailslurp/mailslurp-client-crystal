...
module 
  class SentEmailsControllerApi
    ...
    def get_all_sent_tracking_pixels(page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_sent_tracking_pixels_with_http_info(page, search_filter, size, sort)
      data
    end
    ...
    def get_all_sent_tracking_pixels_with_http_info(page : Int32?, search_filter : String?, size : Int32?, sort : String?)
    ...
    # @param id [String] id
    # @return [PageTrackingPixelProjection]
    def get_sent_email_tracking_pixels(id : String, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_sent_email_tracking_pixels_with_http_info(id, page, search_filter, size, sort)
      data
    end
    ...
    # @param id [String] id
    # @return [Array<(PageTrackingPixelProjection, Integer, Hash)>] PageTrackingPixelProjection data, response status code and response headers
    def get_sent_email_tracking_pixels_with_http_info(id : String, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      if @api_client.config.debugging
