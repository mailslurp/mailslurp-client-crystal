...
module 
  class SentEmailsControllerApi
    ...
    def get_raw_sent_email_contents(email_id : String)
      get_raw_sent_email_contents_with_http_info(email_id)
      nil
    end
    ...
    def get_sent_delivery_status(delivery_id : String)
      data, _status_code, _headers = get_sent_delivery_status_with_http_info(delivery_id)
      data
    end
    ...
    def get_sent_delivery_status_with_http_info(delivery_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: SentEmailsControllerApi.get_sent_delivery_status ..."}
      end
      # verify the required parameter "delivery_id" is set
      if @api_client.config.client_side_validation && delivery_id.nil?
        raise ArgumentError.new("Missing the required parameter 'delivery_id' when calling SentEmailsControllerApi.get_sent_delivery_status")
      end
      # resource path
      local_var_path = "/sent/delivery-status/{deliveryId}".sub("{" + "deliveryId" + "}", URI.encode(delivery_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"SentEmailsControllerApi.get_sent_delivery_status",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: SentEmailsControllerApi#get_sent_delivery_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return DeliveryStatusDto.from_json(data), status_code, headers
    end

    # Get all sent email delivery statuses
    # @return [PageDeliveryStatus]
    def get_sent_delivery_statuses(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_sent_delivery_statuses_with_http_info(page, size, sort, since, before)
      data
    end

    # Get all sent email delivery statuses
    # @return [Array<(PageDeliveryStatus, Integer, Hash)>] PageDeliveryStatus data, response status code and response headers
    def get_sent_delivery_statuses_with_http_info(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: SentEmailsControllerApi.get_sent_delivery_statuses ..."}
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"SentEmailsControllerApi.get_sent_delivery_statuses",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: SentEmailsControllerApi#get_sent_delivery_statuses\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    # @return [PageDeliveryStatus]
    def get_sent_delivery_statuses_by_sent_id(sent_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_sent_delivery_statuses_by_sent_id_with_http_info(sent_id, page, size, sort, since, before)
      data
    end
    ...
    # @param sent_id [String] ID of the sent email that you want to get the delivery status of. Sent email object is returned when sending an email
    # @return [Array<(PageDeliveryStatus, Integer, Hash)>] PageDeliveryStatus data, response status code and response headers
    def get_sent_delivery_statuses_by_sent_id_with_http_info(sent_id : String, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: SentEmailsControllerApi.get_sent_delivery_statuses_by_sent_id ..."}
      end
      # verify the required parameter "sent_id" is set
      if @api_client.config.client_side_validation && sent_id.nil?
        raise ArgumentError.new("Missing the required parameter 'sent_id' when calling SentEmailsControllerApi.get_sent_delivery_statuses_by_sent_id")
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      # resource path
      local_var_path = "/sent/{sentId}/delivery-status".sub("{" + "sentId" + "}", URI.encode(sent_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"SentEmailsControllerApi.get_sent_delivery_statuses_by_sent_id",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: SentEmailsControllerApi#get_sent_delivery_statuses_by_sent_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageDeliveryStatus.from_json(data), status_code, headers
    end
    ...
    def get_sent_emails_with_queue_results(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_sent_emails_with_queue_results_with_http_info(page, size, sort, since, before)
      data
    end
    ...
    def get_sent_emails_with_queue_results_with_http_info(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: SentEmailsControllerApi.get_sent_emails_with_queue_results ..."}
      end
      allowable_values = ["ASC", "DESC"]
      if @api_client.config.client_side_validation && sort && !allowable_values.includes?(sort)
        raise ArgumentError.new("invalid value for \"sort\", must be one of #{allowable_values}")
      ...
      # return_type
      return_type = "PageSentEmailWithQueueProjection"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"SentEmailsControllerApi.get_sent_emails_with_queue_results",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: SentEmailsControllerApi#get_sent_emails_with_queue_results\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageSentEmailWithQueueProjection.from_json(data), status_code, headers
    end
    ...
    # @return [DeliveryStatusDto]
    def wait_for_delivery_statuses(sent_id : String?, inbox_id : String?, timeout : Int64?, index : Int32?, since : Time?, before : Time?)
      data, _status_code, _headers = wait_for_delivery_statuses_with_http_info(sent_id, inbox_id, timeout, index, since, before)
      data
    end

    # Wait for delivery statuses
    # @return [Array<(DeliveryStatusDto, Integer, Hash)>] DeliveryStatusDto data, response status code and response headers
    def wait_for_delivery_statuses_with_http_info(sent_id : String?, inbox_id : String?, timeout : Int64?, index : Int32?, since : Time?, before : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: SentEmailsControllerApi.wait_for_delivery_statuses ..."}
      end
      if @api_client.config.client_side_validation && !index.nil? && index > 2147483647
        raise ArgumentError.new("invalid value for \"index\" when calling SentEmailsControllerApi.wait_for_delivery_statuses, must be smaller than or equal to 2147483647.")
      end

      if @api_client.config.client_side_validation && !index.nil? && index < 0
        raise ArgumentError.new("invalid value for \"index\" when calling SentEmailsControllerApi.wait_for_delivery_statuses, must be greater than or equal to 0.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"SentEmailsControllerApi.wait_for_delivery_statuses",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: SentEmailsControllerApi#wait_for_delivery_statuses\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return DeliveryStatusDto.from_json(data), status_code, headers
    end
  end
