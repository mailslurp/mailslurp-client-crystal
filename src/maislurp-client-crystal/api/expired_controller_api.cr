...
module 
  class ExpiredControllerApi
    ...
    def get_expired_inboxes(page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_expired_inboxes_with_http_info(page, size, sort)
      data
    end
    ...
    def get_expired_inboxes_with_http_info(page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
