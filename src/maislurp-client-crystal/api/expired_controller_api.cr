...
module 
  class ExpiredControllerApi
    ...
    def get_expired_inboxes(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, inbox_id : String?)
      data, _status_code, _headers = get_expired_inboxes_with_http_info(page, size, sort, since, before, inbox_id)
      data
    end
    ...
    def get_expired_inboxes_with_http_info(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, inbox_id : String?)
      if @api_client.config.debugging
