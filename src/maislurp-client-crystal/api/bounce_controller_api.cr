...
module 
  class BounceControllerApi
    ...
    def get_bounced_email_with_http_info(id : String)
      ...
      return Bounce.from_json(data), status_code, headers
    end
    ...
    def get_bounced_emails(page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_bounced_emails_with_http_info(page, size, sort)
      data
    end
    ...
    def get_bounced_recipient_with_http_info(id : String)
      ...
      return BounceRecipient.from_json(data), status_code, headers
    end
    ...
    def get_bounced_recipients(page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_bounced_recipients_with_http_info(page, size, sort)
      data
    end
