...
module 
  class BounceControllerApi
    ...
    def get_bounced_emails(before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_bounced_emails_with_http_info(before, page, since, size, sort)
      data
    end
    ...
    def get_bounced_emails_with_http_info(before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    def get_bounced_recipients(before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_bounced_recipients_with_http_info(before, page, since, size, sort)
      data
    end
    ...
    def get_bounced_recipients_with_http_info(before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
