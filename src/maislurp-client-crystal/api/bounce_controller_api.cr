...
module 
  class BounceControllerApi
    ...
    def get_reputation_items(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_reputation_items_with_http_info(page, size, sort, since, before)
      data
    end
    ...
    def get_reputation_items_with_http_info(page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: BounceControllerApi.get_reputation_items ..."}
      end
      if @api_client.config.client_side_validation && !size.nil? && size > 100
        raise ArgumentError.new("invalid value for \"size\" when calling BounceControllerApi.get_reputation_items, must be smaller than or equal to 100.")
      end
      ...
      # return_type
      return_type = "PageReputationItems"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"BounceControllerApi.get_reputation_items",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: BounceControllerApi#get_reputation_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PageReputationItems.from_json(data), status_code, headers
    end
    ...
    def get_tenant_reputation_findings(account_region : String?)
      data, _status_code, _headers = get_tenant_reputation_findings_with_http_info(account_region)
      data
    end
    ...
    def get_tenant_reputation_findings_with_http_info(account_region : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: BounceControllerApi.get_tenant_reputation_findings ..."}
      end
      ...
      if @api_client.config.client_side_validation && account_region && !allowable_values.includes?(account_region)
        raise ArgumentError.new("invalid value for \"account_region\", must be one of #{allowable_values}")
      end
      # resource path
      ...
      # query parameters
      query_params = Hash(Symbol, String).new
      query_params[:"accountRegion"] = account_region
      ...
      # return_type
      return_type = "TenantReputationFindingsDto"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"BounceControllerApi.get_tenant_reputation_findings",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: BounceControllerApi#get_tenant_reputation_findings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return TenantReputationFindingsDto.from_json(data), status_code, headers
    end
    ...
    def get_tenant_reputation_status_summary(account_region : String?)
      data, _status_code, _headers = get_tenant_reputation_status_summary_with_http_info(account_region)
      data
    end
    ...
    def get_tenant_reputation_status_summary_with_http_info(account_region : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: BounceControllerApi.get_tenant_reputation_status_summary ..."}
      end
      allowable_values = ["US_WEST_2_ACCOUNT_STAGING", "US_EAST_1_ACCOUNT_STAGING", "EU_WEST_1_ACCOUNT_STAGING", "US_WEST_2_ACCOUNT_SES_1", "EU_WEST_1_ACCOUNT_SES_1", "US_WEST_2_ACCOUNT_SES_2", "EU_WEST_1_ACCOUNT_SES_2", "US_WEST_2_ACCOUNT_BYTEWISE", "EU_WEST_1_ACCOUNT_BYTEWISE", "US_WEST_2", "EU_WEST_1", "US_EAST_1"]
      if @api_client.config.client_side_validation && account_region && !allowable_values.includes?(account_region)
        raise ArgumentError.new("invalid value for \"account_region\", must be one of #{allowable_values}")
      ...
      # return_type
      return_type = "TenantReputationStatusSummaryDto"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"BounceControllerApi.get_tenant_reputation_status_summary",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: BounceControllerApi#get_tenant_reputation_status_summary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return TenantReputationStatusSummaryDto.from_json(data), status_code, headers
    end
  end
end
