...
module 
  class PhoneControllerApi
    ...
    def acquire_phone_pool_lease(pool_id : String, acquire_phone_pool_lease_options : AcquirePhonePoolLeaseOptions)
      data, _status_code, _headers = acquire_phone_pool_lease_with_http_info(pool_id, acquire_phone_pool_lease_options)
      data
    end
    ...
    def acquire_phone_pool_lease_with_http_info(pool_id : String, acquire_phone_pool_lease_options : AcquirePhonePoolLeaseOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.acquire_phone_pool_lease ..."}
      end
      # verify the required parameter "pool_id" is set
      if @api_client.config.client_side_validation && pool_id.nil?
        raise ArgumentError.new("Missing the required parameter 'pool_id' when calling PhoneControllerApi.acquire_phone_pool_lease")
      end
      ...
      if @api_client.config.client_side_validation && acquire_phone_pool_lease_options.nil?
        raise ArgumentError.new("Missing the required parameter 'acquire_phone_pool_lease_options' when calling PhoneControllerApi.acquire_phone_pool_lease")
      end
      # resource path
      local_var_path = "/phone/pools/{poolId}/leases".sub("{" + "poolId" + "}", URI.encode(pool_id.to_s))
      ...
      # http body (model)
      post_body = acquire_phone_pool_lease_options.to_json

      # return_type
      return_type = "PhonePoolLeaseDto"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"PhoneControllerApi.acquire_phone_pool_lease",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#acquire_phone_pool_lease\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhonePoolLeaseDto.from_json(data), status_code, headers
    end
    ...
    def add_all_phone_numbers_to_phone_pool(pool_id : String)
      data, _status_code, _headers = add_all_phone_numbers_to_phone_pool_with_http_info(pool_id)
      data
    end
    ...
    def add_all_phone_numbers_to_phone_pool_with_http_info(pool_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.add_all_phone_numbers_to_phone_pool ..."}
      end
      # verify the required parameter "pool_id" is set
      if @api_client.config.client_side_validation && pool_id.nil?
        raise ArgumentError.new("Missing the required parameter 'pool_id' when calling PhoneControllerApi.add_all_phone_numbers_to_phone_pool")
      end
      # resource path
      local_var_path = "/phone/pools/{poolId}/numbers/add-all".sub("{" + "poolId" + "}", URI.encode(pool_id.to_s))
      ...
      # return_type
      return_type = "PhonePoolDetailDto"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"PhoneControllerApi.add_all_phone_numbers_to_phone_pool",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#add_all_phone_numbers_to_phone_pool\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhonePoolDetailDto.from_json(data), status_code, headers
    end
    ...
    def add_phone_number_tags(phone_number_id : String, phone_number_tags_options : PhoneNumberTagsOptions)
      data, _status_code, _headers = add_phone_number_tags_with_http_info(phone_number_id, phone_number_tags_options)
      data
    end
    ...
    def add_phone_number_tags_with_http_info(phone_number_id : String, phone_number_tags_options : PhoneNumberTagsOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.add_phone_number_tags ..."}
      end
      # verify the required parameter "phone_number_id" is set
      if @api_client.config.client_side_validation && phone_number_id.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_number_id' when calling PhoneControllerApi.add_phone_number_tags")
      end
      ...
      if @api_client.config.client_side_validation && phone_number_tags_options.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_number_tags_options' when calling PhoneControllerApi.add_phone_number_tags")
      end
      # resource path
      local_var_path = "/phone/numbers/{phoneNumberId}/tags".sub("{" + "phoneNumberId" + "}", URI.encode(phone_number_id.to_s))
      ...
      # http body (model)
      post_body = phone_number_tags_options.to_json
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"PhoneControllerApi.add_phone_number_tags",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#add_phone_number_tags\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    # @return [PhonePoolDetailDto]
    def add_phone_numbers_to_phone_pool(pool_id : String, add_phone_pool_numbers_options : AddPhonePoolNumbersOptions)
      data, _status_code, _headers = add_phone_numbers_to_phone_pool_with_http_info(pool_id, add_phone_pool_numbers_options)
      data
    end
    ...
    # @param add_phone_pool_numbers_options [AddPhonePoolNumbersOptions] 
    # @return [Array<(PhonePoolDetailDto, Integer, Hash)>] PhonePoolDetailDto data, response status code and response headers
    def add_phone_numbers_to_phone_pool_with_http_info(pool_id : String, add_phone_pool_numbers_options : AddPhonePoolNumbersOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.add_phone_numbers_to_phone_pool ..."}
      end
      # verify the required parameter "pool_id" is set
      if @api_client.config.client_side_validation && pool_id.nil?
        raise ArgumentError.new("Missing the required parameter 'pool_id' when calling PhoneControllerApi.add_phone_numbers_to_phone_pool")
      end
      ...
      if @api_client.config.client_side_validation && add_phone_pool_numbers_options.nil?
        raise ArgumentError.new("Missing the required parameter 'add_phone_pool_numbers_options' when calling PhoneControllerApi.add_phone_numbers_to_phone_pool")
      end
      # resource path
      local_var_path = "/phone/pools/{poolId}/numbers".sub("{" + "poolId" + "}", URI.encode(pool_id.to_s))
      ...
      # http body (model)
      post_body = add_phone_pool_numbers_options.to_json
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"PhoneControllerApi.add_phone_numbers_to_phone_pool",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#add_phone_numbers_to_phone_pool\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhonePoolDetailDto.from_json(data), status_code, headers
    end
    ...
    # @return [PhonePoolDetailDto]
    def create_phone_pool(create_phone_pool_options : CreatePhonePoolOptions)
      data, _status_code, _headers = create_phone_pool_with_http_info(create_phone_pool_options)
      data
    end
    ...
    # @param create_phone_pool_options [CreatePhonePoolOptions] 
    # @return [Array<(PhonePoolDetailDto, Integer, Hash)>] PhonePoolDetailDto data, response status code and response headers
    def create_phone_pool_with_http_info(create_phone_pool_options : CreatePhonePoolOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.create_phone_pool ..."}
      end
      ...
      if @api_client.config.client_side_validation && create_phone_pool_options.nil?
        raise ArgumentError.new("Missing the required parameter 'create_phone_pool_options' when calling PhoneControllerApi.create_phone_pool")
      end
      # resource path
      ...
      # http body (model)
      post_body = create_phone_pool_options.to_json
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"PhoneControllerApi.create_phone_pool",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#create_phone_pool\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhonePoolDetailDto.from_json(data), status_code, headers
    end
    ...
    def create_phone_provisioning_job(create_phone_provisioning_job_options : CreatePhoneProvisioningJobOptions)
      data, _status_code, _headers = create_phone_provisioning_job_with_http_info(create_phone_provisioning_job_options)
      data
    end
    ...
    def create_phone_provisioning_job_with_http_info(create_phone_provisioning_job_options : CreatePhoneProvisioningJobOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.create_phone_provisioning_job ..."}
      end
      ...
      if @api_client.config.client_side_validation && create_phone_provisioning_job_options.nil?
        raise ArgumentError.new("Missing the required parameter 'create_phone_provisioning_job_options' when calling PhoneControllerApi.create_phone_provisioning_job")
      end
      # resource path
      ...
      # http body (model)
      post_body = create_phone_provisioning_job_options.to_json

      # return_type
      return_type = "PhoneProvisioningJobDto"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"PhoneControllerApi.create_phone_provisioning_job",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#create_phone_provisioning_job\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneProvisioningJobDto.from_json(data), status_code, headers
    end

    # Delete all phone numbers
    # Remove all phone number from account
    # @return [nil]
    def delete_all_phone_number()
      delete_all_phone_number_with_http_info()
      nil
    end
    ...
    def delete_all_phone_number_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.delete_all_phone_number ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE,
                                                        local_var_path,
                                                        :"PhoneControllerApi.delete_all_phone_number",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#delete_all_phone_number\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    # @return [EmptyResponseDto]
    def delete_phone_message_thread_items(phone_number_id : String, other_number : String)
      data, _status_code, _headers = delete_phone_message_thread_items_with_http_info(phone_number_id, other_number)
      data
    end
    ...
    # @param other_number [String] 
    # @return [Array<(EmptyResponseDto, Integer, Hash)>] EmptyResponseDto data, response status code and response headers
    def delete_phone_message_thread_items_with_http_info(phone_number_id : String, other_number : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.delete_phone_message_thread_items ..."}
      end
      # verify the required parameter "phone_number_id" is set
      if @api_client.config.client_side_validation && phone_number_id.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_number_id' when calling PhoneControllerApi.delete_phone_message_thread_items")
      end
      # verify the required parameter "other_number" is set
      if @api_client.config.client_side_validation && other_number.nil?
        raise ArgumentError.new("Missing the required parameter 'other_number' when calling PhoneControllerApi.delete_phone_message_thread_items")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE,
                                                        local_var_path,
                                                        :"PhoneControllerApi.delete_phone_message_thread_items",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#delete_phone_message_thread_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyResponseDto.from_json(data), status_code, headers
    end
    ...
    # @param pool_id [String] 
    # @return [nil]
    def delete_phone_pool(pool_id : String)
      delete_phone_pool_with_http_info(pool_id)
      nil
    end
    ...
    # @param pool_id [String] 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_phone_pool_with_http_info(pool_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.delete_phone_pool ..."}
      end
      # verify the required parameter "pool_id" is set
      if @api_client.config.client_side_validation && pool_id.nil?
        raise ArgumentError.new("Missing the required parameter 'pool_id' when calling PhoneControllerApi.delete_phone_pool")
      end
      # resource path
      local_var_path = "/phone/pools/{poolId}".sub("{" + "poolId" + "}", URI.encode(pool_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:DELETE,
                                                        local_var_path,
                                                        :"PhoneControllerApi.delete_phone_pool",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#delete_phone_pool\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
    ...
    def get_all_phone_number_releases(page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_phone_number_releases_with_http_info(page, size, sort)
      data
    end
    ...
    def get_all_phone_number_releases_with_http_info(page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_all_phone_number_releases ..."}
      end
      ...
      # return_type
      return_type = "PagePhoneNumberReleaseProjection"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_all_phone_number_releases",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_all_phone_number_releases\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PagePhoneNumberReleaseProjection.from_json(data), status_code, headers
    end
    ...
    # @return [PhonePoolDetailDto]
    def get_or_create_phone_pool(get_or_create_phone_pool_options : GetOrCreatePhonePoolOptions)
      data, _status_code, _headers = get_or_create_phone_pool_with_http_info(get_or_create_phone_pool_options)
      data
    end
    ...
    # @param get_or_create_phone_pool_options [GetOrCreatePhonePoolOptions] 
    # @return [Array<(PhonePoolDetailDto, Integer, Hash)>] PhonePoolDetailDto data, response status code and response headers
    def get_or_create_phone_pool_with_http_info(get_or_create_phone_pool_options : GetOrCreatePhonePoolOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_or_create_phone_pool ..."}
      end
      ...
      if @api_client.config.client_side_validation && get_or_create_phone_pool_options.nil?
        raise ArgumentError.new("Missing the required parameter 'get_or_create_phone_pool_options' when calling PhoneControllerApi.get_or_create_phone_pool")
      end
      # resource path
      ...
      # http body (model)
      post_body = get_or_create_phone_pool_options.to_json
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_or_create_phone_pool",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_or_create_phone_pool\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhonePoolDetailDto.from_json(data), status_code, headers
    end
    ...
    # @param name [String] 
    # @return [PhoneNumberDto]
    def get_phone_number_by_name(name : String)
      data, _status_code, _headers = get_phone_number_by_name_with_http_info(name)
      data
    end
    ...
    # @param name [String] 
    # @return [Array<(PhoneNumberDto, Integer, Hash)>] PhoneNumberDto data, response status code and response headers
    def get_phone_number_by_name_with_http_info(name : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_number_by_name ..."}
      end
      # verify the required parameter "name" is set
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError.new("Missing the required parameter 'name' when calling PhoneControllerApi.get_phone_number_by_name")
      end
      # resource path
    ...
    # @return [PhoneNumberDto]
    def get_phone_number_by_phone_number(phone_number : String)
      data, _status_code, _headers = get_phone_number_by_phone_number_with_http_info(phone_number)
      data
    end
    ...
    # @param phone_number [String] 
    # @return [Array<(PhoneNumberDto, Integer, Hash)>] PhoneNumberDto data, response status code and response headers
    def get_phone_number_by_phone_number_with_http_info(phone_number : String)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && phone_number.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_number' when calling PhoneControllerApi.get_phone_number_by_phone_number")
      end
      # resource path
    ...
    def get_phone_number_line_type_intelligence(validate_phone_number_options : ValidatePhoneNumberOptions)
      data, _status_code, _headers = get_phone_number_line_type_intelligence_with_http_info(validate_phone_number_options)
      data
    end
    ...
    def get_phone_number_line_type_intelligence_with_http_info(validate_phone_number_options : ValidatePhoneNumberOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_number_line_type_intelligence ..."}
      end
      ...
      if @api_client.config.client_side_validation && validate_phone_number_options.nil?
        raise ArgumentError.new("Missing the required parameter 'validate_phone_number_options' when calling PhoneControllerApi.get_phone_number_line_type_intelligence")
      end
      # resource path
      ...
      # return_type
      return_type = "PhoneNumberLineTypeLookupDto"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_number_line_type_intelligence",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_number_line_type_intelligence\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneNumberLineTypeLookupDto.from_json(data), status_code, headers
    end
    ...
    def get_phone_number_release(release_id : String)
      data, _status_code, _headers = get_phone_number_release_with_http_info(release_id)
      data
    end
    ...
    def get_phone_number_release_with_http_info(release_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_number_release ..."}
      end
      # verify the required parameter "release_id" is set
      if @api_client.config.client_side_validation && release_id.nil?
        raise ArgumentError.new("Missing the required parameter 'release_id' when calling PhoneControllerApi.get_phone_number_release")
      end
      # resource path
      local_var_path = "/phone/releases/{releaseId}".sub("{" + "releaseId" + "}", URI.encode(release_id.to_s))
      ...
      # return_type
      return_type = "PhoneNumberReleaseProjection"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_number_release",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_number_release\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneNumberReleaseProjection.from_json(data), status_code, headers
    end
    ...
    # @param phone_number_id [String] 
    # @return [Array(String)]
    def get_phone_number_tags(phone_number_id : String)
      data, _status_code, _headers = get_phone_number_tags_with_http_info(phone_number_id)
      data
    end
    ...
    def get_phone_number_tags_with_http_info(phone_number_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_number_tags ..."}
      end
      # verify the required parameter "phone_number_id" is set
      if @api_client.config.client_side_validation && phone_number_id.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_number_id' when calling PhoneControllerApi.get_phone_number_tags")
      end
      # resource path
      local_var_path = "/phone/numbers/{phoneNumberId}/tags".sub("{" + "phoneNumberId" + "}", URI.encode(phone_number_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_number_tags",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_number_tags\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_phone_numbers(phone_country : String?, line_type : String?, carrier_name : String?, mobile_country_code : String?, mobile_network_code : String?, provider_label : String?, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, search : String?, tag : Array(String)?, _include : Array(String)?, favourite : Bool?)
      data, _status_code, _headers = get_phone_numbers_with_http_info(phone_country, line_type, carrier_name, mobile_country_code, mobile_network_code, provider_label, page, size, sort, since, before, search, tag, _include, favourite)
      data
    end
    ...
    def get_phone_numbers_with_http_info(phone_country : String?, line_type : String?, carrier_name : String?, mobile_country_code : String?, mobile_network_code : String?, provider_label : String?, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, search : String?, tag : Array(String)?, _include : Array(String)?, favourite : Bool?)
      if @api_client.config.debugging
      ...
      query_params[:"lineType"] = line_type
      query_params[:"carrierName"] = carrier_name
      query_params[:"mobileCountryCode"] = mobile_country_code
      query_params[:"mobileNetworkCode"] = mobile_network_code
      query_params[:"providerLabel"] = provider_label
      query_params[:"page"] = page
      query_params[:"size"] = size
      query_params[:"sort"] = sort
    ...
    # @param pool_id [String] 
    # @return [PhonePoolDetailDto]
    def get_phone_pool(pool_id : String)
      data, _status_code, _headers = get_phone_pool_with_http_info(pool_id)
      data
    end
    ...
    # @param pool_id [String] 
    # @return [Array<(PhonePoolDetailDto, Integer, Hash)>] PhonePoolDetailDto data, response status code and response headers
    def get_phone_pool_with_http_info(pool_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_pool ..."}
      end
      # verify the required parameter "pool_id" is set
      if @api_client.config.client_side_validation && pool_id.nil?
        raise ArgumentError.new("Missing the required parameter 'pool_id' when calling PhoneControllerApi.get_phone_pool")
      end
      # resource path
      local_var_path = "/phone/pools/{poolId}".sub("{" + "poolId" + "}", URI.encode(pool_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_pool",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_pool\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhonePoolDetailDto.from_json(data), status_code, headers
    end
    ...
    # @param name [String] 
    # @return [PhonePoolDetailDto]
    def get_phone_pool_by_name(name : String)
      data, _status_code, _headers = get_phone_pool_by_name_with_http_info(name)
      data
    end
    ...
    # @param name [String] 
    # @return [Array<(PhonePoolDetailDto, Integer, Hash)>] PhonePoolDetailDto data, response status code and response headers
    def get_phone_pool_by_name_with_http_info(name : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_pool_by_name ..."}
      end
      # verify the required parameter "name" is set
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError.new("Missing the required parameter 'name' when calling PhoneControllerApi.get_phone_pool_by_name")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_pool_by_name",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_pool_by_name\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhonePoolDetailDto.from_json(data), status_code, headers
    end
    ...
    def get_phone_pools()
      data, _status_code, _headers = get_phone_pools_with_http_info()
      data
    end
    ...
    def get_phone_pools_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_pools ..."}
      end
      # resource path
      local_var_path = "/phone/pools"
      ...
      # return_type
      return_type = "Array(PhonePoolDto)"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_pools",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_pools\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return Array(PhonePoolDto).from_json(data), status_code, headers
    end
    ...
    def get_phone_provisioning_capabilities(phone_country : String, provider_label : String?)
      data, _status_code, _headers = get_phone_provisioning_capabilities_with_http_info(phone_country, provider_label)
      data
    end
    ...
    def get_phone_provisioning_capabilities_with_http_info(phone_country : String, provider_label : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_provisioning_capabilities ..."}
      end
      # verify the required parameter "phone_country" is set
      if @api_client.config.client_side_validation && phone_country.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_country' when calling PhoneControllerApi.get_phone_provisioning_capabilities")
      end
      # verify enum value
      allowable_values = ["US", "GB", "AU", "CA", "EE", "HK", "PL", "PT", "NL", "IL", "FI", "SE"]
      if @api_client.config.client_side_validation && !allowable_values.includes?(phone_country)
        raise ArgumentError.new("invalid value for \"phone_country\", must be one of #{allowable_values}")
      end
      # resource path
      ...
      # return_type
      return_type = "PhoneProviderCapabilitiesResult"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_provisioning_capabilities",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_provisioning_capabilities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneProviderCapabilitiesResult.from_json(data), status_code, headers
    end
    ...
    # @param job_id [String] 
    # @return [PhoneProvisioningJobDto]
    def get_phone_provisioning_job(job_id : String)
      data, _status_code, _headers = get_phone_provisioning_job_with_http_info(job_id)
      data
    end
    ...
    # @param job_id [String] 
    # @return [Array<(PhoneProvisioningJobDto, Integer, Hash)>] PhoneProvisioningJobDto data, response status code and response headers
    def get_phone_provisioning_job_with_http_info(job_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_provisioning_job ..."}
      end
      # verify the required parameter "job_id" is set
      if @api_client.config.client_side_validation && job_id.nil?
        raise ArgumentError.new("Missing the required parameter 'job_id' when calling PhoneControllerApi.get_phone_provisioning_job")
      end
      # resource path
      local_var_path = "/phone/provisioning/jobs/{jobId}".sub("{" + "jobId" + "}", URI.encode(job_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_provisioning_job",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_provisioning_job\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneProvisioningJobDto.from_json(data), status_code, headers
    end
    ...
    def get_phone_sms_prepaid_credit(credit_id : String)
      data, _status_code, _headers = get_phone_sms_prepaid_credit_with_http_info(credit_id)
      data
    end
    ...
    def get_phone_sms_prepaid_credit_with_http_info(credit_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_sms_prepaid_credit ..."}
      end
      # verify the required parameter "credit_id" is set
      if @api_client.config.client_side_validation && credit_id.nil?
        raise ArgumentError.new("Missing the required parameter 'credit_id' when calling PhoneControllerApi.get_phone_sms_prepaid_credit")
      end
      # resource path
      local_var_path = "/phone/sms-prepaid-credits/{creditId}".sub("{" + "creditId" + "}", URI.encode(credit_id.to_s))
      ...
      # return_type
      return_type = "PhoneSmsPrepaidCreditDto"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_sms_prepaid_credit",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_sms_prepaid_credit\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneSmsPrepaidCreditDto.from_json(data), status_code, headers
    end

    # Get SMS prepaid credits
    # List SMS prepaid credits for the authenticated account
    # @return [PhoneSmsPrepaidCreditsDto]
    def get_phone_sms_prepaid_credits()
      data, _status_code, _headers = get_phone_sms_prepaid_credits_with_http_info()
      data
    end
    ...
    def get_phone_sms_prepaid_credits_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_sms_prepaid_credits ..."}
      end
      # resource path
      ...
      # return_type
      return_type = "PhoneSmsPrepaidCreditsDto"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_sms_prepaid_credits",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_sms_prepaid_credits\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneSmsPrepaidCreditsDto.from_json(data), status_code, headers
    end
    ...
    def get_phone_summary()
      data, _status_code, _headers = get_phone_summary_with_http_info()
      data
    end
    ...
    def get_phone_summary_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_summary ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_summary",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_summary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneSummaryDto.from_json(data), status_code, headers
    end

    # Get phone tags
    # List all unique tags used by your phone numbers
    # @return [Array(String)]
    def get_phone_tags(search : String?)
      data, _status_code, _headers = get_phone_tags_with_http_info(search)
      data
    end
    ...
    # List all unique tags used by your phone numbers
    # @return [Array<(Array(String), Integer, Hash)>] Array(String) data, response status code and response headers
    def get_phone_tags_with_http_info(search : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.get_phone_tags ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.get_phone_tags",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#get_phone_tags\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return Array(String).from_json(data), status_code, headers
    end
    ...
    # @param release_id [String] 
    # @return [PhoneNumberDto]
    def reassign_phone_number_release(release_id : String)
      data, _status_code, _headers = reassign_phone_number_release_with_http_info(release_id)
      data
    end
    ...
    # @param release_id [String] 
    # @return [Array<(PhoneNumberDto, Integer, Hash)>] PhoneNumberDto data, response status code and response headers
    def reassign_phone_number_release_with_http_info(release_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.reassign_phone_number_release ..."}
      end
      # verify the required parameter "release_id" is set
      if @api_client.config.client_side_validation && release_id.nil?
        raise ArgumentError.new("Missing the required parameter 'release_id' when calling PhoneControllerApi.reassign_phone_number_release")
      end
      # resource path
      local_var_path = "/phone/releases/{releaseId}/reassign".sub("{" + "releaseId" + "}", URI.encode(release_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"PhoneControllerApi.reassign_phone_number_release",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#reassign_phone_number_release\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneNumberDto.from_json(data), status_code, headers
    end
    ...
    # @return [nil]
    def release_phone_pool_lease(pool_id : String, lease_id : String)
      release_phone_pool_lease_with_http_info(pool_id, lease_id)
      nil
    end
    ...
    # @param lease_id [String] 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def release_phone_pool_lease_with_http_info(pool_id : String, lease_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.release_phone_pool_lease ..."}
      end
      # verify the required parameter "pool_id" is set
      if @api_client.config.client_side_validation && pool_id.nil?
        raise ArgumentError.new("Missing the required parameter 'pool_id' when calling PhoneControllerApi.release_phone_pool_lease")
      end
      # verify the required parameter "lease_id" is set
      if @api_client.config.client_side_validation && lease_id.nil?
        raise ArgumentError.new("Missing the required parameter 'lease_id' when calling PhoneControllerApi.release_phone_pool_lease")
      end
      # resource path
      local_var_path = "/phone/pools/{poolId}/leases/{leaseId}".sub("{" + "poolId" + "}", URI.encode(pool_id.to_s)).sub("{" + "leaseId" + "}", URI.encode(lease_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:DELETE,
                                                        local_var_path,
                                                        :"PhoneControllerApi.release_phone_pool_lease",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#release_phone_pool_lease\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
    ...
    # @param phone_number_id [String] 
    # @return [nil]
    def remove_phone_number_from_phone_pool(pool_id : String, phone_number_id : String)
      remove_phone_number_from_phone_pool_with_http_info(pool_id, phone_number_id)
      nil
    end
    ...
    # @param phone_number_id [String] 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def remove_phone_number_from_phone_pool_with_http_info(pool_id : String, phone_number_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.remove_phone_number_from_phone_pool ..."}
      end
      # verify the required parameter "pool_id" is set
      if @api_client.config.client_side_validation && pool_id.nil?
        raise ArgumentError.new("Missing the required parameter 'pool_id' when calling PhoneControllerApi.remove_phone_number_from_phone_pool")
      end
      # verify the required parameter "phone_number_id" is set
      if @api_client.config.client_side_validation && phone_number_id.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_number_id' when calling PhoneControllerApi.remove_phone_number_from_phone_pool")
      end
      # resource path
      local_var_path = "/phone/pools/{poolId}/numbers/{phoneNumberId}".sub("{" + "poolId" + "}", URI.encode(pool_id.to_s)).sub("{" + "phoneNumberId" + "}", URI.encode(phone_number_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:DELETE,
                                                        local_var_path,
                                                        :"PhoneControllerApi.remove_phone_number_from_phone_pool",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#remove_phone_number_from_phone_pool\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
    ...
    # @param phone_number_tags_options [PhoneNumberTagsOptions] 
    # @return [PhoneNumberDto]
    def remove_phone_number_tags(phone_number_id : String, phone_number_tags_options : PhoneNumberTagsOptions)
      data, _status_code, _headers = remove_phone_number_tags_with_http_info(phone_number_id, phone_number_tags_options)
      data
    end
    ...
    # @param phone_number_tags_options [PhoneNumberTagsOptions] 
    # @return [Array<(PhoneNumberDto, Integer, Hash)>] PhoneNumberDto data, response status code and response headers
    def remove_phone_number_tags_with_http_info(phone_number_id : String, phone_number_tags_options : PhoneNumberTagsOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.remove_phone_number_tags ..."}
      end
      # verify the required parameter "phone_number_id" is set
      if @api_client.config.client_side_validation && phone_number_id.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_number_id' when calling PhoneControllerApi.remove_phone_number_tags")
      end
      # verify the required parameter "phone_number_tags_options" is set
      if @api_client.config.client_side_validation && phone_number_tags_options.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_number_tags_options' when calling PhoneControllerApi.remove_phone_number_tags")
      end
      # resource path
      local_var_path = "/phone/numbers/{phoneNumberId}/tags".sub("{" + "phoneNumberId" + "}", URI.encode(phone_number_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:DELETE,
                                                        local_var_path,
                                                        :"PhoneControllerApi.remove_phone_number_tags",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#remove_phone_number_tags\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneNumberDto.from_json(data), status_code, headers
    end
    ...
    def search_available_phone_numbers(search_available_phone_numbers_options : SearchAvailablePhoneNumbersOptions)
      data, _status_code, _headers = search_available_phone_numbers_with_http_info(search_available_phone_numbers_options)
      data
    end
    ...
    def search_available_phone_numbers_with_http_info(search_available_phone_numbers_options : SearchAvailablePhoneNumbersOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.search_available_phone_numbers ..."}
      end
      ...
      if @api_client.config.client_side_validation && search_available_phone_numbers_options.nil?
        raise ArgumentError.new("Missing the required parameter 'search_available_phone_numbers_options' when calling PhoneControllerApi.search_available_phone_numbers")
      end
      # resource path
      ...
      # http body (model)
      post_body = search_available_phone_numbers_options.to_json

      # return_type
      return_type = "AvailablePhoneNumbersResult"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"PhoneControllerApi.search_available_phone_numbers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#search_available_phone_numbers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return AvailablePhoneNumbersResult.from_json(data), status_code, headers
    end
    ...
    # @param phone_number_tags_options [PhoneNumberTagsOptions] 
    # @return [PhoneNumberDto]
    def set_phone_number_tags(phone_number_id : String, phone_number_tags_options : PhoneNumberTagsOptions)
      data, _status_code, _headers = set_phone_number_tags_with_http_info(phone_number_id, phone_number_tags_options)
      data
    end
    ...
    # @param phone_number_tags_options [PhoneNumberTagsOptions] 
    # @return [Array<(PhoneNumberDto, Integer, Hash)>] PhoneNumberDto data, response status code and response headers
    def set_phone_number_tags_with_http_info(phone_number_id : String, phone_number_tags_options : PhoneNumberTagsOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.set_phone_number_tags ..."}
      end
      # verify the required parameter "phone_number_id" is set
      if @api_client.config.client_side_validation && phone_number_id.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_number_id' when calling PhoneControllerApi.set_phone_number_tags")
      end
      # verify the required parameter "phone_number_tags_options" is set
      if @api_client.config.client_side_validation && phone_number_tags_options.nil?
        raise ArgumentError.new("Missing the required parameter 'phone_number_tags_options' when calling PhoneControllerApi.set_phone_number_tags")
      end
      # resource path
      local_var_path = "/phone/numbers/{phoneNumberId}/tags".sub("{" + "phoneNumberId" + "}", URI.encode(phone_number_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        local_var_path,
                                                        :"PhoneControllerApi.set_phone_number_tags",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#set_phone_number_tags\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhoneNumberDto.from_json(data), status_code, headers
    end
    ...
    # @return [PhonePoolDetailDto]
    def update_phone_pool(pool_id : String, update_phone_pool_options : UpdatePhonePoolOptions)
      data, _status_code, _headers = update_phone_pool_with_http_info(pool_id, update_phone_pool_options)
      data
    end
    ...
    # @param update_phone_pool_options [UpdatePhonePoolOptions] 
    # @return [Array<(PhonePoolDetailDto, Integer, Hash)>] PhonePoolDetailDto data, response status code and response headers
    def update_phone_pool_with_http_info(pool_id : String, update_phone_pool_options : UpdatePhonePoolOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: PhoneControllerApi.update_phone_pool ..."}
      end
      # verify the required parameter "pool_id" is set
      if @api_client.config.client_side_validation && pool_id.nil?
        raise ArgumentError.new("Missing the required parameter 'pool_id' when calling PhoneControllerApi.update_phone_pool")
      end
      ...
      if @api_client.config.client_side_validation && update_phone_pool_options.nil?
        raise ArgumentError.new("Missing the required parameter 'update_phone_pool_options' when calling PhoneControllerApi.update_phone_pool")
      end
      # resource path
      local_var_path = "/phone/pools/{poolId}".sub("{" + "poolId" + "}", URI.encode(pool_id.to_s))
      ...
      # http body (model)
      post_body = update_phone_pool_options.to_json
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        local_var_path,
                                                        :"PhoneControllerApi.update_phone_pool",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: PhoneControllerApi#update_phone_pool\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return PhonePoolDetailDto.from_json(data), status_code, headers
    end
