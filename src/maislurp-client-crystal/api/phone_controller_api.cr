...
module 
  class PhoneControllerApi
    ...
    # @return [nil]
    def test_phone_number_send_sms(phone_number_id : String, test_phone_number_options : TestPhoneNumberOptions)
      test_phone_number_send_sms_with_http_info(phone_number_id, test_phone_number_options)
      nil
    end
    ...
    # @param test_phone_number_options [TestPhoneNumberOptions] 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def test_phone_number_send_sms_with_http_info(phone_number_id : String, test_phone_number_options : TestPhoneNumberOptions)
      if @api_client.config.debugging
