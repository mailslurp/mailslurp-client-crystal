...
module 
  class PhoneControllerApi
    ...
    def get_phone_numbers(phone_country : String?, line_type : String?, carrier_name : String?, mobile_country_code : String?, mobile_network_code : String?, provider_label : String?, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, search : String?, _include : Array(String)?, favourite : Bool?)
      data, _status_code, _headers = get_phone_numbers_with_http_info(phone_country, line_type, carrier_name, mobile_country_code, mobile_network_code, provider_label, page, size, sort, since, before, search, _include, favourite)
      data
    end
    ...
    def get_phone_numbers_with_http_info(phone_country : String?, line_type : String?, carrier_name : String?, mobile_country_code : String?, mobile_network_code : String?, provider_label : String?, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?, search : String?, _include : Array(String)?, favourite : Bool?)
      if @api_client.config.debugging
