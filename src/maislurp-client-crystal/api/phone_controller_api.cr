...
module 
  class PhoneControllerApi
    ...
    def get_phone_numbers(phone_country : String?, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      data, _status_code, _headers = get_phone_numbers_with_http_info(phone_country, page, size, sort, since, before)
      data
    end
    ...
    def get_phone_numbers_with_http_info(phone_country : String?, page : Int32?, size : Int32?, sort : String?, since : Time?, before : Time?)
      if @api_client.config.debugging
