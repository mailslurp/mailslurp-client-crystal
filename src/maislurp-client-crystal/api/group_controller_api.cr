...
module 
  class GroupControllerApi
    ...
    def get_all_groups(before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_groups_with_http_info(before, page, since, size, sort)
      data
    end

    # Get all Contact Groups in paginated format
    # @return [Array<(PageGroupProjection, Integer, Hash)>] PageGroupProjection data, response status code and response headers
    def get_all_groups_with_http_info(before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    def get_group_with_contacts_paginated(group_id : String, before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_group_with_contacts_paginated_with_http_info(group_id, before, page, since, size, sort)
      data
    end
    ...
    def get_group_with_contacts_paginated_with_http_info(group_id : String, before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
