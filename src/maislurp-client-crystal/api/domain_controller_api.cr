...
module 
  class DomainControllerApi
    ...
    def get_available_domain_regions(inbox_type : String?)
      data, _status_code, _headers = get_available_domain_regions_with_http_info(inbox_type)
      data
    end
    ...
    def get_available_domain_regions_with_http_info(inbox_type : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: DomainControllerApi.get_available_domain_regions ..."}
      end
      ...
      # return_type
      return_type = "DomainRegionGroupsDto"
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"DomainControllerApi.get_available_domain_regions",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: DomainControllerApi#get_available_domain_regions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return DomainRegionGroupsDto.from_json(data), status_code, headers
    end
