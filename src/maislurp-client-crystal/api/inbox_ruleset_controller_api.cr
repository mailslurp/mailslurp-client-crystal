...
module 
  class InboxRulesetControllerApi
    ...
    def get_inbox_rulesets(inbox_id : String?, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_inbox_rulesets_with_http_info(inbox_id, page, search_filter, size, sort)
      data
    end
    ...
    def get_inbox_rulesets_with_http_info(inbox_id : String?, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      if @api_client.config.debugging
