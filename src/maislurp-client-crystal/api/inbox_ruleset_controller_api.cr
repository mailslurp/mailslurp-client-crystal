...
module 
  class InboxRulesetControllerApi
    ...
    def test_inbox_ruleset_receiving(test_inbox_ruleset_receiving_options : TestInboxRulesetReceivingOptions)
      data, _status_code, _headers = test_inbox_ruleset_receiving_with_http_info(test_inbox_ruleset_receiving_options)
      data
    end
    ...
    def test_inbox_ruleset_receiving_with_http_info(test_inbox_ruleset_receiving_options : TestInboxRulesetReceivingOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxRulesetControllerApi.test_inbox_ruleset_receiving ..."}
      end
      ...
      if @api_client.config.client_side_validation && test_inbox_ruleset_receiving_options.nil?
        raise ArgumentError.new("Missing the required parameter 'test_inbox_ruleset_receiving_options' when calling InboxRulesetControllerApi.test_inbox_ruleset_receiving")
      end
      # resource path
      ...
      # http body (model)
      post_body = test_inbox_ruleset_receiving_options.to_json

      # return_type
      return_type = "TestInboxRulesetReceivingResult"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"InboxRulesetControllerApi.test_inbox_ruleset_receiving",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxRulesetControllerApi#test_inbox_ruleset_receiving\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return TestInboxRulesetReceivingResult.from_json(data), status_code, headers
    end
    ...
    def test_inbox_ruleset_sending(test_inbox_ruleset_sending_options : TestInboxRulesetSendingOptions)
      data, _status_code, _headers = test_inbox_ruleset_sending_with_http_info(test_inbox_ruleset_sending_options)
      data
    end
    ...
    def test_inbox_ruleset_sending_with_http_info(test_inbox_ruleset_sending_options : TestInboxRulesetSendingOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxRulesetControllerApi.test_inbox_ruleset_sending ..."}
      end
      ...
      if @api_client.config.client_side_validation && test_inbox_ruleset_sending_options.nil?
        raise ArgumentError.new("Missing the required parameter 'test_inbox_ruleset_sending_options' when calling InboxRulesetControllerApi.test_inbox_ruleset_sending")
      end
      # resource path
      ...
      # return_type
      return_type = "TestInboxRulesetSendingResult"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"InboxRulesetControllerApi.test_inbox_ruleset_sending",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxRulesetControllerApi#test_inbox_ruleset_sending\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return TestInboxRulesetSendingResult.from_json(data), status_code, headers
    end
