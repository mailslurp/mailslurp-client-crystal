...
module 
  class AliasControllerApi
    ...
    def get_alias_emails(alias_id : String, before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_alias_emails_with_http_info(alias_id, before, page, since, size, sort)
      data
    end
    ...
    def get_alias_emails_with_http_info(alias_id : String, before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    def get_alias_threads(alias_id : String, before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_alias_threads_with_http_info(alias_id, before, page, since, size, sort)
      data
    end
    ...
    def get_alias_threads_with_http_info(alias_id : String, before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    # @return [PageAlias]
    def get_aliases(before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_aliases_with_http_info(before, page, since, size, sort)
      data
    end
    ...
    def get_aliases_with_http_info(before : Time?, page : Int32?, since : Time?, size : Int32?, sort : String?)
      if @api_client.config.debugging
