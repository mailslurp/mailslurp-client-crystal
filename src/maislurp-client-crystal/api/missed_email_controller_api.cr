...
module 
  class MissedEmailControllerApi
    ...
    def get_all_missed_emails(inbox_id : String?, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_missed_emails_with_http_info(inbox_id, page, search_filter, size, sort)
      data
    end
    ...
    def get_all_missed_emails_with_http_info(inbox_id : String?, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
    ...
    def get_all_unknown_missed_emails(inbox_id : String?, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_unknown_missed_emails_with_http_info(inbox_id, page, search_filter, size, sort)
      data
    end
    ...
    def get_all_unknown_missed_emails_with_http_info(inbox_id : String?, page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      if @api_client.config.debugging
    ...
    # @return [MissedEmail]
    def wait_for_nth_missed_email(inbox_id : String?, index : Int32?, timeout : Int64?)
      data, _status_code, _headers = wait_for_nth_missed_email_with_http_info(inbox_id, index, timeout)
      data
    end
    ...
    # Wait for 0 based index missed email
    # @return [Array<(MissedEmail, Integer, Hash)>] MissedEmail data, response status code and response headers
    def wait_for_nth_missed_email_with_http_info(inbox_id : String?, index : Int32?, timeout : Int64?)
      if @api_client.config.debugging
