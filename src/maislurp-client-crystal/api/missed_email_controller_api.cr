...
module 
  class MissedEmailControllerApi
    ...
    def get_all_missed_emails(page : Int32?, search_filter : String?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_missed_emails_with_http_info(page, search_filter, size, sort)
      data
    end
    ...
    def get_all_missed_emails_with_http_info(page : Int32?, search_filter : String?, size : Int32?, sort : String?)
