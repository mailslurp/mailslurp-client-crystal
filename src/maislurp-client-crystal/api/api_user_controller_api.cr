...
module 
  class ApiUserControllerApi
    ...
    def get_smtp_password()
      data, _status_code, _headers = get_smtp_password_with_http_info()
      data
    end

    # @return [Array<(String, Integer, Hash)>] String data, response status code and response headers
    def get_smtp_password_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: ApiUserControllerApi.get_smtp_password ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ApiUserControllerApi.get_smtp_password",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ApiUserControllerApi#get_smtp_password\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_smtp_username()
      data, _status_code, _headers = get_smtp_username_with_http_info()
      data
    end

    # @return [Array<(String, Integer, Hash)>] String data, response status code and response headers
    def get_smtp_username_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: ApiUserControllerApi.get_smtp_username ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ApiUserControllerApi.get_smtp_username",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ApiUserControllerApi#get_smtp_username\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return String.from_json(data), status_code, headers
    end
