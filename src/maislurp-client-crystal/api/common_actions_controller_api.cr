...
module 
  class CommonActionsControllerApi
    ...
    # @return [Inbox]
    def create_new_email_address(allow_team_access : Bool?, description : String?, email_address : String?, expires_at : Time?, expires_in : Int64?, favourite : Bool?, inbox_type : String?, name : String?, tags : Array(String)?, use_domain_pool : Bool?)
      data, _status_code, _headers = create_new_email_address_with_http_info(allow_team_access, description, email_address, expires_at, expires_in, favourite, inbox_type, name, tags, use_domain_pool)
      data
    end
    ...
    def create_new_email_address_with_http_info(allow_team_access : Bool?, description : String?, email_address : String?, expires_at : Time?, expires_in : Int64?, favourite : Bool?, inbox_type : String?, name : String?, tags : Array(String)?, use_domain_pool : Bool?)
    ...
    # Returns an Inbox with an `id` and an `emailAddress`
    # @return [Inbox]
    def create_new_email_address1(allow_team_access : Bool?, description : String?, email_address : String?, expires_at : Time?, expires_in : Int64?, favourite : Bool?, inbox_type : String?, name : String?, tags : Array(String)?, use_domain_pool : Bool?)
      data, _status_code, _headers = create_new_email_address1_with_http_info(allow_team_access, description, email_address, expires_at, expires_in, favourite, inbox_type, name, tags, use_domain_pool)
      data
    end
    ...
    # Returns an Inbox with an &#x60;id&#x60; and an &#x60;emailAddress&#x60;
    # @return [Array<(Inbox, Integer, Hash)>] Inbox data, response status code and response headers
    def create_new_email_address1_with_http_info(allow_team_access : Bool?, description : String?, email_address : String?, expires_at : Time?, expires_in : Int64?, favourite : Bool?, inbox_type : String?, name : String?, tags : Array(String)?, use_domain_pool : Bool?)
      if @api_client.config.debugging
