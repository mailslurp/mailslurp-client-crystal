...
module 
  class CommonActionsControllerApi
    ...
    # @return [InboxDto]
    def create_new_email_address(allow_team_access : Bool?, use_domain_pool : Bool?, expires_at : Time?, expires_in : Int64?, email_address : String?, inbox_type : String?, description : String?, name : String?, tags : Array(String)?, favourite : Bool?, virtual_inbox : Bool?, use_short_address : Bool?, domain_name : String?, domain_id : String?, prefix : String?)
      data, _status_code, _headers = create_new_email_address_with_http_info(allow_team_access, use_domain_pool, expires_at, expires_in, email_address, inbox_type, description, name, tags, favourite, virtual_inbox, use_short_address, domain_name, domain_id, prefix)
      data
    end
    ...
    def create_new_email_address_with_http_info(allow_team_access : Bool?, use_domain_pool : Bool?, expires_at : Time?, expires_in : Int64?, email_address : String?, inbox_type : String?, description : String?, name : String?, tags : Array(String)?, favourite : Bool?, virtual_inbox : Bool?, use_short_address : Bool?, domain_name : String?, domain_id : String?, prefix : String?)
    ...
    # Returns an Inbox with an `id` and an `emailAddress`
    # @return [InboxDto]
    def create_random_inbox(allow_team_access : Bool?, use_domain_pool : Bool?, expires_at : Time?, expires_in : Int64?, email_address : String?, inbox_type : String?, description : String?, name : String?, tags : Array(String)?, favourite : Bool?, virtual_inbox : Bool?, use_short_address : Bool?, domain_name : String?, domain_id : String?, prefix : String?)
      data, _status_code, _headers = create_random_inbox_with_http_info(allow_team_access, use_domain_pool, expires_at, expires_in, email_address, inbox_type, description, name, tags, favourite, virtual_inbox, use_short_address, domain_name, domain_id, prefix)
      data
    end
    ...
    # Returns an Inbox with an &#x60;id&#x60; and an &#x60;emailAddress&#x60;
    # @return [Array<(InboxDto, Integer, Hash)>] InboxDto data, response status code and response headers
    def create_random_inbox_with_http_info(allow_team_access : Bool?, use_domain_pool : Bool?, expires_at : Time?, expires_in : Int64?, email_address : String?, inbox_type : String?, description : String?, name : String?, tags : Array(String)?, favourite : Bool?, virtual_inbox : Bool?, use_short_address : Bool?, domain_name : String?, domain_id : String?, prefix : String?)
      if @api_client.config.debugging
    ...
    # @return [nil]
    def send_email_query(to : String, sender_id : String?, body : String?, subject : String?)
      send_email_query_with_http_info(to, sender_id, body, subject)
      nil
    end
    ...
    # @param to [String] Email address to send to
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def send_email_query_with_http_info(to : String, sender_id : String?, body : String?, subject : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: CommonActionsControllerApi.send_email_query ..."}
      end
      # verify the required parameter "to" is set
      if @api_client.config.client_side_validation && to.nil?
        raise ArgumentError.new("Missing the required parameter 'to' when calling CommonActionsControllerApi.send_email_query")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"CommonActionsControllerApi.send_email_query",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: CommonActionsControllerApi#send_email_query\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return nil, status_code, headers
    end
