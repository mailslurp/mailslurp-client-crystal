...
module 
  class CommonActionsControllerApi
    ...
    # @return [InboxDto]
    def create_new_email_address(allow_team_access : Bool?, use_domain_pool : Bool?, expires_at : Time?, expires_in : Int64?, email_address : String?, inbox_type : String?, description : String?, name : String?, tags : Array(String)?, favourite : Bool?)
    ...
    def create_new_email_address_with_http_info(allow_team_access : Bool?, use_domain_pool : Bool?, expires_at : Time?, expires_in : Int64?, email_address : String?, inbox_type : String?, description : String?, name : String?, tags : Array(String)?, favourite : Bool?)
    ...
    # Returns an Inbox with an `id` and an `emailAddress`
    # @return [InboxDto]
    def create_random_inbox(allow_team_access : Bool?, use_domain_pool : Bool?, expires_at : Time?, expires_in : Int64?, email_address : String?, inbox_type : String?, description : String?, name : String?, tags : Array(String)?, favourite : Bool?)
      data, _status_code, _headers = create_random_inbox_with_http_info(allow_team_access, use_domain_pool, expires_at, expires_in, email_address, inbox_type, description, name, tags, favourite)
      data
    end
    ...
    # Returns an Inbox with an &#x60;id&#x60; and an &#x60;emailAddress&#x60;
    # @return [Array<(InboxDto, Integer, Hash)>] InboxDto data, response status code and response headers
    def create_random_inbox_with_http_info(allow_team_access : Bool?, use_domain_pool : Bool?, expires_at : Time?, expires_in : Int64?, email_address : String?, inbox_type : String?, description : String?, name : String?, tags : Array(String)?, favourite : Bool?)
      if @api_client.config.debugging
