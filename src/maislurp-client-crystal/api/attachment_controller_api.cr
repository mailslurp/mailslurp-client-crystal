...
module 
  class AttachmentControllerApi
    ...
    def get_attachments(page : Int32?, size : Int32?, sort : String?, file_name_filter : String?, since : Time?, before : Time?, inbox_id : String?, email_id : String?, sent_email_id : String?)
      data, _status_code, _headers = get_attachments_with_http_info(page, size, sort, file_name_filter, since, before, inbox_id, email_id, sent_email_id)
      data
    end
    ...
    def get_attachments_with_http_info(page : Int32?, size : Int32?, sort : String?, file_name_filter : String?, since : Time?, before : Time?, inbox_id : String?, email_id : String?, sent_email_id : String?)
      if @api_client.config.debugging
    ...
    # @return [Array(String)]
    def upload_multipart_form(content_id : String?, content_type : String?, filename : String?, content_type_header : String?, x_filename : String?, x_filename_raw : String?, x_filesize : Int64?, inline_object : InlineObject?)
      data, _status_code, _headers = upload_multipart_form_with_http_info(content_id, content_type, filename, content_type_header, x_filename, x_filename_raw, x_filesize, inline_object)
      data
    end

    # Upload an attachment for sending using a Multipart Form request. Returns an array whose first element is the ID of the uploaded attachment.
    # @return [Array<(Array(String), Integer, Hash)>] Array(String) data, response status code and response headers
    def upload_multipart_form_with_http_info(content_id : String?, content_type : String?, filename : String?, content_type_header : String?, x_filename : String?, x_filename_raw : String?, x_filesize : Int64?, inline_object : InlineObject?)
      if @api_client.config.debugging
