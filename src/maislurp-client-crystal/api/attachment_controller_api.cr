...
module 
  class AttachmentControllerApi
    ...
    def get_attachments(file_name_filter : String?, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_attachments_with_http_info(file_name_filter, page, size, sort)
      data
    end
    ...
    def get_attachments_with_http_info(file_name_filter : String?, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
