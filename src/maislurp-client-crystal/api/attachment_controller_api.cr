...
module 
  class AttachmentControllerApi
    ...
    def extract_attachment_text(attachment_id : String, extract_attachment_text_options : ExtractAttachmentTextOptions?)
      data, _status_code, _headers = extract_attachment_text_with_http_info(attachment_id, extract_attachment_text_options)
      data
    end
    ...
    def extract_attachment_text_with_http_info(attachment_id : String, extract_attachment_text_options : ExtractAttachmentTextOptions?)
      if @api_client.config.debugging
        Log.debug {"Calling API: AttachmentControllerApi.extract_attachment_text ..."}
      end
      # verify the required parameter "attachment_id" is set
      if @api_client.config.client_side_validation && attachment_id.nil?
        raise ArgumentError.new("Missing the required parameter 'attachment_id' when calling AttachmentControllerApi.extract_attachment_text")
      end
      # resource path
      local_var_path = "/attachments/{attachmentId}/text".sub("{" + "attachmentId" + "}", URI.encode(attachment_id.to_s))
      ...
      # http body (model)
      post_body = extract_attachment_text_options.to_json

      # return_type
      return_type = "ExtractAttachmentTextResult"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"AttachmentControllerApi.extract_attachment_text",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: AttachmentControllerApi#extract_attachment_text\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ExtractAttachmentTextResult.from_json(data), status_code, headers
    end
    ...
    def get_attachment_with_http_info(attachment_id : String)
      ...
      # return_type
      return_type = "AttachmentEntityDto"
      ...
      return AttachmentEntityDto.from_json(data), status_code, headers
    end
    ...
    def get_attachments(page : Int32?, size : Int32?, sort : String?, file_name_filter : String?, since : Time?, before : Time?, inbox_id : String?, email_id : String?, sent_email_id : String?, _include : Array(String)?)
      data, _status_code, _headers = get_attachments_with_http_info(page, size, sort, file_name_filter, since, before, inbox_id, email_id, sent_email_id, _include)
      data
    end
    ...
    def get_attachments_with_http_info(page : Int32?, size : Int32?, sort : String?, file_name_filter : String?, since : Time?, before : Time?, inbox_id : String?, email_id : String?, sent_email_id : String?, _include : Array(String)?)
      if @api_client.config.debugging
      ...
      query_params[:"sentEmailId"] = sent_email_id
    ...
    # @return [Array(String)]
    def upload_attachment_bytes(content_type : String?, content_type2 : String?, content_id : String?, filename : String?, file_size : Int64?, filename2 : String?)
      data, _status_code, _headers = upload_attachment_bytes_with_http_info(content_type, content_type2, content_id, filename, file_size, filename2)
      data
    end

    # Upload an attachment for sending using file byte stream input octet stream. Returns an array whose first element is the ID of the uploaded attachment.
    # @return [Array<(Array(String), Integer, Hash)>] Array(String) data, response status code and response headers
    def upload_attachment_bytes_with_http_info(content_type : String?, content_type2 : String?, content_id : String?, filename : String?, file_size : Int64?, filename2 : String?)
      if @api_client.config.debugging
      ...
      # query parameters
      query_params = Hash(Symbol, String).new
      query_params[:"contentType"] = content_type2
      query_params[:"contentId"] = content_id
      query_params[:"filename"] = filename
      query_params[:"fileSize"] = file_size
      ...
      header_params["filename"] = filename2
    ...
    # @return [Array(String)]
    def upload_multipart_form(content_id : String?, content_type : String?, filename : String?, content_type_header : String?, x_filename : String?, x_filename_raw : String?, x_filesize : Int64?, inline_object1 : InlineObject1?)
      data, _status_code, _headers = upload_multipart_form_with_http_info(content_id, content_type, filename, content_type_header, x_filename, x_filename_raw, x_filesize, inline_object1)
      data
    end

    # Upload an attachment for sending using a Multipart Form request. Returns an array whose first element is the ID of the uploaded attachment.
    # @return [Array<(Array(String), Integer, Hash)>] Array(String) data, response status code and response headers
    def upload_multipart_form_with_http_info(content_id : String?, content_type : String?, filename : String?, content_type_header : String?, x_filename : String?, x_filename_raw : String?, x_filesize : Int64?, inline_object1 : InlineObject1?)
      if @api_client.config.debugging
      ...
      query_params[:"filename"] = filename
      query_params[:"contentTypeHeader"] = content_type_header
      query_params[:"x-filename"] = x_filename
      query_params[:"x-filename-raw"] = x_filename_raw
      query_params[:"x-filesize"] = x_filesize
      ...
      # http body (model)
      post_body = inline_object1.to_json
