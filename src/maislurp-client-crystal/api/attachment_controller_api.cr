...
module 
  class AttachmentControllerApi
    ...
    def get_attachments(page : Int32?, size : Int32?, sort : String?, file_name_filter : String?, since : Time?, before : Time?, inbox_id : String?)
      data, _status_code, _headers = get_attachments_with_http_info(page, size, sort, file_name_filter, since, before, inbox_id)
      data
    end
    ...
    def get_attachments_with_http_info(page : Int32?, size : Int32?, sort : String?, file_name_filter : String?, since : Time?, before : Time?, inbox_id : String?)
      if @api_client.config.debugging
