...
module 
  class AttachmentControllerApi
    ...
    # @return [Array(String)]
    def upload_attachment_bytes(content_type : String?, content_type2 : String?, content_id : String?, filename : String?, filename2 : String?)
      data, _status_code, _headers = upload_attachment_bytes_with_http_info(content_type, content_type2, content_id, filename, filename2)
      data
    end

    # Upload an attachment for sending using file byte stream input octet stream. Returns an array whose first element is the ID of the uploaded attachment.
    # @return [Array<(Array(String), Integer, Hash)>] Array(String) data, response status code and response headers
    def upload_attachment_bytes_with_http_info(content_type : String?, content_type2 : String?, content_id : String?, filename : String?, filename2 : String?)
      if @api_client.config.debugging
    ...
    # @return [Array(String)]
    def upload_multipart_form(content_id : String?, content_type : String?, filename : String?, x_filename : String?, inline_object : InlineObject?)
      data, _status_code, _headers = upload_multipart_form_with_http_info(content_id, content_type, filename, x_filename, inline_object)
      data
    end

    # Upload an attachment for sending using a Multipart Form request. Returns an array whose first element is the ID of the uploaded attachment.
    # @return [Array<(Array(String), Integer, Hash)>] Array(String) data, response status code and response headers
    def upload_multipart_form_with_http_info(content_id : String?, content_type : String?, filename : String?, x_filename : String?, inline_object : InlineObject?)
      if @api_client.config.debugging
