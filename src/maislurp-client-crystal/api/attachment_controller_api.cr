...
module 
  class AttachmentControllerApi
    ...
    # @return [Array(String)]
    def upload_attachment_bytes(inline_object1 : InlineObject1, content_type : String?, filename : String?)
      data, _status_code, _headers = upload_attachment_bytes_with_http_info(inline_object1, content_type, filename)
      data
    end
    ...
    # @param inline_object1 [InlineObject1] 
    # @return [Array<(Array(String), Integer, Hash)>] Array(String) data, response status code and response headers
    def upload_attachment_bytes_with_http_info(inline_object1 : InlineObject1, content_type : String?, filename : String?)
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && inline_object1.nil?
        raise ArgumentError.new("Missing the required parameter 'inline_object1' when calling AttachmentControllerApi.upload_attachment_bytes")
      end
      # resource path
