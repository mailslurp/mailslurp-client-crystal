...
module 
  class AttachmentControllerApi
    ...
    # @return [Array(String)]
    def upload_multipart_form(content_id : String?, content_type : String?, filename : String?, content_type_header : String?, x_filename : String?, x_filename_raw : String?, x_filesize : Int64?, inline_object2 : InlineObject2?)
      data, _status_code, _headers = upload_multipart_form_with_http_info(content_id, content_type, filename, content_type_header, x_filename, x_filename_raw, x_filesize, inline_object2)
      data
    end

    # Upload an attachment for sending using a Multipart Form request. Returns an array whose first element is the ID of the uploaded attachment.
    # @return [Array<(Array(String), Integer, Hash)>] Array(String) data, response status code and response headers
    def upload_multipart_form_with_http_info(content_id : String?, content_type : String?, filename : String?, content_type_header : String?, x_filename : String?, x_filename_raw : String?, x_filesize : Int64?, inline_object2 : InlineObject2?)
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = inline_object2.to_json
