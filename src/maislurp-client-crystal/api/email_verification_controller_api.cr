...
module 
  class EmailVerificationControllerApi
    ...
    def get_email_intelligence(email_intelligence_options : EmailIntelligenceOptions)
      data, _status_code, _headers = get_email_intelligence_with_http_info(email_intelligence_options)
      data
    end
    ...
    def get_email_intelligence_with_http_info(email_intelligence_options : EmailIntelligenceOptions)
      if @api_client.config.debugging
        Log.debug {"Calling API: EmailVerificationControllerApi.get_email_intelligence ..."}
      end
      ...
      if @api_client.config.client_side_validation && email_intelligence_options.nil?
        raise ArgumentError.new("Missing the required parameter 'email_intelligence_options' when calling EmailVerificationControllerApi.get_email_intelligence")
      end
      # resource path
      ...
      # http body (model)
      post_body = email_intelligence_options.to_json

      # return_type
      return_type = "EmailIntelligenceListResult"
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"EmailVerificationControllerApi.get_email_intelligence",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: EmailVerificationControllerApi#get_email_intelligence\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmailIntelligenceListResult.from_json(data), status_code, headers
    end
