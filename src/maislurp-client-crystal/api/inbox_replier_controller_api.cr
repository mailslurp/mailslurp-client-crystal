...
module 
  class InboxReplierControllerApi
    ...
    def get_all_inbox_replier_events(inbox_replier_id : String?, inbox_id : String?, email_id : String?, sent_id : String?, page : Int32?, size : Int32?, sort : String?)
      data, _status_code, _headers = get_all_inbox_replier_events_with_http_info(inbox_replier_id, inbox_id, email_id, sent_id, page, size, sort)
      data
    end
    ...
    def get_all_inbox_replier_events_with_http_info(inbox_replier_id : String?, inbox_id : String?, email_id : String?, sent_id : String?, page : Int32?, size : Int32?, sort : String?)
      if @api_client.config.debugging
        Log.debug {"Calling API: InboxReplierControllerApi.get_all_inbox_replier_events ..."}
      end
      ...
      # query parameters
      query_params = Hash(Symbol, String).new
      query_params[:"inboxReplierId"] = inbox_replier_id
      query_params[:"inboxId"] = inbox_id
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"InboxReplierControllerApi.get_all_inbox_replier_events",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: InboxReplierControllerApi#get_all_inbox_replier_events\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
